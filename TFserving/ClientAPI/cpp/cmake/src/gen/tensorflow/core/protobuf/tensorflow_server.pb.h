...
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::ServerDef* Arena::CreateMaybeMessage<::tensorflow::ServerDef>(
    Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class ServerDef PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.ServerDef)
                   */
{
 public:
  ...
  ServerDef(ServerDef&& from) noexcept : ServerDef() {
    *this = ::std::move(from);
  }
  ...
  static inline const ServerDef* internal_default_instance() {
    return reinterpret_cast<const ServerDef*>(&_ServerDef_default_instance_);
  }
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_job_name(std::string* job_name);
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_protocol(std::string* protocol);
 ...
 public:
  void unsafe_arena_set_allocated_cluster(::tensorflow::ClusterDef* cluster);
 ...
 public:
  ...
  void set_allocated_default_session_config(
 ...
 public:
  ...
  void set_allocated_cluster_device_filters(
      ::tensorflow::ClusterDeviceFilters* cluster_device_filters);

 private:
  const ::tensorflow::ClusterDeviceFilters& _internal_cluster_device_filters()
      const;
  ::tensorflow::ClusterDeviceFilters*
 ...
 public:
  void unsafe_arena_set_allocated_cluster_device_filters(
      ::tensorflow::ClusterDeviceFilters* cluster_device_filters);
  ::tensorflow::ClusterDeviceFilters*
  unsafe_arena_release_cluster_device_filters();
...
inline bool ServerDef::has_cluster() const { return _internal_has_cluster(); }
...
inline void ServerDef::set_allocated_cluster(
    ::tensorflow::ClusterDef* cluster) {
...
inline std::string* ServerDef::unsafe_arena_release_job_name() {
  ...
  return job_name_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ServerDef::unsafe_arena_set_allocated_job_name(
  ...
  job_name_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      job_name, GetArena());
...
// int32 task_index = 3;
inline void ServerDef::clear_task_index() { task_index_ = 0; }
...
inline void ServerDef::_internal_set_task_index(
...
ServerDef::_internal_default_session_config() const {
...
inline const ::tensorflow::ConfigProto& ServerDef::default_session_config()
    const {
...
ServerDef::unsafe_arena_release_default_session_config() {
...
inline ::tensorflow::ConfigProto*
ServerDef::_internal_mutable_default_session_config() {
...
inline void ServerDef::set_allocated_default_session_config(
    ::tensorflow::ConfigProto* default_session_config) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(
...
inline std::string* ServerDef::unsafe_arena_release_protocol() {
  ...
  return protocol_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ServerDef::unsafe_arena_set_allocated_protocol(
  ...
  protocol_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      protocol, GetArena());
...
// int32 port = 6;
inline void ServerDef::clear_port() { port_ = 0; }
...
inline void ServerDef::_internal_set_port(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  port_ = value;
}
...
inline const ::tensorflow::ClusterDeviceFilters&
ServerDef::_internal_cluster_device_filters() const {
  const ::tensorflow::ClusterDeviceFilters* p = cluster_device_filters_;
  return p != nullptr
             ? *p
             : *reinterpret_cast<const ::tensorflow::ClusterDeviceFilters*>(
                   &::tensorflow::_ClusterDeviceFilters_default_instance_);
}
inline const ::tensorflow::ClusterDeviceFilters&
ServerDef::cluster_device_filters() const {
...
inline ::tensorflow::ClusterDeviceFilters*
ServerDef::release_cluster_device_filters() {
...
inline ::tensorflow::ClusterDeviceFilters*
ServerDef::unsafe_arena_release_cluster_device_filters() {
...
inline ::tensorflow::ClusterDeviceFilters*
ServerDef::_internal_mutable_cluster_device_filters() {
  if (cluster_device_filters_ == nullptr) {
    auto* p =
        CreateMaybeMessage<::tensorflow::ClusterDeviceFilters>(GetArena());
    cluster_device_filters_ = p;
  }
  return cluster_device_filters_;
}
inline ::tensorflow::ClusterDeviceFilters*
ServerDef::mutable_cluster_device_filters() {
...
inline void ServerDef::set_allocated_cluster_device_filters(
    ::tensorflow::ClusterDeviceFilters* cluster_device_filters) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(
