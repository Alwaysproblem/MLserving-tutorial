...
Arena::CreateMaybeMessage<::tensorflow::RecvBufRespExtra>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class RecvBufRespExtra PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.RecvBufRespExtra)
                   */
{
 public:
  ...
  RecvBufRespExtra(RecvBufRespExtra&& from) noexcept : RecvBufRespExtra() {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& tensor_content()
      const;
...
inline const std::string& RecvBufRespExtra::_internal_tensor_content(
    int index) const {
...
inline void RecvBufRespExtra::set_tensor_content(int index,
...
inline void RecvBufRespExtra::set_tensor_content(int index, const void* value,
                                                 size_t size) {
  tensor_content_.Mutable(index)->assign(reinterpret_cast<const char*>(value),
                                         size);
...
inline void RecvBufRespExtra::add_tensor_content(const void* value,
                                                 size_t size) {
