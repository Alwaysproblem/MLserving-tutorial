...
extern TensorDescriptionDefaultTypeInternal
    _TensorDescription_default_instance_;
}  // namespace tensorflow
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::TensorDescription*
Arena::CreateMaybeMessage<::tensorflow::TensorDescription>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class TensorDescription PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.TensorDescription)
                   */
{
 public:
  ...
  TensorDescription(TensorDescription&& from) noexcept : TensorDescription() {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  void set_allocated_allocation_description(
      ::tensorflow::AllocationDescription* allocation_description);

 private:
  const ::tensorflow::AllocationDescription& _internal_allocation_description()
      const;
...
// .tensorflow.DataType dtype = 1;
inline void TensorDescription::clear_dtype() { dtype_ = 0; }
...
inline void TensorDescription::_internal_set_dtype(
...
TensorDescription::_internal_shape() const {
...
TensorDescription::unsafe_arena_release_shape() {
...
inline ::tensorflow::TensorShapeProto*
TensorDescription::_internal_mutable_shape() {
  if (shape_ == nullptr) {
...
inline void TensorDescription::set_allocated_shape(
    ::tensorflow::TensorShapeProto* shape) {
...
TensorDescription::_internal_allocation_description() const {
  const ::tensorflow::AllocationDescription* p = allocation_description_;
  return p != nullptr
             ? *p
             : *reinterpret_cast<const ::tensorflow::AllocationDescription*>(
                   &::tensorflow::_AllocationDescription_default_instance_);
}
inline const ::tensorflow::AllocationDescription&
TensorDescription::allocation_description() const {
...
inline void
TensorDescription::unsafe_arena_set_allocated_allocation_description(
    ::tensorflow::AllocationDescription* allocation_description) {
  if (GetArena() == nullptr) {
...
TensorDescription::release_allocation_description() {
...
inline ::tensorflow::AllocationDescription*
TensorDescription::unsafe_arena_release_allocation_description() {
...
inline ::tensorflow::AllocationDescription*
TensorDescription::_internal_mutable_allocation_description() {
  if (allocation_description_ == nullptr) {
    auto* p =
        CreateMaybeMessage<::tensorflow::AllocationDescription>(GetArena());
    allocation_description_ = p;
  }
  return allocation_description_;
}
inline ::tensorflow::AllocationDescription*
TensorDescription::mutable_allocation_description() {
...
inline void TensorDescription::set_allocated_allocation_description(
    ::tensorflow::AllocationDescription* allocation_description) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(
