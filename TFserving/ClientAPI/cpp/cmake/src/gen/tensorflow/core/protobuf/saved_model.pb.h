...
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::SavedModel* Arena::CreateMaybeMessage<::tensorflow::SavedModel>(
    Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class SavedModel PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.SavedModel)
                   */
{
 public:
  ...
  SavedModel(SavedModel&& from) noexcept : SavedModel() {
    *this = ::std::move(from);
  }
  ...
  static inline const SavedModel* internal_default_instance() {
    return reinterpret_cast<const SavedModel*>(&_SavedModel_default_instance_);
  }
 ...
 private:
  ...
  void _internal_set_saved_model_schema_version(
...
SavedModel::_internal_saved_model_schema_version() const {
  return saved_model_schema_version_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 SavedModel::saved_model_schema_version()
    const {
...
inline void SavedModel::_internal_set_saved_model_schema_version(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  saved_model_schema_version_ = value;
}
inline void SavedModel::set_saved_model_schema_version(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline const ::tensorflow::MetaGraphDef& SavedModel::_internal_meta_graphs(
    int index) const {
  return meta_graphs_.Get(index);
}
inline const ::tensorflow::MetaGraphDef& SavedModel::meta_graphs(
    int index) const {
