...
Arena::CreateMaybeMessage<::tensorflow::NamedTensorProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class NamedTensorProto PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.NamedTensorProto)
                   */
{
 public:
  ...
  NamedTensorProto(NamedTensorProto&& from) noexcept : NamedTensorProto() {
    *this = ::std::move(from);
  }
...
inline const ::tensorflow::TensorProto& NamedTensorProto::_internal_tensor()
    const {
...
NamedTensorProto::unsafe_arena_release_tensor() {
...
inline void NamedTensorProto::set_allocated_tensor(
    ::tensorflow::TensorProto* tensor) {
