...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_ResourceDtypeAndShape_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto;
...
class RemoteTensorHandleDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<RemoteTensorHandle>
      _instance;
} _RemoteTensorHandle_default_instance_;
}  // namespace eager
}  // namespace tensorflow
static void
InitDefaultsscc_info_RemoteTensorHandle_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto() {
...
static void
InitDefaultsscc_info_ResourceDtypeAndShape_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto
        [2];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::eager::ResourceDtypeAndShape,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::eager::ResourceDtypeAndShape,
                                  shape_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::eager::RemoteTensorHandle,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
...
static ::PROTOBUF_NAMESPACE_ID::Message const* const file_default_instances[] =
    {
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::eager::_ResourceDtypeAndShape_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto_sccs
        [2] = {
            &scc_info_RemoteTensorHandle_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto
                 .base,
            &scc_info_ResourceDtypeAndShape_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto
...
static bool dynamic_init_dummy_tensorflow_2fcore_2fprotobuf_2fremote_5ftensor_5fhandle_2eproto =
...
class ResourceDtypeAndShape::_Internal {
 public:
  static const ::tensorflow::TensorShapeProto& shape(
      const ResourceDtypeAndShape* msg);
};

const ::tensorflow::TensorShapeProto& ResourceDtypeAndShape::_Internal::shape(
    const ResourceDtypeAndShape* msg) {
  return *msg->shape_;
}
...
void ResourceDtypeAndShape::ArenaDtor(void* object) {
  ResourceDtypeAndShape* _this =
      reinterpret_cast<ResourceDtypeAndShape*>(object);
  (void)_this;
}
...
const char* ResourceDtypeAndShape::_InternalParse(
...
void ResourceDtypeAndShape::MergeFrom(
...
void ResourceDtypeAndShape::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool ResourceDtypeAndShape::IsInitialized() const { return true; }
...
RemoteTensorHandle::RemoteTensorHandle(const RemoteTensorHandle& from)
  ...
  op_device_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_op_device().empty()) {
    op_device_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_op_device(), GetArena());
  }
...
const char* RemoteTensorHandle::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.eager.RemoteTensorHandle.device"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(
              str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.eager.RemoteTensorHandle.op_device"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          goto handle_unusual;
        continue;
      // repeated .tensorflow.eager.ResourceDtypeAndShape
      // resource_dtypes_and_shapes = 6;
      case 6:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_resource_dtypes_and_shapes(),
                                    ptr);
            CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* RemoteTensorHandle::_InternalSerialize(
  ...
  if (this->output_num() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(
            2, this->_internal_output_num(), target);
  }
  ...
  if (this->device().size() > 0) {
    ...
    target =
        stream->WriteStringMaybeAliased(3, this->_internal_device(), target);
  }

  // string op_device = 4;
  if (this->op_device().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_op_device().data(),
        static_cast<int>(this->_internal_op_device().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "tensorflow.eager.RemoteTensorHandle.op_device");
    target =
        stream->WriteStringMaybeAliased(4, this->_internal_op_device(), target);
  }
  ...
  for (unsigned int i = 0,
                    n = static_cast<unsigned int>(
                        this->_internal_resource_dtypes_and_shapes_size());
       i < n; i++) {
    target = stream->EnsureSpace(target);
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            6, this->_internal_resource_dtypes_and_shapes(i), target, stream);
  }
...
void RemoteTensorHandle::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
void RemoteTensorHandle::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool RemoteTensorHandle::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::eager::ResourceDtypeAndShape*
Arena::CreateMaybeMessage<::tensorflow::eager::ResourceDtypeAndShape>(
    Arena* arena) {
  return Arena::CreateMessageInternal<
      ::tensorflow::eager::ResourceDtypeAndShape>(arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::eager::RemoteTensorHandle*
Arena::CreateMaybeMessage<::tensorflow::eager::RemoteTensorHandle>(
    Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::eager::RemoteTensorHandle>(
      arena);
}
