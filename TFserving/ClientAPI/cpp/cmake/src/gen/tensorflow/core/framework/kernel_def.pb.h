...
extern KernelDef_AttrConstraintDefaultTypeInternal
...
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::KernelDef* Arena::CreateMaybeMessage<::tensorflow::KernelDef>(
    Arena*);
template <>
::tensorflow::KernelDef_AttrConstraint*
Arena::CreateMaybeMessage<::tensorflow::KernelDef_AttrConstraint>(Arena*);
template <>
::tensorflow::KernelList* Arena::CreateMaybeMessage<::tensorflow::KernelList>(
    Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class KernelDef_AttrConstraint PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.KernelDef.AttrConstraint)
                   */
{
 public:
  ...
  inline KernelDef_AttrConstraint& operator=(
      const KernelDef_AttrConstraint& from) {
    CopyFrom(from);
    return *this;
  }
  inline KernelDef_AttrConstraint& operator=(
      KernelDef_AttrConstraint&& from) noexcept {
...
class KernelDef PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.KernelDef)
                   */
{
 public:
  ...
  KernelDef(KernelDef&& from) noexcept : KernelDef() {
    *this = ::std::move(from);
  }
  ...
  static inline const KernelDef* internal_default_instance() {
    return reinterpret_cast<const KernelDef*>(&_KernelDef_default_instance_);
  }
 ...
 private:
  const ::tensorflow::KernelDef_AttrConstraint& _internal_constraint(
      int index) const;
...
class KernelList PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.KernelList)
                   */
{
 public:
  ...
  KernelList(KernelList&& from) noexcept : KernelList() {
    *this = ::std::move(from);
  }
  ...
  static inline const KernelList* internal_default_instance() {
    return reinterpret_cast<const KernelList*>(&_KernelList_default_instance_);
  }
...
inline void KernelDef_AttrConstraint::_internal_set_name(
...
inline const ::tensorflow::AttrValue&
KernelDef_AttrConstraint::_internal_allowed_values() const {
...
inline const ::tensorflow::AttrValue& KernelDef_AttrConstraint::allowed_values()
    const {
...
KernelDef_AttrConstraint::release_allowed_values() {
...
inline ::tensorflow::AttrValue*
KernelDef_AttrConstraint::unsafe_arena_release_allowed_values() {
...
inline ::tensorflow::AttrValue*
KernelDef_AttrConstraint::_internal_mutable_allowed_values() {
...
inline ::tensorflow::AttrValue*
KernelDef_AttrConstraint::mutable_allowed_values() {
...
inline void KernelDef_AttrConstraint::set_allocated_allowed_values(
    ::tensorflow::AttrValue* allowed_values) {
...
inline const std::string& KernelDef::_internal_op() const { return op_.Get(); }
...
inline void KernelDef::unsafe_arena_set_allocated_op(std::string* op) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (op != nullptr) {
  } else {
  }
...
inline void KernelDef::clear_constraint() { constraint_.Clear(); }
inline ::tensorflow::KernelDef_AttrConstraint* KernelDef::mutable_constraint(
    int index) {
...
inline const ::tensorflow::KernelDef_AttrConstraint&
KernelDef::_internal_constraint(int index) const {
  return constraint_.Get(index);
}
inline const ::tensorflow::KernelDef_AttrConstraint& KernelDef::constraint(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.KernelDef.constraint)
  return _internal_constraint(index);
}
inline ::tensorflow::KernelDef_AttrConstraint*
KernelDef::_internal_add_constraint() {
...
inline void KernelDef::clear_host_memory_arg() { host_memory_arg_.Clear(); }
...
inline const std::string& KernelDef::_internal_host_memory_arg(
    int index) const {
...
inline void KernelDef::set_host_memory_arg(int index,
                                           const std::string& value) {
...
inline void KernelDef::set_host_memory_arg(int index, const char* value,
                                           size_t size) {
  host_memory_arg_.Mutable(index)->assign(reinterpret_cast<const char*>(value),
                                          size);
...
inline void KernelDef::unsafe_arena_set_allocated_label(std::string* label) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (label != nullptr) {
  } else {
  }
...
// int32 priority = 6;
inline void KernelDef::clear_priority() { priority_ = 0; }
...
inline void KernelDef::_internal_set_priority(
...
// repeated .tensorflow.KernelDef kernel = 1;
inline int KernelList::_internal_kernel_size() const { return kernel_.size(); }
inline int KernelList::kernel_size() const { return _internal_kernel_size(); }
inline void KernelList::clear_kernel() { kernel_.Clear(); }
...
inline const ::tensorflow::KernelDef& KernelList::_internal_kernel(
    int index) const {
