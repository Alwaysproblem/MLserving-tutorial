...
extern LogCollectorConfigDefaultTypeInternal
...
Arena::CreateMaybeMessage<::tensorflow::serving::LogCollectorConfig>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace serving {
...
class LogCollectorConfig PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.LogCollectorConfig)
                   */
{
 public:
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_filename_prefix(std::string* filename_prefix);
...
inline void LogCollectorConfig::set_type(const char* value, size_t size) {
  type_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline const std::string& LogCollectorConfig::_internal_filename_prefix()
    const {
  return filename_prefix_.Get();
}
inline void LogCollectorConfig::_internal_set_filename_prefix(
...
inline std::string* LogCollectorConfig::_internal_mutable_filename_prefix() {
  return filename_prefix_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline std::string* LogCollectorConfig::release_filename_prefix() {
  ...
  return filename_prefix_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void LogCollectorConfig::set_allocated_filename_prefix(
    std::string* filename_prefix) {
  if (filename_prefix != nullptr) {
  } else {
  }
  filename_prefix_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* LogCollectorConfig::unsafe_arena_release_filename_prefix() {
  ...
  return filename_prefix_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void LogCollectorConfig::unsafe_arena_set_allocated_filename_prefix(
  ...
  filename_prefix_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      filename_prefix, GetArena());
