...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_PlatformConfig_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_PlatformConfigMap_PlatformConfigsEntry_DoNotUse_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto;
namespace tensorflow {
namespace serving {
class PlatformConfigDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PlatformConfig>
      _instance;
...
class PlatformConfigMapDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PlatformConfigMap>
      _instance;
} _PlatformConfigMap_default_instance_;
}  // namespace serving
}  // namespace tensorflow
static void
InitDefaultsscc_info_PlatformConfig_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto() {
...
static void
InitDefaultsscc_info_PlatformConfigMap_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
    scc_info_PlatformConfigMap_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto =
        {{ATOMIC_VAR_INIT(
              ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized),
          1, 0,
          InitDefaultsscc_info_PlatformConfigMap_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto},
...
static void
InitDefaultsscc_info_PlatformConfigMap_PlatformConfigsEntry_DoNotUse_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto
        [3];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::PlatformConfig,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ...
            1,
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::PlatformConfigMap,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
...
static ::PROTOBUF_NAMESPACE_ID::Message const* const file_default_instances[] = {
    reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
        &::tensorflow::serving::_PlatformConfig_default_instance_),
    reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
        &::tensorflow::serving::
            _PlatformConfigMap_PlatformConfigsEntry_DoNotUse_default_instance_),
    reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
        &::tensorflow::serving::_PlatformConfigMap_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto_sccs
        [3] = {
            &scc_info_PlatformConfig_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto
                 .base,
            &scc_info_PlatformConfigMap_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto
...
static bool dynamic_init_dummy_tensorflow_5fserving_2fconfig_2fplatform_5fconfig_2eproto =
...
void PlatformConfig::InitAsDefaultInstance() {
  ::tensorflow::serving::_PlatformConfig_default_instance_._instance
      .get_mutable()
      ->source_adapter_config_ = const_cast<PROTOBUF_NAMESPACE_ID::Any*>(
      PROTOBUF_NAMESPACE_ID::Any::internal_default_instance());
}
class PlatformConfig::_Internal {
 public:
  static const PROTOBUF_NAMESPACE_ID::Any& source_adapter_config(
      const PlatformConfig* msg);
};
...
PlatformConfig::PlatformConfig(const PlatformConfig& from)
  ...
  if (from._internal_has_source_adapter_config()) {
    source_adapter_config_ =
        new PROTOBUF_NAMESPACE_ID::Any(*from.source_adapter_config_);
  } else {
    source_adapter_config_ = nullptr;
  }
...
void PlatformConfig::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* PlatformConfig::_InternalParse(
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr =
              ctx->ParseMessage(_internal_mutable_source_adapter_config(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void PlatformConfig::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const PlatformConfig* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PlatformConfig>(&from);
  if (source == nullptr) {
...
void PlatformConfig::MergeFrom(const PlatformConfig& from) {
  ...
  if (from.has_source_adapter_config()) {
    _internal_mutable_source_adapter_config()
...
bool PlatformConfig::IsInitialized() const { return true; }
...
void PlatformConfigMap_PlatformConfigsEntry_DoNotUse::MergeFrom(
    const PlatformConfigMap_PlatformConfigsEntry_DoNotUse& other) {
  MergeFromInternal(other);
}
::PROTOBUF_NAMESPACE_ID::Metadata
PlatformConfigMap_PlatformConfigsEntry_DoNotUse::GetMetadata() const {
  return GetMetadataStatic();
}
void PlatformConfigMap_PlatformConfigsEntry_DoNotUse::MergeFrom(
...
PlatformConfigMap::PlatformConfigMap(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), platform_configs_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
...
void PlatformConfigMap::SharedDtor() { GOOGLE_DCHECK(GetArena() == nullptr); }
...
const char* PlatformConfigMap::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
::PROTOBUF_NAMESPACE_ID::uint8* PlatformConfigMap::_InternalSerialize(
  ...
  if (!this->_internal_platform_configs().empty()) {
    typedef ::PROTOBUF_NAMESPACE_ID::Map<
        std::string, ::tensorflow::serving::PlatformConfig>::const_pointer
        ConstPtr;
    ...
    if (stream->IsSerializationDeterministic() &&
      ...
      typedef ::PROTOBUF_NAMESPACE_ID::Map<
          std::string, ::tensorflow::serving::PlatformConfig>::size_type
          size_type;
      size_type n = 0;
      for (::PROTOBUF_NAMESPACE_ID::Map<
               std::string,
               ::tensorflow::serving::PlatformConfig>::const_iterator it =
               this->_internal_platform_configs().begin();
           it != this->_internal_platform_configs().end(); ++it, ++n) {
        items[static_cast<ptrdiff_t>(n)] = SortItem(&*it);
      }
      ::std::sort(&items[0], &items[static_cast<ptrdiff_t>(n)], Less());
      for (size_type i = 0; i < n; i++) {
        target = PlatformConfigMap_PlatformConfigsEntry_DoNotUse::Funcs::
...
size_t PlatformConfigMap::ByteSizeLong() const {
  ...
  total_size += 1 * ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(
                        this->_internal_platform_configs_size());
  for (::PROTOBUF_NAMESPACE_ID::Map<
           std::string, ::tensorflow::serving::PlatformConfig>::const_iterator
           it = this->_internal_platform_configs().begin();
       it != this->_internal_platform_configs().end(); ++it) {
    total_size +=
        PlatformConfigMap_PlatformConfigsEntry_DoNotUse::Funcs::ByteSizeLong(
            it->first, it->second);
  }
...
void PlatformConfigMap::MergeFrom(
  ...
  const PlatformConfigMap* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PlatformConfigMap>(&from);
  if (source == nullptr) {
...
bool PlatformConfigMap::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::PlatformConfig*
Arena::CreateMaybeMessage<::tensorflow::serving::PlatformConfig>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::PlatformConfig>(
      arena);
}
template <>
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::PlatformConfigMap*
Arena::CreateMaybeMessage<::tensorflow::serving::PlatformConfigMap>(
    Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::PlatformConfigMap>(
      arena);
}
