...
class LogCollectorConfigDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<LogCollectorConfig>
      _instance;
} _LogCollectorConfig_default_instance_;
}  // namespace serving
}  // namespace tensorflow
static void
InitDefaultsscc_info_LogCollectorConfig_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto() {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto
        [1];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::LogCollectorConfig,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* const
    descriptor_table_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto_deps
        [1] = {};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto_sccs
        [1] = {
            &scc_info_LogCollectorConfig_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto
                 .base,
};
...
static bool dynamic_init_dummy_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto =
...
LogCollectorConfig::LogCollectorConfig(const LogCollectorConfig& from)
  ...
  filename_prefix_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_filename_prefix().empty()) {
    filename_prefix_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_filename_prefix(), GetArena());
  }
...
void LogCollectorConfig::SharedDtor() {
  ...
  type_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  filename_prefix_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void LogCollectorConfig::Clear() {
  ...
  type_.ClearToEmpty(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
  filename_prefix_.ClearToEmpty(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

const char* LogCollectorConfig::_InternalParse(
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.LogCollectorConfig.type"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(
              str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.LogCollectorConfig.filename_prefix"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* LogCollectorConfig::_InternalSerialize(
  ...
  if (this->filename_prefix().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_filename_prefix().data(),
        static_cast<int>(this->_internal_filename_prefix().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
...
void LogCollectorConfig::MergeFrom(
...
void LogCollectorConfig::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool LogCollectorConfig::IsInitialized() const { return true; }
...
void LogCollectorConfig::InternalSwap(LogCollectorConfig* other) {
  ...
  type_.Swap(&other->type_,
             &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
             GetArena());
  filename_prefix_.Swap(
      &other->filename_prefix_,
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::LogCollectorConfig*
Arena::CreateMaybeMessage<::tensorflow::serving::LogCollectorConfig>(
    Arena* arena) {
  return Arena::CreateMessageInternal<
      ::tensorflow::serving::LogCollectorConfig>(arena);
}
