...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
        scc_info_LogCollectorConfig_tensorflow_5fserving_2fconfig_2flog_5fcollector_5fconfig_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
        scc_info_SamplingConfig_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto;
namespace tensorflow {
namespace serving {
class SamplingConfigDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<SamplingConfig>
      _instance;
} _SamplingConfig_default_instance_;
class LoggingConfigDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<LoggingConfig>
      _instance;
} _LoggingConfig_default_instance_;
}  // namespace serving
}  // namespace tensorflow
static void
InitDefaultsscc_info_LoggingConfig_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto() {
...
static void
InitDefaultsscc_info_SamplingConfig_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto
        [2];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::SamplingConfig,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::SamplingConfig,
                                  sampling_rate_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::LoggingConfig,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto_sccs
        [2] = {
            &scc_info_LoggingConfig_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto
                 .base,
            &scc_info_SamplingConfig_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto
...
static bool dynamic_init_dummy_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto =
...
void SamplingConfig::SharedCtor() { sampling_rate_ = 0; }
...
void SamplingConfig::SharedDtor() { GOOGLE_DCHECK(GetArena() == nullptr); }
...
void SamplingConfig::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* SamplingConfig::_InternalParse(
  ...
  if (!(this->sampling_rate() <= 0 && this->sampling_rate() >= 0)) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(
            1, this->_internal_sampling_rate(), target);
  }
...
void SamplingConfig::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const SamplingConfig* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<SamplingConfig>(&from);
  if (source == nullptr) {
...
bool SamplingConfig::IsInitialized() const { return true; }
...
void LoggingConfig::InitAsDefaultInstance() {
  ::tensorflow::serving::_LoggingConfig_default_instance_._instance
      .get_mutable()
      ->log_collector_config_ = const_cast<
      ::tensorflow::serving::LogCollectorConfig*>(
      ::tensorflow::serving::LogCollectorConfig::internal_default_instance());
  ::tensorflow::serving::_LoggingConfig_default_instance_._instance
      .get_mutable()
      ->sampling_config_ = const_cast<::tensorflow::serving::SamplingConfig*>(
      ::tensorflow::serving::SamplingConfig::internal_default_instance());
}
class LoggingConfig::_Internal {
 public:
  static const ::tensorflow::serving::LogCollectorConfig& log_collector_config(
      const LoggingConfig* msg);
  static const ::tensorflow::serving::SamplingConfig& sampling_config(
      const LoggingConfig* msg);
};
...
LoggingConfig::LoggingConfig(const LoggingConfig& from)
  ...
  if (from._internal_has_log_collector_config()) {
    log_collector_config_ = new ::tensorflow::serving::LogCollectorConfig(
        *from.log_collector_config_);
  } else {
    log_collector_config_ = nullptr;
  }
  if (from._internal_has_sampling_config()) {
    sampling_config_ =
        new ::tensorflow::serving::SamplingConfig(*from.sampling_config_);
  } else {
...
void LoggingConfig::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &scc_info_LoggingConfig_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto
           .base);
  ::memset(
      &log_collector_config_, 0,
      static_cast<size_t>(reinterpret_cast<char*>(&sampling_config_) -
                          reinterpret_cast<char*>(&log_collector_config_)) +
          sizeof(sampling_config_));
}
...
void LoggingConfig::SetCachedSize(int size) const { _cached_size_.Set(size); }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr =
              ctx->ParseMessage(_internal_mutable_log_collector_config(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void LoggingConfig::MergeFrom(const LoggingConfig& from) {
  ...
  if (from.has_log_collector_config()) {
    _internal_mutable_log_collector_config()
        ->::tensorflow::serving::LogCollectorConfig::MergeFrom(
            from._internal_log_collector_config());
  }
  if (from.has_sampling_config()) {
    _internal_mutable_sampling_config()
        ->::tensorflow::serving::SamplingConfig::MergeFrom(
...
bool LoggingConfig::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::SamplingConfig*
Arena::CreateMaybeMessage<::tensorflow::serving::SamplingConfig>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::SamplingConfig>(
      arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::LoggingConfig*
Arena::CreateMaybeMessage<::tensorflow::serving::LoggingConfig>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::LoggingConfig>(
      arena);
}
