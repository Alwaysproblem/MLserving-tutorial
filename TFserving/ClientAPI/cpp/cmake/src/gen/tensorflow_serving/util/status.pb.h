...
Arena::CreateMaybeMessage<::tensorflow::serving::StatusProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace serving {
...
class StatusProto PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.StatusProto)
                   */
{
 public:
  ...
  StatusProto(StatusProto&& from) noexcept : StatusProto() {
    *this = ::std::move(from);
  }
 ...
 private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
        &::descriptor_table_tensorflow_5fserving_2futil_2fstatus_2eproto);
    return ::descriptor_table_tensorflow_5fserving_2futil_2fstatus_2eproto
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_error_message(std::string* error_message);
...
// .tensorflow.error.Code error_code = 1[json_name = "error_code"];
inline void StatusProto::clear_error_code() { error_code_ = 0; }
...
inline void StatusProto::_internal_set_error_code(
...
inline void StatusProto::set_allocated_error_message(
    std::string* error_message) {
  if (error_message != nullptr) {
  } else {
  }
  error_message_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* StatusProto::unsafe_arena_release_error_message() {
  ...
  return error_message_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void StatusProto::unsafe_arena_set_allocated_error_message(
  ...
  error_message_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      error_message, GetArena());
