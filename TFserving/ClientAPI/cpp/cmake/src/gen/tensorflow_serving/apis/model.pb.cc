...
static void
InitDefaultsscc_info_ModelSpec_tensorflow_5fserving_2fapis_2fmodel_2eproto() {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_5fserving_2fapis_2fmodel_2eproto[1];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fapis_2fmodel_2eproto::offsets
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelSpec,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelSpec,
                                  _oneof_case_[0]),
            ...
            offsetof(::tensorflow::serving::ModelSpecDefaultTypeInternal,
                     version_),
            offsetof(::tensorflow::serving::ModelSpecDefaultTypeInternal,
                     version_label_),
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelSpec,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* const
    descriptor_table_tensorflow_5fserving_2fapis_2fmodel_2eproto_deps[1] = {
        &::descriptor_table_google_2fprotobuf_2fwrappers_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2fapis_2fmodel_2eproto_sccs[1] = {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_tensorflow_5fserving_2fapis_2fmodel_2eproto = {
        ...
        245,
        &descriptor_table_tensorflow_5fserving_2fapis_2fmodel_2eproto_once,
        descriptor_table_tensorflow_5fserving_2fapis_2fmodel_2eproto_sccs,
        ...
        TableStruct_tensorflow_5fserving_2fapis_2fmodel_2eproto::offsets,
        file_level_metadata_tensorflow_5fserving_2fapis_2fmodel_2eproto,
        1,
        file_level_enum_descriptors_tensorflow_5fserving_2fapis_2fmodel_2eproto,
        file_level_service_descriptors_tensorflow_5fserving_2fapis_2fmodel_2eproto,
};
...
static bool dynamic_init_dummy_tensorflow_5fserving_2fapis_2fmodel_2eproto =
...
void ModelSpec::InitAsDefaultInstance() {
  ::tensorflow::serving::_ModelSpec_default_instance_.version_ =
      const_cast<PROTOBUF_NAMESPACE_ID::Int64Value*>(
          PROTOBUF_NAMESPACE_ID::Int64Value::internal_default_instance());
  ::tensorflow::serving::_ModelSpec_default_instance_.version_label_
      .UnsafeSetDefault(
...
const PROTOBUF_NAMESPACE_ID::Int64Value& ModelSpec::_Internal::version(
    const ModelSpec* msg) {
  return *msg->version_choice_.version_;
}
void ModelSpec::set_allocated_version(
...
ModelSpec::ModelSpec(const ModelSpec& from)
  ...
  signature_name_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_signature_name().empty()) {
    signature_name_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_signature_name(), GetArena());
  }
  clear_has_version_choice();
  switch (from.version_choice_case()) {
    case kVersion: {
      _internal_mutable_version()->PROTOBUF_NAMESPACE_ID::Int64Value::MergeFrom(
...
void ModelSpec::SharedDtor() {
  ...
  name_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  signature_name_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void ModelSpec::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void ModelSpec::clear_version_choice() {
  ...
  switch (version_choice_case()) {
    ...
    case kVersionLabel: {
      version_choice_.version_label_.Destroy(
          &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
          GetArena());
      break;
    }
...
const char* ModelSpec::_InternalParse(
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.ModelSpec.name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(
              str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.ModelSpec.signature_name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(
              str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.ModelSpec.version_label"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* ModelSpec::_InternalSerialize(
  ...
  if (this->signature_name().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_signature_name().data(),
        static_cast<int>(this->_internal_signature_name().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
  ...
  if (_internal_has_version_label()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_version_label().data(),
        static_cast<int>(this->_internal_version_label().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "tensorflow.serving.ModelSpec.version_label");
    target = stream->WriteStringMaybeAliased(4, this->_internal_version_label(),
                                             target);
  }
...
void ModelSpec::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const ModelSpec* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ModelSpec>(&from);
  if (source == nullptr) {
...
bool ModelSpec::IsInitialized() const { return true; }
...
void ModelSpec::InternalSwap(ModelSpec* other) {
  ...
  name_.Swap(&other->name_,
             &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
             GetArena());
  signature_name_.Swap(
      &other->signature_name_,
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::ModelSpec*
