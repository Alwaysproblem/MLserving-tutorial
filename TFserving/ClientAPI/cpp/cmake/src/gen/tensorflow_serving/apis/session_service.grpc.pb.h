 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status SessionRun(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::SessionRunRequest& request,
        ::tensorflow::serving::SessionRunResponse* response) = 0;
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::SessionRunResponse>>
    AsyncSessionRun(::grpc::ClientContext* context,
                    const ::tensorflow::serving::SessionRunRequest& request,
                    ::grpc::CompletionQueue* cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::tensorflow::serving::SessionRunResponse>>(
          AsyncSessionRunRaw(context, request, cq));
    }
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::SessionRunResponse>>
    PrepareAsyncSessionRun(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::SessionRunRequest& request,
        ::grpc::CompletionQueue* cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::tensorflow::serving::SessionRunResponse>>(
          PrepareAsyncSessionRunRaw(context, request, cq));
    }
    class experimental_async_interface {
     public:
      virtual ~experimental_async_interface() {}
      // Runs inference of a given model.
      virtual void SessionRun(
          ::grpc::ClientContext* context,
          const ::tensorflow::serving::SessionRunRequest* request,
   ...
   private:
    virtual ::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::SessionRunResponse>*
    AsyncSessionRunRaw(::grpc::ClientContext* context,
                       const ::tensorflow::serving::SessionRunRequest& request,
                       ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::SessionRunResponse>*
    PrepareAsyncSessionRunRaw(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::SessionRunRequest& request,
        ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status SessionRun(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::SessionRunRequest& request,
        ::tensorflow::serving::SessionRunResponse* response) override;
    ...
    class experimental_async final
     ...
     public:
      void SessionRun(::grpc::ClientContext* context,
                      const ::tensorflow::serving::SessionRunRequest* request,
                      ::tensorflow::serving::SessionRunResponse* response,
  ...
  class WithAsyncMethod_SessionRun : public BaseClass {
   ...
   public:
    WithAsyncMethod_SessionRun() { ::grpc::Service::MarkMethodAsync(0); }
          ...
          MarkMethodCallback(
              ...
              new ::grpc_impl::internal::CallbackUnaryHandler<
                  ...
                  [this](
                      ...
                      const ::tensorflow::serving::SessionRunRequest* request,
                      ::tensorflow::serving::SessionRunResponse* response) {
                    return this->SessionRun(context, request, response);
                  }));
    }
    void SetMessageAllocatorFor_SessionRun(
        ::grpc::experimental::MessageAllocator<
            ::tensorflow::serving::SessionRunRequest,
            ::tensorflow::serving::SessionRunResponse>* allocator) {
#ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler<
          ::tensorflow::serving::SessionRunRequest,
          ::tensorflow::serving::SessionRunResponse>*>(handler)
  ...
  typedef ExperimentalWithCallbackMethod_SessionRun<Service>
  ...
  class WithGenericMethod_SessionRun : public BaseClass {
   ...
   public:
    WithGenericMethod_SessionRun() { ::grpc::Service::MarkMethodGeneric(0); }
  ...
  class WithRawMethod_SessionRun : public BaseClass {
   ...
   public:
    WithRawMethod_SessionRun() { ::grpc::Service::MarkMethodRaw(0); }
  ...
  class WithStreamedUnaryMethod_SessionRun : public BaseClass {
   ...
   public:
          ...
          new ::grpc::internal::StreamedUnaryHandler<
              ...
              [this](::grpc_impl::ServerContext* context,
                     ::grpc_impl::ServerUnaryStreamer<
                         ::tensorflow::serving::SessionRunRequest,
                         ::tensorflow::serving::SessionRunResponse>* streamer) {
                return this->StreamedSessionRun(context, streamer);
              }));
    }
    ...
    virtual ::grpc::Status StreamedSessionRun(
        ::grpc::ServerContext* context,
        ::grpc::ServerUnaryStreamer<::tensorflow::serving::SessionRunRequest,
                                    ::tensorflow::serving::SessionRunResponse>*
