...
extern GraphExecutionTraceDefaultTypeInternal
...
Arena::CreateMaybeMessage<::tensorflow::CodeLocation>(Arena*);
template <>
::tensorflow::DebugEvent* Arena::CreateMaybeMessage<::tensorflow::DebugEvent>(
    Arena*);
template <>
::tensorflow::DebugMetadata*
Arena::CreateMaybeMessage<::tensorflow::DebugMetadata>(Arena*);
template <>
::tensorflow::DebuggedDevice*
Arena::CreateMaybeMessage<::tensorflow::DebuggedDevice>(Arena*);
template <>
::tensorflow::DebuggedGraph*
Arena::CreateMaybeMessage<::tensorflow::DebuggedGraph>(Arena*);
template <>
::tensorflow::Execution* Arena::CreateMaybeMessage<::tensorflow::Execution>(
    Arena*);
template <>
::tensorflow::GraphExecutionTrace*
Arena::CreateMaybeMessage<::tensorflow::GraphExecutionTrace>(Arena*);
template <>
::tensorflow::GraphOpCreation*
Arena::CreateMaybeMessage<::tensorflow::GraphOpCreation>(Arena*);
template <>
::tensorflow::SourceFile* Arena::CreateMaybeMessage<::tensorflow::SourceFile>(
    Arena*);
template <>
::tensorflow::StackFrameWithId*
Arena::CreateMaybeMessage<::tensorflow::StackFrameWithId>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
inline const std::string& TensorDebugMode_Name(T enum_t_value) {
  static_assert(
      ::std::is_same<T, TensorDebugMode>::value || ::std::is_integral<T>::value,
      "Incorrect type passed to function TensorDebugMode_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
      TensorDebugMode_descriptor(), enum_t_value);
}
inline bool TensorDebugMode_Parse(const std::string& name,
                                  TensorDebugMode* value) {
...
class DebugEvent PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.DebugEvent)
                   */
{
 public:
  ...
  DebugEvent(DebugEvent&& from) noexcept : DebugEvent() {
    *this = ::std::move(from);
  }
  ...
  static inline const DebugEvent* internal_default_instance() {
    return reinterpret_cast<const DebugEvent*>(&_DebugEvent_default_instance_);
  }
 ...
 public:
  ...
  void set_allocated_debug_metadata(
 ...
 public:
  ...
  void set_allocated_stack_frame_with_id(
 ...
 public:
  ...
  void set_allocated_graph_op_creation(
 ...
 public:
  ...
  void set_allocated_debugged_graph(
 ...
 public:
  void unsafe_arena_set_allocated_execution(::tensorflow::Execution* execution);
 ...
 public:
  ...
  void set_allocated_graph_execution_trace(
      ::tensorflow::GraphExecutionTrace* graph_execution_trace);

 private:
  const ::tensorflow::GraphExecutionTrace& _internal_graph_execution_trace()
      const;
 ...
 public:
  void unsafe_arena_set_allocated_graph_execution_trace(
      ::tensorflow::GraphExecutionTrace* graph_execution_trace);
  ::tensorflow::GraphExecutionTrace*
  unsafe_arena_release_graph_execution_trace();
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_graph_id(std::string* graph_id);
 ...
 public:
  ...
  void set_allocated_debugged_device(
 ...
 private:
  ...
  friend struct ::
      TableStruct_tensorflow_2fcore_2fprotobuf_2fdebug_5fevent_2eproto;
};
// -------------------------------------------------------------------

class DebugMetadata PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.DebugMetadata)
                   */
{
 public:
  ...
  DebugMetadata(DebugMetadata&& from) noexcept : DebugMetadata() {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_file_version(std::string* file_version);
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_tfdbg_run_id(std::string* tfdbg_run_id);
...
class SourceFile PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.SourceFile)
                   */
{
 public:
  ...
  SourceFile(SourceFile&& from) noexcept : SourceFile() {
    *this = ::std::move(from);
  }
  ...
  static inline const SourceFile* internal_default_instance() {
    return reinterpret_cast<const SourceFile*>(&_SourceFile_default_instance_);
  }
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_file_path(std::string* file_path);
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_host_name(std::string* host_name);
...
class StackFrameWithId PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.StackFrameWithId)
                   */
{
 public:
  ...
  StackFrameWithId(StackFrameWithId&& from) noexcept : StackFrameWithId() {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  void set_allocated_file_line_col(
      ::tensorflow::GraphDebugInfo_FileLineCol* file_line_col);

 private:
  const ::tensorflow::GraphDebugInfo_FileLineCol& _internal_file_line_col()
      const;
 ...
 public:
  void unsafe_arena_set_allocated_file_line_col(
      ::tensorflow::GraphDebugInfo_FileLineCol* file_line_col);
  ::tensorflow::GraphDebugInfo_FileLineCol*
  unsafe_arena_release_file_line_col();
...
class CodeLocation PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.CodeLocation)
                   */
{
 public:
  ...
  CodeLocation(CodeLocation&& from) noexcept : CodeLocation() {
    *this = ::std::move(from);
  }
...
class GraphOpCreation PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.GraphOpCreation)
                   */
{
 public:
  ...
  GraphOpCreation(GraphOpCreation&& from) noexcept : GraphOpCreation() {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& input_names()
      const;
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_op_type(std::string* op_type);
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_op_name(std::string* op_name);
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_graph_name(std::string* graph_name);
...
class DebuggedGraph PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.DebuggedGraph)
                   */
{
 public:
  ...
  DebuggedGraph(DebuggedGraph&& from) noexcept : DebuggedGraph() {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
  instrumented_ops() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
  mutable_instrumented_ops();
 ...
 public:
  ...
  void set_allocated_instrumented_graph_def(
...
class DebuggedDevice PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.DebuggedDevice)
                   */
{
 public:
  ...
  DebuggedDevice(DebuggedDevice&& from) noexcept : DebuggedDevice() {
    *this = ::std::move(from);
  }
...
class Execution PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.Execution)
                   */
{
 public:
  ...
  Execution(Execution&& from) noexcept : Execution() {
    *this = ::std::move(from);
  }
  ...
  static inline const Execution* internal_default_instance() {
    return reinterpret_cast<const Execution*>(&_Execution_default_instance_);
  }
 ...
 private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_output_tensor_device_ids(
      int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::PROTOBUF_NAMESPACE_ID::int32>&
  _internal_output_tensor_device_ids() const;
  void _internal_add_output_tensor_device_ids(
 ...
 public:
  ...
  void set_output_tensor_device_ids(int index,
                                    ::PROTOBUF_NAMESPACE_ID::int32 value);
...
class GraphExecutionTrace PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.GraphExecutionTrace)
                   */
{
 public:
...
// double wall_time = 1;
inline void DebugEvent::clear_wall_time() { wall_time_ = 0; }
inline double DebugEvent::_internal_wall_time() const { return wall_time_; }
...
// int64 step = 2;
inline void DebugEvent::clear_step() { step_ = PROTOBUF_LONGLONG(0); }
...
inline void DebugEvent::_internal_set_step(
...
inline const ::tensorflow::DebugMetadata& DebugEvent::_internal_debug_metadata()
    const {
  return _internal_has_debug_metadata()
             ? *what_.debug_metadata_
             : *reinterpret_cast<::tensorflow::DebugMetadata*>(
                   &::tensorflow::_DebugMetadata_default_instance_);
}
...
inline ::tensorflow::DebugMetadata*
DebugEvent::unsafe_arena_release_debug_metadata() {
...
inline void DebugEvent::unsafe_arena_set_allocated_debug_metadata(
    ::tensorflow::DebugMetadata* debug_metadata) {
  clear_what();
  if (debug_metadata) {
...
inline ::tensorflow::DebugMetadata*
DebugEvent::_internal_mutable_debug_metadata() {
  if (!_internal_has_debug_metadata()) {
    clear_what();
    set_has_debug_metadata();
    what_.debug_metadata_ =
        CreateMaybeMessage<::tensorflow::DebugMetadata>(GetArena());
  }
...
inline void DebugEvent::set_has_source_file() { _oneof_case_[0] = kSourceFile; }
...
inline const ::tensorflow::SourceFile& DebugEvent::_internal_source_file()
    const {
  return _internal_has_source_file()
             ? *what_.source_file_
             : *reinterpret_cast<::tensorflow::SourceFile*>(
                   &::tensorflow::_SourceFile_default_instance_);
}
...
inline ::tensorflow::SourceFile*
DebugEvent::unsafe_arena_release_source_file() {
...
inline void DebugEvent::unsafe_arena_set_allocated_source_file(
    ::tensorflow::SourceFile* source_file) {
  clear_what();
  if (source_file) {
    set_has_source_file();
...
inline ::tensorflow::SourceFile* DebugEvent::_internal_mutable_source_file() {
  if (!_internal_has_source_file()) {
    ...
    set_has_source_file();
    what_.source_file_ =
        CreateMaybeMessage<::tensorflow::SourceFile>(GetArena());
  }
...
inline ::tensorflow::StackFrameWithId*
DebugEvent::release_stack_frame_with_id() {
...
inline const ::tensorflow::StackFrameWithId&
DebugEvent::_internal_stack_frame_with_id() const {
  return _internal_has_stack_frame_with_id()
             ? *what_.stack_frame_with_id_
             : *reinterpret_cast<::tensorflow::StackFrameWithId*>(
                   &::tensorflow::_StackFrameWithId_default_instance_);
}
inline const ::tensorflow::StackFrameWithId& DebugEvent::stack_frame_with_id()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.DebugEvent.stack_frame_with_id)
  return _internal_stack_frame_with_id();
}
inline ::tensorflow::StackFrameWithId*
DebugEvent::unsafe_arena_release_stack_frame_with_id() {
...
inline void DebugEvent::unsafe_arena_set_allocated_stack_frame_with_id(
    ::tensorflow::StackFrameWithId* stack_frame_with_id) {
  clear_what();
...
inline ::tensorflow::StackFrameWithId*
DebugEvent::_internal_mutable_stack_frame_with_id() {
  if (!_internal_has_stack_frame_with_id()) {
    clear_what();
    set_has_stack_frame_with_id();
    what_.stack_frame_with_id_ =
        CreateMaybeMessage<::tensorflow::StackFrameWithId>(GetArena());
  }
  return what_.stack_frame_with_id_;
}
inline ::tensorflow::StackFrameWithId*
DebugEvent::mutable_stack_frame_with_id() {
...
inline const ::tensorflow::GraphOpCreation&
DebugEvent::_internal_graph_op_creation() const {
  return _internal_has_graph_op_creation()
             ? *what_.graph_op_creation_
             : *reinterpret_cast<::tensorflow::GraphOpCreation*>(
                   &::tensorflow::_GraphOpCreation_default_instance_);
}
inline const ::tensorflow::GraphOpCreation& DebugEvent::graph_op_creation()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.DebugEvent.graph_op_creation)
  return _internal_graph_op_creation();
}
inline ::tensorflow::GraphOpCreation*
DebugEvent::unsafe_arena_release_graph_op_creation() {
...
inline void DebugEvent::unsafe_arena_set_allocated_graph_op_creation(
    ::tensorflow::GraphOpCreation* graph_op_creation) {
  clear_what();
...
inline ::tensorflow::GraphOpCreation*
DebugEvent::_internal_mutable_graph_op_creation() {
  if (!_internal_has_graph_op_creation()) {
    clear_what();
    set_has_graph_op_creation();
    what_.graph_op_creation_ =
        CreateMaybeMessage<::tensorflow::GraphOpCreation>(GetArena());
  }
...
inline const ::tensorflow::DebuggedGraph& DebugEvent::_internal_debugged_graph()
    const {
  return _internal_has_debugged_graph()
             ? *what_.debugged_graph_
             : *reinterpret_cast<::tensorflow::DebuggedGraph*>(
                   &::tensorflow::_DebuggedGraph_default_instance_);
}
...
inline ::tensorflow::DebuggedGraph*
DebugEvent::unsafe_arena_release_debugged_graph() {
...
inline void DebugEvent::unsafe_arena_set_allocated_debugged_graph(
    ::tensorflow::DebuggedGraph* debugged_graph) {
  clear_what();
  if (debugged_graph) {
...
inline ::tensorflow::DebuggedGraph*
DebugEvent::_internal_mutable_debugged_graph() {
  if (!_internal_has_debugged_graph()) {
    clear_what();
    set_has_debugged_graph();
    what_.debugged_graph_ =
        CreateMaybeMessage<::tensorflow::DebuggedGraph>(GetArena());
  }
...
inline void DebugEvent::set_has_execution() { _oneof_case_[0] = kExecution; }
...
inline const ::tensorflow::Execution& DebugEvent::_internal_execution() const {
  return _internal_has_execution()
             ? *what_.execution_
             : *reinterpret_cast<::tensorflow::Execution*>(
                   &::tensorflow::_Execution_default_instance_);
}
...
inline void DebugEvent::unsafe_arena_set_allocated_execution(
...
inline ::tensorflow::GraphExecutionTrace*
DebugEvent::release_graph_execution_trace() {
...
inline const ::tensorflow::GraphExecutionTrace&
DebugEvent::_internal_graph_execution_trace() const {
  return _internal_has_graph_execution_trace()
             ? *what_.graph_execution_trace_
             : *reinterpret_cast<::tensorflow::GraphExecutionTrace*>(
                   &::tensorflow::_GraphExecutionTrace_default_instance_);
}
inline const ::tensorflow::GraphExecutionTrace&
DebugEvent::graph_execution_trace() const {
  // @@protoc_insertion_point(field_get:tensorflow.DebugEvent.graph_execution_trace)
  return _internal_graph_execution_trace();
}
inline ::tensorflow::GraphExecutionTrace*
DebugEvent::unsafe_arena_release_graph_execution_trace() {
...
inline void DebugEvent::unsafe_arena_set_allocated_graph_execution_trace(
    ::tensorflow::GraphExecutionTrace* graph_execution_trace) {
  clear_what();
...
inline ::tensorflow::GraphExecutionTrace*
DebugEvent::_internal_mutable_graph_execution_trace() {
  if (!_internal_has_graph_execution_trace()) {
    clear_what();
    set_has_graph_execution_trace();
    what_.graph_execution_trace_ =
        CreateMaybeMessage<::tensorflow::GraphExecutionTrace>(GetArena());
  }
  return what_.graph_execution_trace_;
}
inline ::tensorflow::GraphExecutionTrace*
DebugEvent::mutable_graph_execution_trace() {
...
inline void DebugEvent::set_has_graph_id() { _oneof_case_[0] = kGraphId; }
inline void DebugEvent::clear_graph_id() {
  if (_internal_has_graph_id()) {
    what_.graph_id_.Destroy(
...
inline void DebugEvent::_internal_set_graph_id(const std::string& value) {
  if (!_internal_has_graph_id()) {
    clear_what();
    set_has_graph_id();
    what_.graph_id_.UnsafeSetDefault(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  what_.graph_id_.Set(
...
inline void DebugEvent::set_graph_id(const char* value, size_t size) {
  if (!_internal_has_graph_id()) {
    clear_what();
    set_has_graph_id();
    what_.graph_id_.UnsafeSetDefault(
...
inline std::string* DebugEvent::_internal_mutable_graph_id() {
  ...
  return what_.graph_id_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline std::string* DebugEvent::release_graph_id() {
  ...
  if (_internal_has_graph_id()) {
    clear_has_what();
    return what_.graph_id_.Release(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        GetArena());
  } else {
    return nullptr;
...
inline void DebugEvent::unsafe_arena_set_allocated_graph_id(
    std::string* graph_id) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (!_internal_has_graph_id()) {
    what_.graph_id_.UnsafeSetDefault(
  ...
  if (graph_id) {
    set_has_graph_id();
    what_.graph_id_.UnsafeArenaSetAllocated(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        graph_id, GetArena());
  }
...
inline const ::tensorflow::DebuggedDevice&
DebugEvent::_internal_debugged_device() const {
  return _internal_has_debugged_device()
             ? *what_.debugged_device_
             : *reinterpret_cast<::tensorflow::DebuggedDevice*>(
                   &::tensorflow::_DebuggedDevice_default_instance_);
}
...
inline ::tensorflow::DebuggedDevice*
DebugEvent::unsafe_arena_release_debugged_device() {
...
inline void DebugEvent::unsafe_arena_set_allocated_debugged_device(
    ::tensorflow::DebuggedDevice* debugged_device) {
  clear_what();
  if (debugged_device) {
...
inline ::tensorflow::DebuggedDevice*
DebugEvent::_internal_mutable_debugged_device() {
  if (!_internal_has_debugged_device()) {
    clear_what();
    set_has_debugged_device();
    what_.debugged_device_ =
        CreateMaybeMessage<::tensorflow::DebuggedDevice>(GetArena());
  }
...
inline bool DebugEvent::has_what() const { return what_case() != WHAT_NOT_SET; }
inline void DebugEvent::clear_has_what() { _oneof_case_[0] = WHAT_NOT_SET; }
...
inline void DebugMetadata::_internal_set_tensorflow_version(
...
inline void DebugMetadata::set_allocated_tensorflow_version(
    std::string* tensorflow_version) {
...
inline void DebugMetadata::_internal_set_file_version(
    const std::string& value) {
  file_version_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value,
      GetArena());
...
inline void DebugMetadata::set_file_version(const char* value, size_t size) {
  file_version_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* DebugMetadata::release_file_version() {
  ...
  return file_version_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DebugMetadata::set_allocated_file_version(
    std::string* file_version) {
  if (file_version != nullptr) {
  } else {
  }
  file_version_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* DebugMetadata::unsafe_arena_release_file_version() {
  ...
  return file_version_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DebugMetadata::unsafe_arena_set_allocated_file_version(
  ...
  file_version_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      file_version, GetArena());
...
inline void DebugMetadata::_internal_set_tfdbg_run_id(
    const std::string& value) {
  tfdbg_run_id_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value,
      GetArena());
...
inline void DebugMetadata::set_tfdbg_run_id(const char* value, size_t size) {
  tfdbg_run_id_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* DebugMetadata::release_tfdbg_run_id() {
  ...
  return tfdbg_run_id_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DebugMetadata::set_allocated_tfdbg_run_id(
    std::string* tfdbg_run_id) {
  if (tfdbg_run_id != nullptr) {
  } else {
  }
  tfdbg_run_id_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* DebugMetadata::unsafe_arena_release_tfdbg_run_id() {
  ...
  return tfdbg_run_id_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DebugMetadata::unsafe_arena_set_allocated_tfdbg_run_id(
  ...
  tfdbg_run_id_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      tfdbg_run_id, GetArena());
...
inline void SourceFile::set_file_path(const char* value, size_t size) {
  file_path_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* SourceFile::unsafe_arena_release_file_path() {
  ...
  return file_path_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SourceFile::unsafe_arena_set_allocated_file_path(
  ...
  file_path_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      file_path, GetArena());
...
inline void SourceFile::set_host_name(const char* value, size_t size) {
  host_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* SourceFile::unsafe_arena_release_host_name() {
  ...
  return host_name_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SourceFile::unsafe_arena_set_allocated_host_name(
  ...
  host_name_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      host_name, GetArena());
...
// repeated string lines = 3;
inline int SourceFile::_internal_lines_size() const { return lines_.size(); }
inline int SourceFile::lines_size() const { return _internal_lines_size(); }
inline void SourceFile::clear_lines() { lines_.Clear(); }
...
inline void SourceFile::set_lines(int index, const char* value, size_t size) {
  lines_.Mutable(index)->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:tensorflow.SourceFile.lines)
}
inline std::string* SourceFile::_internal_add_lines() { return lines_.Add(); }
...
inline void StackFrameWithId::set_id(const char* value, size_t size) {
  id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline void StackFrameWithId::unsafe_arena_set_allocated_id(std::string* id) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (id != nullptr) {
  } else {
  }
...
inline const ::tensorflow::GraphDebugInfo_FileLineCol&
StackFrameWithId::_internal_file_line_col() const {
...
inline const ::tensorflow::GraphDebugInfo_FileLineCol&
StackFrameWithId::file_line_col() const {
...
inline ::tensorflow::GraphDebugInfo_FileLineCol*
StackFrameWithId::release_file_line_col() {
...
inline ::tensorflow::GraphDebugInfo_FileLineCol*
StackFrameWithId::unsafe_arena_release_file_line_col() {
...
inline ::tensorflow::GraphDebugInfo_FileLineCol*
StackFrameWithId::_internal_mutable_file_line_col() {
  if (file_line_col_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::GraphDebugInfo_FileLineCol>(
        GetArena());
    file_line_col_ = p;
  }
...
inline void CodeLocation::set_host_name(const char* value, size_t size) {
  host_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline void CodeLocation::clear_stack_frame_ids() { stack_frame_ids_.Clear(); }
...
inline const std::string& CodeLocation::_internal_stack_frame_ids(
    int index) const {
...
inline void CodeLocation::set_stack_frame_ids(int index,
                                              const std::string& value) {
...
inline void CodeLocation::set_stack_frame_ids(int index, const char* value,
                                              size_t size) {
  stack_frame_ids_.Mutable(index)->assign(reinterpret_cast<const char*>(value),
                                          size);
...
inline void GraphOpCreation::set_op_type(const char* value, size_t size) {
  op_type_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline void GraphOpCreation::unsafe_arena_set_allocated_op_type(
  ...
  op_type_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      op_type, GetArena());
...
inline void GraphOpCreation::set_op_name(const char* value, size_t size) {
  op_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* GraphOpCreation::unsafe_arena_release_op_name() {
  ...
  return op_name_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void GraphOpCreation::unsafe_arena_set_allocated_op_name(
  ...
  op_name_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      op_name, GetArena());
...
inline void GraphOpCreation::_internal_set_graph_name(
    const std::string& value) {
  graph_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value,
      GetArena());
...
inline void GraphOpCreation::set_graph_name(const char* value, size_t size) {
  graph_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* GraphOpCreation::unsafe_arena_release_graph_name() {
  ...
  return graph_name_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void GraphOpCreation::unsafe_arena_set_allocated_graph_name(
  ...
  graph_name_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      graph_name, GetArena());
...
inline void GraphOpCreation::set_graph_id(const char* value, size_t size) {
  graph_id_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* GraphOpCreation::unsafe_arena_release_graph_id() {
  ...
  return graph_id_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void GraphOpCreation::unsafe_arena_set_allocated_graph_id(
  ...
  graph_id_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      graph_id, GetArena());
...
inline void GraphOpCreation::_internal_set_device_name(
    const std::string& value) {
  device_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value,
      GetArena());
...
inline void GraphOpCreation::set_device_name(const char* value, size_t size) {
  device_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline void GraphOpCreation::set_allocated_device_name(
...
inline void GraphOpCreation::clear_input_names() { input_names_.Clear(); }
...
inline const std::string& GraphOpCreation::_internal_input_names(
    int index) const {
...
inline void GraphOpCreation::set_input_names(int index,
                                             const std::string& value) {
...
inline void GraphOpCreation::set_input_names(int index, const char* value,
                                             size_t size) {
  input_names_.Mutable(index)->assign(reinterpret_cast<const char*>(value),
                                      size);
...
// int32 num_outputs = 7;
inline void GraphOpCreation::clear_num_outputs() { num_outputs_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphOpCreation::_internal_num_outputs()
    const {
  return num_outputs_;
}
...
inline void GraphOpCreation::_internal_set_num_outputs(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  num_outputs_ = value;
}
inline void GraphOpCreation::set_num_outputs(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline const ::tensorflow::CodeLocation&
GraphOpCreation::_internal_code_location() const {
  const ::tensorflow::CodeLocation* p = code_location_;
  return p != nullptr ? *p
                      : *reinterpret_cast<const ::tensorflow::CodeLocation*>(
                            &::tensorflow::_CodeLocation_default_instance_);
}
inline const ::tensorflow::CodeLocation& GraphOpCreation::code_location()
    const {
...
inline ::tensorflow::CodeLocation*
GraphOpCreation::unsafe_arena_release_code_location() {
...
inline ::tensorflow::CodeLocation*
GraphOpCreation::_internal_mutable_code_location() {
...
inline void GraphOpCreation::set_allocated_code_location(
    ::tensorflow::CodeLocation* code_location) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete code_location_;
...
GraphOpCreation::_internal_output_tensor_ids(int index) const {
  return output_tensor_ids_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GraphOpCreation::output_tensor_ids(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.GraphOpCreation.output_tensor_ids)
  return _internal_output_tensor_ids(index);
}
inline void GraphOpCreation::set_output_tensor_ids(
...
inline void GraphOpCreation::_internal_add_output_tensor_ids(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  output_tensor_ids_.Add(value);
}
inline void GraphOpCreation::add_output_tensor_ids(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void DebuggedGraph::set_graph_id(const char* value, size_t size) {
  graph_id_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline void DebuggedGraph::set_graph_name(const char* value, size_t size) {
  graph_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline const std::string& DebuggedGraph::_internal_instrumented_ops(
    int index) const {
...
inline void DebuggedGraph::set_instrumented_ops(int index,
                                                const std::string& value) {
...
inline void DebuggedGraph::set_instrumented_ops(int index, const char* value,
                                                size_t size) {
  instrumented_ops_.Mutable(index)->assign(reinterpret_cast<const char*>(value),
                                           size);
...
inline void DebuggedGraph::clear_original_graph_def() {
  original_graph_def_.ClearToEmpty(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
...
inline void DebuggedGraph::_internal_set_original_graph_def(
    const std::string& value) {
...
inline std::string* DebuggedGraph::_internal_mutable_original_graph_def() {
  return original_graph_def_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline std::string* DebuggedGraph::release_original_graph_def() {
  ...
  return original_graph_def_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DebuggedGraph::set_allocated_original_graph_def(
    std::string* original_graph_def) {
  if (original_graph_def != nullptr) {
  } else {
  }
  original_graph_def_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* DebuggedGraph::unsafe_arena_release_original_graph_def() {
  ...
  return original_graph_def_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DebuggedGraph::unsafe_arena_set_allocated_original_graph_def(
  ...
  original_graph_def_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      original_graph_def, GetArena());
...
inline void DebuggedGraph::clear_instrumented_graph_def() {
  instrumented_graph_def_.ClearToEmpty(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
...
inline void DebuggedGraph::set_instrumented_graph_def(
    const std::string& value) {
...
inline const std::string& DebuggedGraph::_internal_instrumented_graph_def()
    const {
  return instrumented_graph_def_.Get();
}
inline void DebuggedGraph::_internal_set_instrumented_graph_def(
    const std::string& value) {
...
inline std::string* DebuggedGraph::_internal_mutable_instrumented_graph_def() {
  return instrumented_graph_def_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline std::string* DebuggedGraph::release_instrumented_graph_def() {
  ...
  return instrumented_graph_def_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DebuggedGraph::set_allocated_instrumented_graph_def(
    std::string* instrumented_graph_def) {
  if (instrumented_graph_def != nullptr) {
  } else {
  }
  instrumented_graph_def_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string*
DebuggedGraph::unsafe_arena_release_instrumented_graph_def() {
  // @@protoc_insertion_point(field_unsafe_arena_release:tensorflow.DebuggedGraph.instrumented_graph_def)
  GOOGLE_DCHECK(GetArena() != nullptr);

  return instrumented_graph_def_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DebuggedGraph::unsafe_arena_set_allocated_instrumented_graph_def(
  ...
  instrumented_graph_def_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      instrumented_graph_def, GetArena());
...
inline void DebuggedGraph::clear_outer_context_id() {
  outer_context_id_.ClearToEmpty(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
...
inline void DebuggedGraph::_internal_set_outer_context_id(
    const std::string& value) {
...
inline std::string* DebuggedGraph::_internal_mutable_outer_context_id() {
  return outer_context_id_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline std::string* DebuggedGraph::release_outer_context_id() {
  ...
  return outer_context_id_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DebuggedGraph::set_allocated_outer_context_id(
    std::string* outer_context_id) {
  if (outer_context_id != nullptr) {
  } else {
  }
  outer_context_id_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* DebuggedGraph::unsafe_arena_release_outer_context_id() {
  ...
  return outer_context_id_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DebuggedGraph::unsafe_arena_set_allocated_outer_context_id(
  ...
  outer_context_id_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      outer_context_id, GetArena());
...
inline void DebuggedDevice::_internal_set_device_name(
    const std::string& value) {
  device_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value,
      GetArena());
...
inline void DebuggedDevice::set_device_name(const char* value, size_t size) {
  device_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline void DebuggedDevice::set_allocated_device_name(
    std::string* device_name) {
  if (device_name != nullptr) {
  } else {
  }
...
// int32 device_id = 2;
inline void DebuggedDevice::clear_device_id() { device_id_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 DebuggedDevice::_internal_device_id()
    const {
  return device_id_;
}
...
inline void DebuggedDevice::_internal_set_device_id(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  device_id_ = value;
}
inline void DebuggedDevice::set_device_id(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void Execution::set_op_type(const char* value, size_t size) {
  op_type_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
// int32 num_outputs = 2;
inline void Execution::clear_num_outputs() { num_outputs_ = 0; }
...
inline void Execution::_internal_set_num_outputs(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  num_outputs_ = value;
}
...
inline void Execution::set_graph_id(const char* value, size_t size) {
  graph_id_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline void Execution::clear_input_tensor_ids() { input_tensor_ids_.Clear(); }
inline ::PROTOBUF_NAMESPACE_ID::int64 Execution::_internal_input_tensor_ids(
    int index) const {
  return input_tensor_ids_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Execution::input_tensor_ids(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.Execution.input_tensor_ids)
  return _internal_input_tensor_ids(index);
}
inline void Execution::set_input_tensor_ids(
...
inline void Execution::_internal_add_input_tensor_ids(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  input_tensor_ids_.Add(value);
}
inline void Execution::add_input_tensor_ids(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void Execution::clear_output_tensor_ids() { output_tensor_ids_.Clear(); }
inline ::PROTOBUF_NAMESPACE_ID::int64 Execution::_internal_output_tensor_ids(
    int index) const {
  return output_tensor_ids_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Execution::output_tensor_ids(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.Execution.output_tensor_ids)
  return _internal_output_tensor_ids(index);
}
inline void Execution::set_output_tensor_ids(
    int index, ::PROTOBUF_NAMESPACE_ID::int64 value) {
  output_tensor_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:tensorflow.Execution.output_tensor_ids)
}
inline void Execution::_internal_add_output_tensor_ids(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  output_tensor_ids_.Add(value);
}
inline void Execution::add_output_tensor_ids(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_add_output_tensor_ids(value);
...
// .tensorflow.TensorDebugMode tensor_debug_mode = 6;
inline void Execution::clear_tensor_debug_mode() { tensor_debug_mode_ = 0; }
inline ::tensorflow::TensorDebugMode Execution::_internal_tensor_debug_mode()
    const {
...
inline void Execution::_internal_set_tensor_debug_mode(
    ::tensorflow::TensorDebugMode value) {
  tensor_debug_mode_ = value;
}
inline void Execution::set_tensor_debug_mode(
    ::tensorflow::TensorDebugMode value) {
...
inline const ::tensorflow::TensorProto& Execution::_internal_tensor_protos(
    int index) const {
  return tensor_protos_.Get(index);
}
inline const ::tensorflow::TensorProto& Execution::tensor_protos(
    int index) const {
...
inline const ::tensorflow::CodeLocation& Execution::_internal_code_location()
    const {
  const ::tensorflow::CodeLocation* p = code_location_;
  return p != nullptr ? *p
                      : *reinterpret_cast<const ::tensorflow::CodeLocation*>(
...
inline ::tensorflow::CodeLocation*
Execution::unsafe_arena_release_code_location() {
...
inline ::tensorflow::CodeLocation*
Execution::_internal_mutable_code_location() {
  if (code_location_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::CodeLocation>(GetArena());
    code_location_ = p;
  }
...
inline void Execution::set_allocated_code_location(
    ::tensorflow::CodeLocation* code_location) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete code_location_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32
Execution::_internal_output_tensor_device_ids(int index) const {
  return output_tensor_device_ids_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Execution::output_tensor_device_ids(
    int index) const {
...
inline void Execution::set_output_tensor_device_ids(
    int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  output_tensor_device_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:tensorflow.Execution.output_tensor_device_ids)
}
inline void Execution::_internal_add_output_tensor_device_ids(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  output_tensor_device_ids_.Add(value);
}
inline void Execution::add_output_tensor_device_ids(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void GraphExecutionTrace::clear_tfdbg_context_id() {
  tfdbg_context_id_.ClearToEmpty(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
...
inline void GraphExecutionTrace::set_tfdbg_context_id(
    const std::string& value) {
...
inline const std::string& GraphExecutionTrace::_internal_tfdbg_context_id()
    const {
  return tfdbg_context_id_.Get();
}
inline void GraphExecutionTrace::_internal_set_tfdbg_context_id(
    const std::string& value) {
...
inline std::string* GraphExecutionTrace::_internal_mutable_tfdbg_context_id() {
  return tfdbg_context_id_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
...
inline void GraphExecutionTrace::unsafe_arena_set_allocated_tfdbg_context_id(
  ...
  tfdbg_context_id_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      tfdbg_context_id, GetArena());
...
inline void GraphExecutionTrace::_internal_set_op_name(
    const std::string& value) {
  op_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value,
      GetArena());
...
inline void GraphExecutionTrace::set_op_name(const char* value, size_t size) {
  op_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
// int32 output_slot = 3;
inline void GraphExecutionTrace::clear_output_slot() { output_slot_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32
GraphExecutionTrace::_internal_output_slot() const {
  return output_slot_;
}
...
inline void GraphExecutionTrace::_internal_set_output_slot(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  output_slot_ = value;
}
inline void GraphExecutionTrace::set_output_slot(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::tensorflow::TensorDebugMode
GraphExecutionTrace::_internal_tensor_debug_mode() const {
  return static_cast<::tensorflow::TensorDebugMode>(tensor_debug_mode_);
}
inline ::tensorflow::TensorDebugMode GraphExecutionTrace::tensor_debug_mode()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.GraphExecutionTrace.tensor_debug_mode)
  return _internal_tensor_debug_mode();
}
inline void GraphExecutionTrace::_internal_set_tensor_debug_mode(
    ::tensorflow::TensorDebugMode value) {
  tensor_debug_mode_ = value;
}
inline void GraphExecutionTrace::set_tensor_debug_mode(
    ::tensorflow::TensorDebugMode value) {
  _internal_set_tensor_debug_mode(value);
...
GraphExecutionTrace::_internal_tensor_proto() const {
...
inline const ::tensorflow::TensorProto& GraphExecutionTrace::tensor_proto()
    const {
...
GraphExecutionTrace::unsafe_arena_release_tensor_proto() {
...
inline ::tensorflow::TensorProto*
GraphExecutionTrace::_internal_mutable_tensor_proto() {
...
inline void GraphExecutionTrace::set_allocated_tensor_proto(
    ::tensorflow::TensorProto* tensor_proto) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(
...
inline void GraphExecutionTrace::_internal_set_device_name(
    const std::string& value) {
  device_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value,
      GetArena());
...
inline void GraphExecutionTrace::set_allocated_device_name(
    std::string* device_name) {
  if (device_name != nullptr) {
  } else {
  }
...
GetEnumDescriptor<::tensorflow::TensorDebugMode>() {
