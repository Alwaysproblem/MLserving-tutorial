...
class TensorDescriptionDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<TensorDescription>
      _instance;
} _TensorDescription_default_instance_;
}  // namespace tensorflow
static void
InitDefaultsscc_info_TensorDescription_tensorflow_2fcore_2fframework_2ftensor_5fdescription_2eproto() {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_2fcore_2fframework_2ftensor_5fdescription_2eproto
        [1];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_2fcore_2fframework_2ftensor_5fdescription_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::TensorDescription,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fdescription_2eproto_sccs
        [1] = {
            &scc_info_TensorDescription_tensorflow_2fcore_2fframework_2ftensor_5fdescription_2eproto
                 .base,
};
...
static bool dynamic_init_dummy_tensorflow_2fcore_2fframework_2ftensor_5fdescription_2eproto =
...
void TensorDescription::InitAsDefaultInstance() {
  ::tensorflow::_TensorDescription_default_instance_._instance.get_mutable()
      ->shape_ = const_cast<::tensorflow::TensorShapeProto*>(
      ::tensorflow::TensorShapeProto::internal_default_instance());
  ::tensorflow::_TensorDescription_default_instance_._instance.get_mutable()
      ->allocation_description_ =
      const_cast<::tensorflow::AllocationDescription*>(
...
class TensorDescription::_Internal {
 public:
  static const ::tensorflow::TensorShapeProto& shape(
      const TensorDescription* msg);
  static const ::tensorflow::AllocationDescription& allocation_description(
      const TensorDescription* msg);
};

const ::tensorflow::TensorShapeProto& TensorDescription::_Internal::shape(
    const TensorDescription* msg) {
  return *msg->shape_;
}
const ::tensorflow::AllocationDescription&
TensorDescription::_Internal::allocation_description(
    const TensorDescription* msg) {
...
TensorDescription::TensorDescription(const TensorDescription& from)
  ...
  if (from._internal_has_allocation_description()) {
    allocation_description_ =
        new ::tensorflow::AllocationDescription(*from.allocation_description_);
  } else {
    allocation_description_ = nullptr;
  }
  dtype_ = from.dtype_;
...
const char* TensorDescription::_InternalParse(
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr = ctx->ParseMessage(_internal_mutable_allocation_description(),
                                  ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
...
void TensorDescription::MergeFrom(
  ...
  const TensorDescription* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<TensorDescription>(&from);
  if (source == nullptr) {
...
void TensorDescription::MergeFrom(const TensorDescription& from) {
  ...
  if (from.has_allocation_description()) {
    _internal_mutable_allocation_description()
        ->::tensorflow::AllocationDescription::MergeFrom(
...
bool TensorDescription::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::TensorDescription*
