...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_RemoteFusedGraphExecuteInfo_TensorShapeTypeProto_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto;
...
static void
InitDefaultsscc_info_RemoteFusedGraphExecuteInfo_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
    scc_info_RemoteFusedGraphExecuteInfo_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto =
        {{ATOMIC_VAR_INIT(
...
static void
InitDefaultsscc_info_RemoteFusedGraphExecuteInfo_TensorShapeTypeProto_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const**
    file_level_enum_descriptors_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto =
        nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const**
    file_level_service_descriptors_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto =
        nullptr;
    ...
    TableStruct_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ...
            PROTOBUF_FIELD_OFFSET(
                ...
                shape_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::RemoteFusedGraphExecuteInfo,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
...
static ::PROTOBUF_NAMESPACE_ID::Message const* const file_default_instances[] = {
    reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
        &::tensorflow::
            _RemoteFusedGraphExecuteInfo_TensorShapeTypeProto_default_instance_),
    reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
        &::tensorflow::_RemoteFusedGraphExecuteInfo_default_instance_),
};

const char
    descriptor_table_protodef_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto
...
static bool dynamic_init_dummy_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto =
...
class RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::_Internal {
 public:
  static const ::tensorflow::TensorShapeProto& shape(
      const RemoteFusedGraphExecuteInfo_TensorShapeTypeProto* msg);
};

const ::tensorflow::TensorShapeProto&
RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::_Internal::shape(
    const RemoteFusedGraphExecuteInfo_TensorShapeTypeProto* msg) {
  return *msg->shape_;
}
...
void RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::ArenaDtor(void* object) {
  RemoteFusedGraphExecuteInfo_TensorShapeTypeProto* _this =
      reinterpret_cast<RemoteFusedGraphExecuteInfo_TensorShapeTypeProto*>(
          object);
  (void)_this;
}
void RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::RegisterArenaDtor(
    ::PROTOBUF_NAMESPACE_ID::Arena*) {}
void RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::SetCachedSize(
    int size) const {
  _cached_size_.Set(size);
}
const RemoteFusedGraphExecuteInfo_TensorShapeTypeProto&
RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &::scc_info_RemoteFusedGraphExecuteInfo_TensorShapeTypeProto_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto
           .base);
...
const char* RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::_InternalParse(
...
RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::_InternalSerialize(
...
void RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::MergeFrom(
  ...
  const RemoteFusedGraphExecuteInfo_TensorShapeTypeProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          RemoteFusedGraphExecuteInfo_TensorShapeTypeProto>(&from);
  if (source == nullptr) {
...
void RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
void RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::InternalSwap(
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RemoteFusedGraphExecuteInfo_TensorShapeTypeProto,
                            dtype_) +
      sizeof(RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::dtype_) -
      PROTOBUF_FIELD_OFFSET(RemoteFusedGraphExecuteInfo_TensorShapeTypeProto,
                            shape_)>(reinterpret_cast<char*>(&shape_),
                                     reinterpret_cast<char*>(&other->shape_));
}

::PROTOBUF_NAMESPACE_ID::Metadata
RemoteFusedGraphExecuteInfo_TensorShapeTypeProto::GetMetadata() const {
...
void RemoteFusedGraphExecuteInfo::InitAsDefaultInstance() {
  ::tensorflow::_RemoteFusedGraphExecuteInfo_default_instance_._instance
      .get_mutable()
...
class RemoteFusedGraphExecuteInfo::_Internal {
 public:
  static const ::tensorflow::GraphDef& remote_graph(
      const RemoteFusedGraphExecuteInfo* msg);
};

const ::tensorflow::GraphDef&
RemoteFusedGraphExecuteInfo::_Internal::remote_graph(
    const RemoteFusedGraphExecuteInfo* msg) {
...
RemoteFusedGraphExecuteInfo::RemoteFusedGraphExecuteInfo(
    ...
    : ::PROTOBUF_NAMESPACE_ID::Message(),
      ...
      default_graph_output_tensor_shape_(
          from.default_graph_output_tensor_shape_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      from._internal_metadata_);
  executor_name_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_executor_name().empty()) {
    executor_name_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_executor_name(), GetArena());
  }
  serialized_executor_parameters_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_serialized_executor_parameters().empty()) {
    serialized_executor_parameters_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_serialized_executor_parameters(), GetArena());
  }
...
void RemoteFusedGraphExecuteInfo::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  executor_name_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  serialized_executor_parameters_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (this != internal_default_instance()) delete remote_graph_;
}

void RemoteFusedGraphExecuteInfo::ArenaDtor(void* object) {
  RemoteFusedGraphExecuteInfo* _this =
      reinterpret_cast<RemoteFusedGraphExecuteInfo*>(object);
  (void)_this;
}
void RemoteFusedGraphExecuteInfo::RegisterArenaDtor(
    ::PROTOBUF_NAMESPACE_ID::Arena*) {}
void RemoteFusedGraphExecuteInfo::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const RemoteFusedGraphExecuteInfo&
RemoteFusedGraphExecuteInfo::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &::scc_info_RemoteFusedGraphExecuteInfo_tensorflow_2fcore_2fframework_2fremote_5ffused_5fgraph_5fexecute_5finfo_2eproto
           .base);
  return *internal_default_instance();
...
const char* RemoteFusedGraphExecuteInfo::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
        ...
        if (PROTOBUF_PREDICT_TRUE(
          ...
          do {
            ...
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
                str,
                "tensorflow.RemoteFusedGraphExecuteInfo.graph_input_node_"
                "name"));
            CHK_(ptr);
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          do {
            ...
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
                str,
                "tensorflow.RemoteFusedGraphExecuteInfo.graph_output_node_"
                "name"));
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(
              str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.RemoteFusedGraphExecuteInfo.executor_name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
        ...
        if (PROTOBUF_PREDICT_TRUE(
          ...
          do {
            ...
            ptr = ctx->ParseMessage(
                _internal_add_default_graph_input_tensor_shape(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(
                _internal_add_default_graph_output_tensor_shape(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
::PROTOBUF_NAMESPACE_ID::uint8* RemoteFusedGraphExecuteInfo::_InternalSerialize(
  ...
  // repeated string graph_input_node_name = 2;
  for (int i = 0, n = this->_internal_graph_input_node_name_size(); i < n;
       i++) {
  ...
  // repeated string graph_output_node_name = 3;
  for (int i = 0, n = this->_internal_graph_output_node_name_size(); i < n;
       i++) {
  ...
  if (this->executor_name().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_executor_name().data(),
        static_cast<int>(this->_internal_executor_name().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "tensorflow.RemoteFusedGraphExecuteInfo.executor_name");
    target = stream->WriteStringMaybeAliased(4, this->_internal_executor_name(),
                                             target);
  }
  ...
  for (unsigned int
           ...
           n = static_cast<unsigned int>(
               this->_internal_default_graph_input_tensor_shape_size());
       i < n; i++) {
    target = stream->EnsureSpace(target);
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            6, this->_internal_default_graph_input_tensor_shape(i), target,
            stream);
  }
  ...
  for (unsigned int
           i = 0,
           n = static_cast<unsigned int>(
               this->_internal_default_graph_output_tensor_shape_size());
       i < n; i++) {
    target = stream->EnsureSpace(target);
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            7, this->_internal_default_graph_output_tensor_shape(i), target,
            stream);
  }
...
void RemoteFusedGraphExecuteInfo::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const RemoteFusedGraphExecuteInfo* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          RemoteFusedGraphExecuteInfo>(&from);
  if (source == nullptr) {
...
void RemoteFusedGraphExecuteInfo::MergeFrom(
  ...
  default_graph_input_tensor_shape_.MergeFrom(
      from.default_graph_input_tensor_shape_);
  default_graph_output_tensor_shape_.MergeFrom(
      from.default_graph_output_tensor_shape_);
  ...
  if (from.serialized_executor_parameters().size() > 0) {
    _internal_set_serialized_executor_parameters(
        from._internal_serialized_executor_parameters());
  }
  if (from.has_remote_graph()) {
    _internal_mutable_remote_graph()->::tensorflow::GraphDef::MergeFrom(
        from._internal_remote_graph());
  }
}

void RemoteFusedGraphExecuteInfo::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool RemoteFusedGraphExecuteInfo::IsInitialized() const { return true; }

void RemoteFusedGraphExecuteInfo::InternalSwap(
    RemoteFusedGraphExecuteInfo* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      &other->_internal_metadata_);
  ...
  default_graph_input_tensor_shape_.InternalSwap(
      &other->default_graph_input_tensor_shape_);
  default_graph_output_tensor_shape_.InternalSwap(
      &other->default_graph_output_tensor_shape_);
  executor_name_.Swap(
      &other->executor_name_,
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
  serialized_executor_parameters_.Swap(
      &other->serialized_executor_parameters_,
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
  swap(remote_graph_, other->remote_graph_);
}

::PROTOBUF_NAMESPACE_ID::Metadata RemoteFusedGraphExecuteInfo::GetMetadata()
    const {
  return GetMetadataStatic();
}
...
template <>
PROTOBUF_NOINLINE ::tensorflow::RemoteFusedGraphExecuteInfo*
Arena::CreateMaybeMessage<::tensorflow::RemoteFusedGraphExecuteInfo>(
    Arena* arena) {
  return Arena::CreateMessageInternal<
      ::tensorflow::RemoteFusedGraphExecuteInfo>(arena);
}
