...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3>
        scc_info_TrackableObjectGraph_TrackableObject_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto ::
...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
        scc_info_TrackableObjectGraph_TrackableObject_SerializedTensor_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
...
class TrackableObjectGraphDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<TrackableObjectGraph>
      _instance;
} _TrackableObjectGraph_default_instance_;
}  // namespace tensorflow
static void
InitDefaultsscc_info_TrackableObjectGraph_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
    scc_info_TrackableObjectGraph_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto =
        {{ATOMIC_VAR_INIT(
...
static void
InitDefaultsscc_info_TrackableObjectGraph_TrackableObject_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr =
        &::tensorflow::_TrackableObjectGraph_TrackableObject_default_instance_;
...
static void
InitDefaultsscc_info_TrackableObjectGraph_TrackableObject_ObjectReference_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_TrackableObjectGraph_TrackableObject_SerializedTensor_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_TrackableObjectGraph_TrackableObject_SlotVariableReference_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto
        [5];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ...
            ~0u,  // no _weak_field_map_
            PROTOBUF_FIELD_OFFSET(
                ::tensorflow::TrackableObjectGraph_TrackableObject, children_),
            PROTOBUF_FIELD_OFFSET(
                ::tensorflow::TrackableObjectGraph_TrackableObject,
                attributes_),
            PROTOBUF_FIELD_OFFSET(
                ...
                slot_variables_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::TrackableObjectGraph,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
...
static ::PROTOBUF_NAMESPACE_ID::Message const* const file_default_instances[] = {
    ...
    reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
        &::tensorflow::_TrackableObjectGraph_TrackableObject_default_instance_),
    reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
        &::tensorflow::_TrackableObjectGraph_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto_sccs
        [5] = {
            &scc_info_TrackableObjectGraph_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto
                 .base,
            &scc_info_TrackableObjectGraph_TrackableObject_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto
...
static bool dynamic_init_dummy_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto =
...
void TrackableObjectGraph_TrackableObject_ObjectReference::
    InitAsDefaultInstance() {}
...
TrackableObjectGraph_TrackableObject_ObjectReference::
  ...
  local_name_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_local_name().empty()) {
    local_name_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_local_name(), GetArena());
  }
...
void TrackableObjectGraph_TrackableObject_ObjectReference::SharedDtor() {
  ...
  local_name_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void TrackableObjectGraph_TrackableObject_ObjectReference::ArenaDtor(
    void* object) {
  TrackableObjectGraph_TrackableObject_ObjectReference* _this =
      reinterpret_cast<TrackableObjectGraph_TrackableObject_ObjectReference*>(
          object);
  (void)_this;
}
void TrackableObjectGraph_TrackableObject_ObjectReference::RegisterArenaDtor(
    ::PROTOBUF_NAMESPACE_ID::Arena*) {}
void TrackableObjectGraph_TrackableObject_ObjectReference::SetCachedSize(
    int size) const {
  _cached_size_.Set(size);
}
const TrackableObjectGraph_TrackableObject_ObjectReference&
TrackableObjectGraph_TrackableObject_ObjectReference::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &::scc_info_TrackableObjectGraph_TrackableObject_ObjectReference_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto
           .base);
...
const char*
TrackableObjectGraph_TrackableObject_ObjectReference::_InternalParse(
...
TrackableObjectGraph_TrackableObject_ObjectReference::_InternalSerialize(
  ...
  if (this->local_name().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_local_name().data(),
        static_cast<int>(this->_internal_local_name().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "tensorflow.TrackableObjectGraph.TrackableObject.ObjectReference.local_"
        "name");
    target = stream->WriteStringMaybeAliased(2, this->_internal_local_name(),
                                             target);
  }
...
size_t TrackableObjectGraph_TrackableObject_ObjectReference::ByteSizeLong()
    const {
...
void TrackableObjectGraph_TrackableObject_ObjectReference::MergeFrom(
  ...
  const TrackableObjectGraph_TrackableObject_ObjectReference* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          TrackableObjectGraph_TrackableObject_ObjectReference>(&from);
  if (source == nullptr) {
...
void TrackableObjectGraph_TrackableObject_ObjectReference::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool TrackableObjectGraph_TrackableObject_ObjectReference::IsInitialized()
    const {
  return true;
}

void TrackableObjectGraph_TrackableObject_ObjectReference::InternalSwap(
...
TrackableObjectGraph_TrackableObject_ObjectReference::GetMetadata() const {
  return GetMetadataStatic();
}

// ===================================================================

void TrackableObjectGraph_TrackableObject_SerializedTensor::
    InitAsDefaultInstance() {}
...
TrackableObjectGraph_TrackableObject_SerializedTensor::
  ...
  full_name_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_full_name().empty()) {
    full_name_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_full_name(), GetArena());
  }
  checkpoint_key_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_checkpoint_key().empty()) {
    checkpoint_key_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_checkpoint_key(), GetArena());
  }
...
void TrackableObjectGraph_TrackableObject_SerializedTensor::SharedDtor() {
  ...
  name_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  full_name_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  checkpoint_key_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void TrackableObjectGraph_TrackableObject_SerializedTensor::ArenaDtor(
    void* object) {
  TrackableObjectGraph_TrackableObject_SerializedTensor* _this =
      reinterpret_cast<TrackableObjectGraph_TrackableObject_SerializedTensor*>(
          object);
  (void)_this;
}
void TrackableObjectGraph_TrackableObject_SerializedTensor::RegisterArenaDtor(
    ::PROTOBUF_NAMESPACE_ID::Arena*) {}
void TrackableObjectGraph_TrackableObject_SerializedTensor::SetCachedSize(
    int size) const {
  _cached_size_.Set(size);
}
const TrackableObjectGraph_TrackableObject_SerializedTensor&
TrackableObjectGraph_TrackableObject_SerializedTensor::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &::scc_info_TrackableObjectGraph_TrackableObject_SerializedTensor_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto
           .base);
  return *internal_default_instance();
...
const char*
TrackableObjectGraph_TrackableObject_SerializedTensor::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str,
              "tensorflow.TrackableObjectGraph.TrackableObject."
              "SerializedTensor.checkpoint_key"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
TrackableObjectGraph_TrackableObject_SerializedTensor::_InternalSerialize(
  ...
  if (this->full_name().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_full_name().data(),
        static_cast<int>(this->_internal_full_name().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "tensorflow.TrackableObjectGraph.TrackableObject.SerializedTensor.full_"
        "name");
    target =
        stream->WriteStringMaybeAliased(2, this->_internal_full_name(), target);
  }

  // string checkpoint_key = 3;
  if (this->checkpoint_key().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_checkpoint_key().data(),
        static_cast<int>(this->_internal_checkpoint_key().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "tensorflow.TrackableObjectGraph.TrackableObject.SerializedTensor."
        "checkpoint_key");
  ...
  if (this->optional_restore() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(
            4, this->_internal_optional_restore(), target);
  }
...
size_t TrackableObjectGraph_TrackableObject_SerializedTensor::ByteSizeLong()
    const {
...
void TrackableObjectGraph_TrackableObject_SerializedTensor::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const TrackableObjectGraph_TrackableObject_SerializedTensor* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          TrackableObjectGraph_TrackableObject_SerializedTensor>(&from);
  if (source == nullptr) {
...
void TrackableObjectGraph_TrackableObject_SerializedTensor::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool TrackableObjectGraph_TrackableObject_SerializedTensor::IsInitialized()
    const {
  return true;
}

void TrackableObjectGraph_TrackableObject_SerializedTensor::InternalSwap(
  ...
  full_name_.Swap(
      ...
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
  checkpoint_key_.Swap(
      &other->checkpoint_key_,
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
...
::PROTOBUF_NAMESPACE_ID::Metadata
TrackableObjectGraph_TrackableObject_SerializedTensor::GetMetadata() const {
  return GetMetadataStatic();
}

// ===================================================================

void TrackableObjectGraph_TrackableObject_SlotVariableReference::
    InitAsDefaultInstance() {}
...
TrackableObjectGraph_TrackableObject_SlotVariableReference::
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      from._internal_metadata_);
  slot_name_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_slot_name().empty()) {
    slot_name_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_slot_name(), GetArena());
  }
...
void TrackableObjectGraph_TrackableObject_SlotVariableReference::SharedCtor() {
  ...
  slot_name_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(&original_variable_node_id_, 0,
           static_cast<size_t>(
               reinterpret_cast<char*>(&slot_variable_node_id_) -
               reinterpret_cast<char*>(&original_variable_node_id_)) +
               sizeof(slot_variable_node_id_));
...
void TrackableObjectGraph_TrackableObject_SlotVariableReference::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  slot_name_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

void TrackableObjectGraph_TrackableObject_SlotVariableReference::ArenaDtor(
    void* object) {
  TrackableObjectGraph_TrackableObject_SlotVariableReference* _this =
      reinterpret_cast<
          TrackableObjectGraph_TrackableObject_SlotVariableReference*>(object);
  (void)_this;
}
void TrackableObjectGraph_TrackableObject_SlotVariableReference::
    RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {}
void TrackableObjectGraph_TrackableObject_SlotVariableReference::SetCachedSize(
    int size) const {
  _cached_size_.Set(size);
}
const TrackableObjectGraph_TrackableObject_SlotVariableReference&
TrackableObjectGraph_TrackableObject_SlotVariableReference::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &::scc_info_TrackableObjectGraph_TrackableObject_SlotVariableReference_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto
           .base);
  return *internal_default_instance();
...
const char*
TrackableObjectGraph_TrackableObject_SlotVariableReference::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str,
              "tensorflow.TrackableObjectGraph.TrackableObject."
              "SlotVariableReference.slot_name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
TrackableObjectGraph_TrackableObject_SlotVariableReference::_InternalSerialize(
  ...
  if (this->original_variable_node_id() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(
            1, this->_internal_original_variable_node_id(), target);
  }

  // string slot_name = 2;
  if (this->slot_name().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_slot_name().data(),
        static_cast<int>(this->_internal_slot_name().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "tensorflow.TrackableObjectGraph.TrackableObject.SlotVariableReference."
        "slot_name");
    target =
        stream->WriteStringMaybeAliased(2, this->_internal_slot_name(), target);
  }
  ...
  if (this->slot_variable_node_id() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(
            3, this->_internal_slot_variable_node_id(), target);
  }
...
size_t
TrackableObjectGraph_TrackableObject_SlotVariableReference::ByteSizeLong()
    const {
...
void TrackableObjectGraph_TrackableObject_SlotVariableReference::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const TrackableObjectGraph_TrackableObject_SlotVariableReference* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          TrackableObjectGraph_TrackableObject_SlotVariableReference>(&from);
  if (source == nullptr) {
...
void TrackableObjectGraph_TrackableObject_SlotVariableReference::MergeFrom(
  ...
  if (from.original_variable_node_id() != 0) {
    _internal_set_original_variable_node_id(
        from._internal_original_variable_node_id());
  }
...
void TrackableObjectGraph_TrackableObject_SlotVariableReference::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool TrackableObjectGraph_TrackableObject_SlotVariableReference::IsInitialized()
    const {
  return true;
}

void TrackableObjectGraph_TrackableObject_SlotVariableReference::InternalSwap(
...
::PROTOBUF_NAMESPACE_ID::Metadata
TrackableObjectGraph_TrackableObject_SlotVariableReference::GetMetadata()
    const {
  return GetMetadataStatic();
}
...
void TrackableObjectGraph_TrackableObject::ArenaDtor(void* object) {
  TrackableObjectGraph_TrackableObject* _this =
      reinterpret_cast<TrackableObjectGraph_TrackableObject*>(object);
  (void)_this;
}
void TrackableObjectGraph_TrackableObject::RegisterArenaDtor(
    ::PROTOBUF_NAMESPACE_ID::Arena*) {}
void TrackableObjectGraph_TrackableObject::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const TrackableObjectGraph_TrackableObject&
TrackableObjectGraph_TrackableObject::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &::scc_info_TrackableObjectGraph_TrackableObject_tensorflow_2fcore_2fprotobuf_2ftrackable_5fobject_5fgraph_2eproto
           .base);
  return *internal_default_instance();
...
const char* TrackableObjectGraph_TrackableObject::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
TrackableObjectGraph_TrackableObject::_InternalSerialize(
  ...
  for (unsigned int i = 0, n = static_cast<unsigned int>(
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            2, this->_internal_attributes(i), target, stream);
  }
...
void TrackableObjectGraph_TrackableObject::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const TrackableObjectGraph_TrackableObject* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          TrackableObjectGraph_TrackableObject>(&from);
  if (source == nullptr) {
...
void TrackableObjectGraph_TrackableObject::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
void TrackableObjectGraph_TrackableObject::InternalSwap(
    TrackableObjectGraph_TrackableObject* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      &other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata
TrackableObjectGraph_TrackableObject::GetMetadata() const {
  return GetMetadataStatic();
}
...
const char* TrackableObjectGraph::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
void TrackableObjectGraph::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
void TrackableObjectGraph::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool TrackableObjectGraph::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::TrackableObjectGraph_TrackableObject*
Arena::CreateMaybeMessage<::tensorflow::TrackableObjectGraph_TrackableObject>(
    Arena* arena) {
  return Arena::CreateMessageInternal<
      ::tensorflow::TrackableObjectGraph_TrackableObject>(arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::TrackableObjectGraph*
Arena::CreateMaybeMessage<::tensorflow::TrackableObjectGraph>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::TrackableObjectGraph>(
      arena);
}
