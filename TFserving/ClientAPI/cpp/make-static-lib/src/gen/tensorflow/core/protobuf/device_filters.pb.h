...
extern ClusterDeviceFiltersDefaultTypeInternal
...
extern JobDeviceFilters_TasksEntry_DoNotUseDefaultTypeInternal
    _JobDeviceFilters_TasksEntry_DoNotUse_default_instance_;
class TaskDeviceFilters;
class TaskDeviceFiltersDefaultTypeInternal;
extern TaskDeviceFiltersDefaultTypeInternal
    _TaskDeviceFilters_default_instance_;
}  // namespace tensorflow
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::ClusterDeviceFilters*
Arena::CreateMaybeMessage<::tensorflow::ClusterDeviceFilters>(Arena*);
template <>
::tensorflow::JobDeviceFilters*
Arena::CreateMaybeMessage<::tensorflow::JobDeviceFilters>(Arena*);
template <>
...
Arena::CreateMaybeMessage<::tensorflow::TaskDeviceFilters>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class TaskDeviceFilters PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.TaskDeviceFilters)
                   */
{
 public:
  ...
  TaskDeviceFilters(TaskDeviceFilters&& from) noexcept : TaskDeviceFilters() {
    *this = ::std::move(from);
  }
...
class JobDeviceFilters_TasksEntry_DoNotUse
    : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<
          JobDeviceFilters_TasksEntry_DoNotUse, ::PROTOBUF_NAMESPACE_ID::int32,
          ::tensorflow::TaskDeviceFilters,
 ...
 public:
  ...
  static const JobDeviceFilters_TasksEntry_DoNotUse*
...
class JobDeviceFilters PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.JobDeviceFilters)
                   */
{
 public:
  ...
  JobDeviceFilters(JobDeviceFilters&& from) noexcept : JobDeviceFilters() {
    *this = ::std::move(from);
  }
...
class ClusterDeviceFilters PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.ClusterDeviceFilters)
                   */
{
 public:
...
inline const std::string& TaskDeviceFilters::_internal_device_filters(
    int index) const {
...
inline void TaskDeviceFilters::set_device_filters(int index,
...
inline void JobDeviceFilters::set_name(const char* value, size_t size) {
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline void JobDeviceFilters::clear_tasks() { tasks_.Clear(); }
...
inline void ClusterDeviceFilters::clear_jobs() { jobs_.Clear(); }
inline ::tensorflow::JobDeviceFilters* ClusterDeviceFilters::mutable_jobs(
    int index) {
...
inline const ::tensorflow::JobDeviceFilters&
ClusterDeviceFilters::_internal_jobs(int index) const {
  return jobs_.Get(index);
}
inline const ::tensorflow::JobDeviceFilters& ClusterDeviceFilters::jobs(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.ClusterDeviceFilters.jobs)
  return _internal_jobs(index);
}
inline ::tensorflow::JobDeviceFilters*
ClusterDeviceFilters::_internal_add_jobs() {
  return jobs_.Add();
}
