...
extern AllocatorMemoryUsedDefaultTypeInternal
...
extern DeviceStepStats_ThreadNamesEntry_DoNotUseDefaultTypeInternal
...
Arena::CreateMaybeMessage<::tensorflow::AllocationRecord>(Arena*);
template <>
::tensorflow::AllocatorMemoryUsed*
Arena::CreateMaybeMessage<::tensorflow::AllocatorMemoryUsed>(Arena*);
template <>
::tensorflow::DeviceStepStats*
Arena::CreateMaybeMessage<::tensorflow::DeviceStepStats>(Arena*);
template <>
::tensorflow::DeviceStepStats_ThreadNamesEntry_DoNotUse*
Arena::CreateMaybeMessage<
    ::tensorflow::DeviceStepStats_ThreadNamesEntry_DoNotUse>(Arena*);
template <>
::tensorflow::MemoryStats* Arena::CreateMaybeMessage<::tensorflow::MemoryStats>(
    Arena*);
template <>
::tensorflow::NodeExecStats*
Arena::CreateMaybeMessage<::tensorflow::NodeExecStats>(Arena*);
template <>
::tensorflow::NodeOutput* Arena::CreateMaybeMessage<::tensorflow::NodeOutput>(
    Arena*);
template <>
::tensorflow::StepStats* Arena::CreateMaybeMessage<::tensorflow::StepStats>(
    Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class AllocationRecord PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.AllocationRecord)
                   */
{
 public:
  ...
  AllocationRecord(AllocationRecord&& from) noexcept : AllocationRecord() {
    *this = ::std::move(from);
  }
...
class AllocatorMemoryUsed PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.AllocatorMemoryUsed)
                   */
{
 public:
 ...
 private:
  const ::tensorflow::AllocationRecord& _internal_allocation_records(
      int index) const;
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_allocator_name(std::string* allocator_name);
 ...
 private:
  ...
  void _internal_set_allocator_bytes_in_use(
...
class NodeOutput PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.NodeOutput)
                   */
{
 public:
  ...
  NodeOutput(NodeOutput&& from) noexcept : NodeOutput() {
    *this = ::std::move(from);
  }
  ...
  static inline const NodeOutput* internal_default_instance() {
    return reinterpret_cast<const NodeOutput*>(&_NodeOutput_default_instance_);
  }
 ...
 public:
  ...
  void set_allocated_tensor_description(
...
class MemoryStats PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.MemoryStats)
                   */
{
 public:
  ...
  MemoryStats(MemoryStats&& from) noexcept : MemoryStats() {
    *this = ::std::move(from);
  }
 ...
 private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_persistent_tensor_alloc_ids(
      int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::PROTOBUF_NAMESPACE_ID::int64>&
  _internal_persistent_tensor_alloc_ids() const;
  void _internal_add_persistent_tensor_alloc_ids(
      ::PROTOBUF_NAMESPACE_ID::int64 value);
 ...
 public:
  ...
  void set_persistent_tensor_alloc_ids(int index,
                                       ::PROTOBUF_NAMESPACE_ID::int64 value);
 ...
 private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_device_persistent_tensor_alloc_ids(
      int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::PROTOBUF_NAMESPACE_ID::int64>&
  _internal_device_persistent_tensor_alloc_ids() const;
  void _internal_add_device_persistent_tensor_alloc_ids(
      ::PROTOBUF_NAMESPACE_ID::int64 value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<::PROTOBUF_NAMESPACE_ID::int64>*
  _internal_mutable_device_persistent_tensor_alloc_ids();

 public:
  PROTOBUF_DEPRECATED ::PROTOBUF_NAMESPACE_ID::int64
  device_persistent_tensor_alloc_ids(int index) const;
  PROTOBUF_DEPRECATED void set_device_persistent_tensor_alloc_ids(
      int index, ::PROTOBUF_NAMESPACE_ID::int64 value);
  PROTOBUF_DEPRECATED void add_device_persistent_tensor_alloc_ids(
      ::PROTOBUF_NAMESPACE_ID::int64 value);
  PROTOBUF_DEPRECATED const ::PROTOBUF_NAMESPACE_ID::RepeatedField<
      ::PROTOBUF_NAMESPACE_ID::int64>&
  device_persistent_tensor_alloc_ids() const;
  PROTOBUF_DEPRECATED ::PROTOBUF_NAMESPACE_ID::RepeatedField<
      ::PROTOBUF_NAMESPACE_ID::int64>*
 ...
 public:
  ...
  PROTOBUF_DEPRECATED ::PROTOBUF_NAMESPACE_ID::int64 device_temp_memory_size()
      const;
  PROTOBUF_DEPRECATED void set_device_temp_memory_size(
      ::PROTOBUF_NAMESPACE_ID::int64 value);

 private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_device_temp_memory_size() const;
  void _internal_set_device_temp_memory_size(
      ::PROTOBUF_NAMESPACE_ID::int64 value);
 ...
 private:
  ...
  void _internal_set_persistent_memory_size(
      ::PROTOBUF_NAMESPACE_ID::int64 value);
 ...
 public:
  ...
  PROTOBUF_DEPRECATED ::PROTOBUF_NAMESPACE_ID::int64
  device_persistent_memory_size() const;
  PROTOBUF_DEPRECATED void set_device_persistent_memory_size(
      ::PROTOBUF_NAMESPACE_ID::int64 value);

 private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_device_persistent_memory_size()
      const;
  void _internal_set_device_persistent_memory_size(
      ::PROTOBUF_NAMESPACE_ID::int64 value);
...
class NodeExecStats PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.NodeExecStats)
                   */
{
 public:
  ...
  NodeExecStats(NodeExecStats&& from) noexcept : NodeExecStats() {
    *this = ::std::move(from);
  }
 ...
 private:
  const ::tensorflow::AllocationDescription& _internal_referenced_tensor(
      int index) const;
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_node_name(std::string* node_name);
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_timeline_label(std::string* timeline_label);
...
class DeviceStepStats_ThreadNamesEntry_DoNotUse
 ...
 public:
  ...
  static const DeviceStepStats_ThreadNamesEntry_DoNotUse*
...
class DeviceStepStats PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.DeviceStepStats)
                   */
{
 public:
  ...
  DeviceStepStats(DeviceStepStats&& from) noexcept : DeviceStepStats() {
    *this = ::std::move(from);
  }
 ...
 private:
  const ::PROTOBUF_NAMESPACE_ID::Map<::PROTOBUF_NAMESPACE_ID::uint32,
                                     std::string>&
...
class StepStats PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.StepStats)
                   */
{
 public:
  ...
  StepStats(StepStats&& from) noexcept : StepStats() {
    *this = ::std::move(from);
  }
  ...
  static inline const StepStats* internal_default_instance() {
    return reinterpret_cast<const StepStats*>(&_StepStats_default_instance_);
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int64 AllocationRecord::_internal_alloc_micros()
    const {
...
inline void AllocationRecord::_internal_set_alloc_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  alloc_micros_ = value;
}
inline void AllocationRecord::set_alloc_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 AllocationRecord::_internal_alloc_bytes()
    const {
  return alloc_bytes_;
}
...
inline void AllocationRecord::_internal_set_alloc_bytes(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  alloc_bytes_ = value;
}
inline void AllocationRecord::set_alloc_bytes(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline const std::string& AllocatorMemoryUsed::_internal_allocator_name()
    const {
  return allocator_name_.Get();
}
inline void AllocatorMemoryUsed::_internal_set_allocator_name(
...
inline std::string* AllocatorMemoryUsed::_internal_mutable_allocator_name() {
  return allocator_name_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
...
inline void AllocatorMemoryUsed::set_allocated_allocator_name(
    std::string* allocator_name) {
  if (allocator_name != nullptr) {
  } else {
  }
  allocator_name_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* AllocatorMemoryUsed::unsafe_arena_release_allocator_name() {
  ...
  return allocator_name_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void AllocatorMemoryUsed::unsafe_arena_set_allocated_allocator_name(
  ...
  allocator_name_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      allocator_name, GetArena());
...
AllocatorMemoryUsed::_internal_total_bytes() const {
  return total_bytes_;
}
...
inline void AllocatorMemoryUsed::_internal_set_total_bytes(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  total_bytes_ = value;
}
inline void AllocatorMemoryUsed::set_total_bytes(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
AllocatorMemoryUsed::_internal_peak_bytes() const {
  return peak_bytes_;
}
...
inline void AllocatorMemoryUsed::_internal_set_peak_bytes(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  peak_bytes_ = value;
}
inline void AllocatorMemoryUsed::set_peak_bytes(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
AllocatorMemoryUsed::_internal_live_bytes() const {
  return live_bytes_;
}
...
inline void AllocatorMemoryUsed::_internal_set_live_bytes(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  live_bytes_ = value;
}
inline void AllocatorMemoryUsed::set_live_bytes(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::tensorflow::AllocationRecord*
AllocatorMemoryUsed::mutable_allocation_records(int index) {
...
inline const ::tensorflow::AllocationRecord&
AllocatorMemoryUsed::_internal_allocation_records(int index) const {
  return allocation_records_.Get(index);
}
inline const ::tensorflow::AllocationRecord&
AllocatorMemoryUsed::allocation_records(int index) const {
...
inline ::tensorflow::AllocationRecord*
AllocatorMemoryUsed::_internal_add_allocation_records() {
  return allocation_records_.Add();
}
inline ::tensorflow::AllocationRecord*
AllocatorMemoryUsed::add_allocation_records() {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
AllocatorMemoryUsed::_internal_allocator_bytes_in_use() const {
  return allocator_bytes_in_use_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64
AllocatorMemoryUsed::allocator_bytes_in_use() const {
...
inline void AllocatorMemoryUsed::_internal_set_allocator_bytes_in_use(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  allocator_bytes_in_use_ = value;
}
inline void AllocatorMemoryUsed::set_allocator_bytes_in_use(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
// int32 slot = 1;
inline void NodeOutput::clear_slot() { slot_ = 0; }
...
inline void NodeOutput::_internal_set_slot(
...
inline const ::tensorflow::TensorDescription&
NodeOutput::_internal_tensor_description() const {
  const ::tensorflow::TensorDescription* p = tensor_description_;
  return p != nullptr
             ? *p
             : *reinterpret_cast<const ::tensorflow::TensorDescription*>(
                   &::tensorflow::_TensorDescription_default_instance_);
}
inline const ::tensorflow::TensorDescription& NodeOutput::tensor_description()
    const {
...
inline ::tensorflow::TensorDescription*
NodeOutput::release_tensor_description() {
...
inline ::tensorflow::TensorDescription*
NodeOutput::unsafe_arena_release_tensor_description() {
...
inline ::tensorflow::TensorDescription*
NodeOutput::_internal_mutable_tensor_description() {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 MemoryStats::_internal_temp_memory_size()
    const {
...
inline void MemoryStats::_internal_set_temp_memory_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  temp_memory_size_ = value;
}
inline void MemoryStats::set_temp_memory_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
MemoryStats::_internal_persistent_memory_size() const {
  return persistent_memory_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 MemoryStats::persistent_memory_size()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.MemoryStats.persistent_memory_size)
  return _internal_persistent_memory_size();
}
inline void MemoryStats::_internal_set_persistent_memory_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  persistent_memory_size_ = value;
}
inline void MemoryStats::set_persistent_memory_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
MemoryStats::_internal_persistent_tensor_alloc_ids(int index) const {
  return persistent_tensor_alloc_ids_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 MemoryStats::persistent_tensor_alloc_ids(
    int index) const {
...
inline void MemoryStats::set_persistent_tensor_alloc_ids(
    int index, ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void MemoryStats::_internal_add_persistent_tensor_alloc_ids(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  persistent_tensor_alloc_ids_.Add(value);
}
inline void MemoryStats::add_persistent_tensor_alloc_ids(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
MemoryStats::_internal_device_temp_memory_size() const {
  return device_temp_memory_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 MemoryStats::device_temp_memory_size()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.MemoryStats.device_temp_memory_size)
  return _internal_device_temp_memory_size();
}
inline void MemoryStats::_internal_set_device_temp_memory_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  device_temp_memory_size_ = value;
}
inline void MemoryStats::set_device_temp_memory_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
MemoryStats::_internal_device_persistent_memory_size() const {
  return device_persistent_memory_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64
MemoryStats::device_persistent_memory_size() const {
...
inline void MemoryStats::_internal_set_device_persistent_memory_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
// repeated int64 device_persistent_tensor_alloc_ids = 6 [deprecated = true];
inline int MemoryStats::_internal_device_persistent_tensor_alloc_ids_size()
    const {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
MemoryStats::_internal_device_persistent_tensor_alloc_ids(int index) const {
  return device_persistent_tensor_alloc_ids_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int64
MemoryStats::device_persistent_tensor_alloc_ids(int index) const {
...
inline void MemoryStats::set_device_persistent_tensor_alloc_ids(
    int index, ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void MemoryStats::_internal_add_device_persistent_tensor_alloc_ids(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  device_persistent_tensor_alloc_ids_.Add(value);
}
inline void MemoryStats::add_device_persistent_tensor_alloc_ids(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline std::string* NodeExecStats::unsafe_arena_release_node_name() {
  ...
  return node_name_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void NodeExecStats::unsafe_arena_set_allocated_node_name(
  ...
  node_name_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      node_name, GetArena());
...
inline ::PROTOBUF_NAMESPACE_ID::int64
NodeExecStats::_internal_all_start_micros() const {
...
inline void NodeExecStats::_internal_set_all_start_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  all_start_micros_ = value;
}
inline void NodeExecStats::set_all_start_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
NodeExecStats::_internal_op_start_rel_micros() const {
  return op_start_rel_micros_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 NodeExecStats::op_start_rel_micros()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.NodeExecStats.op_start_rel_micros)
  return _internal_op_start_rel_micros();
}
inline void NodeExecStats::_internal_set_op_start_rel_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  op_start_rel_micros_ = value;
}
inline void NodeExecStats::set_op_start_rel_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
NodeExecStats::_internal_op_end_rel_micros() const {
...
inline void NodeExecStats::_internal_set_op_end_rel_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  op_end_rel_micros_ = value;
}
inline void NodeExecStats::set_op_end_rel_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
NodeExecStats::_internal_all_end_rel_micros() const {
  return all_end_rel_micros_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 NodeExecStats::all_end_rel_micros()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.NodeExecStats.all_end_rel_micros)
  return _internal_all_end_rel_micros();
}
inline void NodeExecStats::_internal_set_all_end_rel_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  all_end_rel_micros_ = value;
}
inline void NodeExecStats::set_all_end_rel_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void NodeExecStats::clear_memory() { memory_.Clear(); }
inline ::tensorflow::AllocatorMemoryUsed* NodeExecStats::mutable_memory(
    int index) {
...
inline const ::tensorflow::AllocatorMemoryUsed& NodeExecStats::_internal_memory(
    int index) const {
  return memory_.Get(index);
}
inline const ::tensorflow::AllocatorMemoryUsed& NodeExecStats::memory(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.NodeExecStats.memory)
  return _internal_memory(index);
}
inline ::tensorflow::AllocatorMemoryUsed*
NodeExecStats::_internal_add_memory() {
  return memory_.Add();
}
...
inline void NodeExecStats::clear_output() { output_.Clear(); }
...
inline const ::tensorflow::NodeOutput& NodeExecStats::_internal_output(
    int index) const {
...
inline void NodeExecStats::_internal_set_timeline_label(
    const std::string& value) {
  timeline_label_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value,
      GetArena());
...
inline std::string* NodeExecStats::_internal_mutable_timeline_label() {
  return timeline_label_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
...
inline void NodeExecStats::set_allocated_timeline_label(
    std::string* timeline_label) {
  if (timeline_label != nullptr) {
  } else {
  }
  timeline_label_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* NodeExecStats::unsafe_arena_release_timeline_label() {
  ...
  return timeline_label_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void NodeExecStats::unsafe_arena_set_allocated_timeline_label(
  ...
  timeline_label_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      timeline_label, GetArena());
...
inline ::PROTOBUF_NAMESPACE_ID::int64
NodeExecStats::_internal_scheduled_micros() const {
...
inline void NodeExecStats::_internal_set_scheduled_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  scheduled_micros_ = value;
}
inline void NodeExecStats::set_scheduled_micros(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
// uint32 thread_id = 10;
inline void NodeExecStats::clear_thread_id() { thread_id_ = 0u; }
inline ::PROTOBUF_NAMESPACE_ID::uint32 NodeExecStats::_internal_thread_id()
    const {
  return thread_id_;
}
...
inline void NodeExecStats::_internal_set_thread_id(
    ::PROTOBUF_NAMESPACE_ID::uint32 value) {
  thread_id_ = value;
}
inline void NodeExecStats::set_thread_id(
    ::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline ::tensorflow::AllocationDescription*
NodeExecStats::mutable_referenced_tensor(int index) {
...
inline const ::tensorflow::AllocationDescription&
NodeExecStats::_internal_referenced_tensor(int index) const {
  return referenced_tensor_.Get(index);
}
inline const ::tensorflow::AllocationDescription&
NodeExecStats::referenced_tensor(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.NodeExecStats.referenced_tensor)
  return _internal_referenced_tensor(index);
}
inline ::tensorflow::AllocationDescription*
NodeExecStats::_internal_add_referenced_tensor() {
  return referenced_tensor_.Add();
}
inline ::tensorflow::AllocationDescription*
NodeExecStats::add_referenced_tensor() {
...
inline const ::tensorflow::MemoryStats& NodeExecStats::_internal_memory_stats()
    const {
  const ::tensorflow::MemoryStats* p = memory_stats_;
  return p != nullptr ? *p
                      : *reinterpret_cast<const ::tensorflow::MemoryStats*>(
...
inline ::tensorflow::MemoryStats*
NodeExecStats::unsafe_arena_release_memory_stats() {
...
inline ::tensorflow::MemoryStats*
NodeExecStats::_internal_mutable_memory_stats() {
...
inline void NodeExecStats::set_allocated_memory_stats(
    ::tensorflow::MemoryStats* memory_stats) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete memory_stats_;
...
inline ::PROTOBUF_NAMESPACE_ID::int64 NodeExecStats::_internal_all_start_nanos()
    const {
...
inline void NodeExecStats::_internal_set_all_start_nanos(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  all_start_nanos_ = value;
}
inline void NodeExecStats::set_all_start_nanos(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
NodeExecStats::_internal_op_start_rel_nanos() const {
  return op_start_rel_nanos_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 NodeExecStats::op_start_rel_nanos()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.NodeExecStats.op_start_rel_nanos)
  return _internal_op_start_rel_nanos();
}
inline void NodeExecStats::_internal_set_op_start_rel_nanos(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  op_start_rel_nanos_ = value;
}
inline void NodeExecStats::set_op_start_rel_nanos(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
NodeExecStats::_internal_op_end_rel_nanos() const {
...
inline void NodeExecStats::_internal_set_op_end_rel_nanos(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  op_end_rel_nanos_ = value;
}
inline void NodeExecStats::set_op_end_rel_nanos(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
NodeExecStats::_internal_all_end_rel_nanos() const {
...
inline void NodeExecStats::_internal_set_all_end_rel_nanos(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  all_end_rel_nanos_ = value;
}
inline void NodeExecStats::set_all_end_rel_nanos(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 NodeExecStats::_internal_scheduled_nanos()
    const {
...
inline void NodeExecStats::_internal_set_scheduled_nanos(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  scheduled_nanos_ = value;
}
inline void NodeExecStats::set_scheduled_nanos(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void DeviceStepStats::clear_node_stats() { node_stats_.Clear(); }
inline ::tensorflow::NodeExecStats* DeviceStepStats::mutable_node_stats(
    int index) {
...
inline const ::tensorflow::NodeExecStats& DeviceStepStats::_internal_node_stats(
    int index) const {
  return node_stats_.Get(index);
}
inline const ::tensorflow::NodeExecStats& DeviceStepStats::node_stats(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.DeviceStepStats.node_stats)
  return _internal_node_stats(index);
}
inline ::tensorflow::NodeExecStats*
DeviceStepStats::_internal_add_node_stats() {
...
inline void DeviceStepStats::clear_thread_names() { thread_names_.Clear(); }
inline const ::PROTOBUF_NAMESPACE_ID::Map<::PROTOBUF_NAMESPACE_ID::uint32,
                                          std::string>&
...
inline ::PROTOBUF_NAMESPACE_ID::Map<::PROTOBUF_NAMESPACE_ID::uint32,
                                    std::string>*
...
inline void StepStats::clear_dev_stats() { dev_stats_.Clear(); }
...
inline const ::tensorflow::DeviceStepStats& StepStats::_internal_dev_stats(
    int index) const {
  return dev_stats_.Get(index);
}
inline const ::tensorflow::DeviceStepStats& StepStats::dev_stats(
    int index) const {
