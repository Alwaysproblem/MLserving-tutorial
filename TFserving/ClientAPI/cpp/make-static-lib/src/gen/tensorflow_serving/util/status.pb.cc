...
class StatusProtoDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<StatusProto>
      _instance;
} _StatusProto_default_instance_;
}  // namespace serving
}  // namespace tensorflow
static void
InitDefaultsscc_info_StatusProto_tensorflow_5fserving_2futil_2fstatus_2eproto() {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_5fserving_2futil_2fstatus_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const**
    file_level_enum_descriptors_tensorflow_5fserving_2futil_2fstatus_2eproto =
        nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const**
    file_level_service_descriptors_tensorflow_5fserving_2futil_2fstatus_2eproto =
        nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2futil_2fstatus_2eproto::offsets
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::StatusProto,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
...
const char
    descriptor_table_protodef_tensorflow_5fserving_2futil_2fstatus_2eproto
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* const
    descriptor_table_tensorflow_5fserving_2futil_2fstatus_2eproto_deps[1] = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2futil_2fstatus_2eproto_sccs[1] = {
        &scc_info_StatusProto_tensorflow_5fserving_2futil_2fstatus_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag
    descriptor_table_tensorflow_5fserving_2futil_2fstatus_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_tensorflow_5fserving_2futil_2fstatus_2eproto = {
        ...
        224,
        &descriptor_table_tensorflow_5fserving_2futil_2fstatus_2eproto_once,
        descriptor_table_tensorflow_5fserving_2futil_2fstatus_2eproto_sccs,
        descriptor_table_tensorflow_5fserving_2futil_2fstatus_2eproto_deps,
        1,
        1,
        schemas,
        file_default_instances,
        TableStruct_tensorflow_5fserving_2futil_2fstatus_2eproto::offsets,
        file_level_metadata_tensorflow_5fserving_2futil_2fstatus_2eproto,
        1,
        file_level_enum_descriptors_tensorflow_5fserving_2futil_2fstatus_2eproto,
        file_level_service_descriptors_tensorflow_5fserving_2futil_2fstatus_2eproto,
};
...
static bool dynamic_init_dummy_tensorflow_5fserving_2futil_2fstatus_2eproto =
...
StatusProto::StatusProto(const StatusProto& from)
  ...
  if (!from._internal_error_message().empty()) {
    error_message_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_error_message(), GetArena());
  }
...
void StatusProto::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* StatusProto::_InternalParse(
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.StatusProto.error_message"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* StatusProto::_InternalSerialize(
  ...
  if (this->error_message().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_error_message().data(),
        static_cast<int>(this->_internal_error_message().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "tensorflow.serving.StatusProto.error_message");
    target = stream->WriteStringMaybeAliased(2, this->_internal_error_message(),
                                             target);
  }
...
void StatusProto::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const StatusProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<StatusProto>(&from);
  if (source == nullptr) {
...
bool StatusProto::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::StatusProto*
Arena::CreateMaybeMessage<::tensorflow::serving::StatusProto>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::StatusProto>(
      arena);
}
