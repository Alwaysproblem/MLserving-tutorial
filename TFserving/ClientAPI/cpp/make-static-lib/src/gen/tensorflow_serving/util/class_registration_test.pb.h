...
Arena::CreateMaybeMessage<::tensorflow::serving::Config1>(Arena*);
template <>
::tensorflow::serving::Config2*
Arena::CreateMaybeMessage<::tensorflow::serving::Config2>(Arena*);
template <>
::tensorflow::serving::MessageWithAny*
Arena::CreateMaybeMessage<::tensorflow::serving::MessageWithAny>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace serving {
...
class Config1 PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.Config1)
                   */
{
 public:
  ...
  Config1(Config1&& from) noexcept : Config1() { *this = ::std::move(from); }
  ...
  static inline const Config1* internal_default_instance() {
    return reinterpret_cast<const Config1*>(&_Config1_default_instance_);
  }
  static constexpr int kIndexInFileMessages = 0;

  friend void swap(Config1& a, Config1& b) { a.Swap(&b); }
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_string_field(std::string* string_field);
...
class Config2 PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.Config2)
                   */
{
 public:
  ...
  Config2(Config2&& from) noexcept : Config2() { *this = ::std::move(from); }
  ...
  static inline const Config2* internal_default_instance() {
    return reinterpret_cast<const Config2*>(&_Config2_default_instance_);
  }
  static constexpr int kIndexInFileMessages = 1;

  friend void swap(Config2& a, Config2& b) { a.Swap(&b); }
...
class MessageWithAny PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.MessageWithAny)
                   */
{
 public:
  ...
  MessageWithAny(MessageWithAny&& from) noexcept : MessageWithAny() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(MessageWithAny& a, MessageWithAny& b) { a.Swap(&b); }
...
inline std::string* Config1::unsafe_arena_release_string_field() {
  ...
  return string_field_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Config1::unsafe_arena_set_allocated_string_field(
  ...
  string_field_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      string_field, GetArena());
...
inline const PROTOBUF_NAMESPACE_ID::Any& MessageWithAny::_internal_any_field()
    const {
...
MessageWithAny::unsafe_arena_release_any_field() {
...
inline PROTOBUF_NAMESPACE_ID::Any*
MessageWithAny::_internal_mutable_any_field() {
...
inline void MessageWithAny::set_allocated_any_field(
    PROTOBUF_NAMESPACE_ID::Any* any_field) {
