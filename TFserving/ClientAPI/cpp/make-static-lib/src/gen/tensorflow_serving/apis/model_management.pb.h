...
Arena::CreateMaybeMessage<::tensorflow::serving::ReloadConfigRequest>(Arena*);
template <>
::tensorflow::serving::ReloadConfigResponse*
Arena::CreateMaybeMessage<::tensorflow::serving::ReloadConfigResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace serving {
...
class ReloadConfigRequest PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ReloadConfigRequest)
                   */
{
 public:
...
class ReloadConfigResponse PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ReloadConfigResponse)
                   */
{
 public:
...
inline const ::tensorflow::serving::ModelServerConfig&
ReloadConfigRequest::_internal_config() const {
...
inline const ::tensorflow::serving::ModelServerConfig&
ReloadConfigRequest::config() const {
...
inline ::tensorflow::serving::ModelServerConfig*
ReloadConfigRequest::release_config() {
...
inline ::tensorflow::serving::ModelServerConfig*
ReloadConfigRequest::unsafe_arena_release_config() {
...
inline ::tensorflow::serving::ModelServerConfig*
ReloadConfigRequest::_internal_mutable_config() {
  if (config_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::serving::ModelServerConfig>(
        GetArena());
    config_ = p;
  }
  return config_;
...
ReloadConfigResponse::_internal_status() const {
...
inline const ::tensorflow::serving::StatusProto& ReloadConfigResponse::status()
    const {
...
ReloadConfigResponse::release_status() {
...
inline ::tensorflow::serving::StatusProto*
ReloadConfigResponse::unsafe_arena_release_status() {
...
inline ::tensorflow::serving::StatusProto*
ReloadConfigResponse::_internal_mutable_status() {
  if (status_ == nullptr) {
    auto* p =
