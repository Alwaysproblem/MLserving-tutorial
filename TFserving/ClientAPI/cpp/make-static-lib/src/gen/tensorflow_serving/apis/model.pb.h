...
Arena::CreateMaybeMessage<::tensorflow::serving::ModelSpec>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace serving {
...
class ModelSpec PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ModelSpec)
                   */
{
 public:
  ...
  ModelSpec(ModelSpec&& from) noexcept : ModelSpec() {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_signature_name(std::string* signature_name);
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_version_label(std::string* version_label);
...
inline void ModelSpec::set_name(const char* value, size_t size) {
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline void ModelSpec::unsafe_arena_set_allocated_name(std::string* name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (name != nullptr) {
  } else {
  }
...
inline bool ModelSpec::has_version() const { return _internal_has_version(); }
inline void ModelSpec::set_has_version() { _oneof_case_[0] = kVersion; }
...
inline const PROTOBUF_NAMESPACE_ID::Int64Value& ModelSpec::_internal_version()
    const {
  return _internal_has_version()
             ? *version_choice_.version_
             : *reinterpret_cast<PROTOBUF_NAMESPACE_ID::Int64Value*>(
...
inline PROTOBUF_NAMESPACE_ID::Int64Value*
ModelSpec::unsafe_arena_release_version() {
...
inline void ModelSpec::unsafe_arena_set_allocated_version(
    PROTOBUF_NAMESPACE_ID::Int64Value* version) {
...
inline PROTOBUF_NAMESPACE_ID::Int64Value*
ModelSpec::_internal_mutable_version() {
  if (!_internal_has_version()) {
    clear_version_choice();
    set_has_version();
    version_choice_.version_ =
        CreateMaybeMessage<PROTOBUF_NAMESPACE_ID::Int64Value>(GetArena());
  }
...
inline void ModelSpec::_internal_set_version_label(const std::string& value) {
  if (!_internal_has_version_label()) {
    ...
    version_choice_.version_label_.UnsafeSetDefault(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
...
inline void ModelSpec::set_version_label(const char* value, size_t size) {
  if (!_internal_has_version_label()) {
    clear_version_choice();
    set_has_version_label();
    version_choice_.version_label_.UnsafeSetDefault(
...
inline std::string* ModelSpec::release_version_label() {
  ...
  if (_internal_has_version_label()) {
    clear_has_version_choice();
    return version_choice_.version_label_.Release(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        GetArena());
  } else {
    return nullptr;
...
inline void ModelSpec::unsafe_arena_set_allocated_version_label(
  ...
  if (version_label) {
    set_has_version_label();
    version_choice_.version_label_.UnsafeArenaSetAllocated(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        version_label, GetArena());
  }
...
inline void ModelSpec::set_signature_name(const char* value, size_t size) {
  signature_name_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* ModelSpec::_internal_mutable_signature_name() {
  return signature_name_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline std::string* ModelSpec::release_signature_name() {
  ...
  return signature_name_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ModelSpec::set_allocated_signature_name(
    std::string* signature_name) {
  if (signature_name != nullptr) {
  } else {
  }
  signature_name_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* ModelSpec::unsafe_arena_release_signature_name() {
  ...
  return signature_name_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ModelSpec::unsafe_arena_set_allocated_signature_name(
  ...
  signature_name_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      signature_name, GetArena());
