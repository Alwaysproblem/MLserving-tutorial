...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fclassification_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_ClassificationRequest_tensorflow_5fserving_2fapis_2fclassification_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fclassification_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_ClassificationResponse_tensorflow_5fserving_2fapis_2fclassification_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_ClassifyLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fcore_2flogging_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_LogMetadata_tensorflow_5fserving_2fcore_2flogging_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_MultiInferenceLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2finference_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_MultiInferenceRequest_tensorflow_5fserving_2fapis_2finference_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2finference_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_MultiInferenceResponse_tensorflow_5fserving_2fapis_2finference_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_PredictLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fpredict_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_PredictRequest_tensorflow_5fserving_2fapis_2fpredict_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fpredict_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_PredictResponse_tensorflow_5fserving_2fapis_2fpredict_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_RegressLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fregression_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_RegressionRequest_tensorflow_5fserving_2fapis_2fregression_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fregression_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_RegressionResponse_tensorflow_5fserving_2fapis_2fregression_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_SessionRunLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fsession_5fservice_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3>
        scc_info_SessionRunRequest_tensorflow_5fserving_2fapis_2fsession_5fservice_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fsession_5fservice_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3>
        scc_info_SessionRunResponse_tensorflow_5fserving_2fapis_2fsession_5fservice_2eproto;
namespace tensorflow {
namespace serving {
class ClassifyLogDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ClassifyLog>
      _instance;
} _ClassifyLog_default_instance_;
class RegressLogDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<RegressLog>
      _instance;
} _RegressLog_default_instance_;
class PredictLogDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PredictLog>
      _instance;
} _PredictLog_default_instance_;
class MultiInferenceLogDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<MultiInferenceLog>
      _instance;
} _MultiInferenceLog_default_instance_;
class SessionRunLogDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<SessionRunLog>
      _instance;
} _SessionRunLog_default_instance_;
class PredictionLogDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PredictionLog>
      _instance;
...
static void
InitDefaultsscc_info_ClassifyLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto() {
...
static void
InitDefaultsscc_info_MultiInferenceLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_PredictLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_PredictionLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<6>
    scc_info_PredictionLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto = {
        {ATOMIC_VAR_INIT(
             ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized),
         6, 0,
         InitDefaultsscc_info_PredictionLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto},
...
static void
InitDefaultsscc_info_RegressLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_SessionRunLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto
        [6];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto::offsets
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ClassifyLog,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ClassifyLog,
                                  response_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::RegressLog,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
            ...
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::PredictLog,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
            ...
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::MultiInferenceLog,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::MultiInferenceLog,
                                  response_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::SessionRunLog,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::SessionRunLog,
                                  response_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::PredictionLog,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::PredictionLog,
                                  _oneof_case_[0]),
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::PredictionLog,
                                  log_metadata_),
            offsetof(::tensorflow::serving::PredictionLogDefaultTypeInternal,
                     classify_log_),
            offsetof(::tensorflow::serving::PredictionLogDefaultTypeInternal,
                     regress_log_),
            offsetof(::tensorflow::serving::PredictionLogDefaultTypeInternal,
...
static ::PROTOBUF_NAMESPACE_ID::Message const* const file_default_instances[] =
    {
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_ClassifyLog_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_RegressLog_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_PredictLog_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_MultiInferenceLog_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_SessionRunLog_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_PredictionLog_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto_sccs[6] = {
        &scc_info_ClassifyLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto
             .base,
        &scc_info_MultiInferenceLog_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto
             .base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto = {
        ...
        1381,
        &descriptor_table_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto_once,
        descriptor_table_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto_sccs,
        descriptor_table_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto_deps,
        6,
        6,
        schemas,
        file_default_instances,
        TableStruct_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto::
            offsets,
        file_level_metadata_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto,
        6,
        file_level_enum_descriptors_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto,
...
static bool dynamic_init_dummy_tensorflow_5fserving_2fapis_2fprediction_5flog_2eproto =
...
void ClassifyLog::InitAsDefaultInstance() {
  ::tensorflow::serving::_ClassifyLog_default_instance_._instance.get_mutable()
      ->request_ = const_cast<::tensorflow::serving::ClassificationRequest*>(
      ::tensorflow::serving::ClassificationRequest::
          internal_default_instance());
  ::tensorflow::serving::_ClassifyLog_default_instance_._instance.get_mutable()
      ->response_ = const_cast<::tensorflow::serving::ClassificationResponse*>(
      ::tensorflow::serving::ClassificationResponse::
          internal_default_instance());
}
class ClassifyLog::_Internal {
 public:
  static const ::tensorflow::serving::ClassificationRequest& request(
      const ClassifyLog* msg);
  static const ::tensorflow::serving::ClassificationResponse& response(
      const ClassifyLog* msg);
};
...
ClassifyLog::ClassifyLog(const ClassifyLog& from)
  ...
  if (from._internal_has_response()) {
    response_ =
        new ::tensorflow::serving::ClassificationResponse(*from.response_);
  } else {
    response_ = nullptr;
  }
...
void ClassifyLog::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* ClassifyLog::_InternalParse(
...
void ClassifyLog::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const ClassifyLog* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ClassifyLog>(&from);
  if (source == nullptr) {
...
void ClassifyLog::MergeFrom(const ClassifyLog& from) {
  ...
  if (from.has_request()) {
    _internal_mutable_request()
        ->::tensorflow::serving::ClassificationRequest::MergeFrom(
            from._internal_request());
  }
  if (from.has_response()) {
    _internal_mutable_response()
        ->::tensorflow::serving::ClassificationResponse::MergeFrom(
...
bool ClassifyLog::IsInitialized() const { return true; }
...
void RegressLog::InitAsDefaultInstance() {
  ::tensorflow::serving::_RegressLog_default_instance_._instance.get_mutable()
      ->request_ = const_cast<::tensorflow::serving::RegressionRequest*>(
      ::tensorflow::serving::RegressionRequest::internal_default_instance());
  ::tensorflow::serving::_RegressLog_default_instance_._instance.get_mutable()
      ->response_ = const_cast<::tensorflow::serving::RegressionResponse*>(
      ::tensorflow::serving::RegressionResponse::internal_default_instance());
}
class RegressLog::_Internal {
 public:
  static const ::tensorflow::serving::RegressionRequest& request(
      const RegressLog* msg);
  static const ::tensorflow::serving::RegressionResponse& response(
      const RegressLog* msg);
};

const ::tensorflow::serving::RegressionRequest& RegressLog::_Internal::request(
    const RegressLog* msg) {
  return *msg->request_;
}
...
void RegressLog::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* RegressLog::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
void RegressLog::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const RegressLog* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RegressLog>(&from);
  if (source == nullptr) {
...
void RegressLog::MergeFrom(const RegressLog& from) {
  ...
  if (from.has_request()) {
    _internal_mutable_request()
        ->::tensorflow::serving::RegressionRequest::MergeFrom(
            from._internal_request());
  }
  if (from.has_response()) {
    _internal_mutable_response()
        ->::tensorflow::serving::RegressionResponse::MergeFrom(
            from._internal_response());
  }
}
...
bool RegressLog::IsInitialized() const { return true; }
...
void PredictLog::InitAsDefaultInstance() {
  ::tensorflow::serving::_PredictLog_default_instance_._instance.get_mutable()
      ->request_ = const_cast<::tensorflow::serving::PredictRequest*>(
      ::tensorflow::serving::PredictRequest::internal_default_instance());
  ::tensorflow::serving::_PredictLog_default_instance_._instance.get_mutable()
      ->response_ = const_cast<::tensorflow::serving::PredictResponse*>(
      ::tensorflow::serving::PredictResponse::internal_default_instance());
}
class PredictLog::_Internal {
 public:
  static const ::tensorflow::serving::PredictRequest& request(
      const PredictLog* msg);
  static const ::tensorflow::serving::PredictResponse& response(
      const PredictLog* msg);
};

const ::tensorflow::serving::PredictRequest& PredictLog::_Internal::request(
    const PredictLog* msg) {
  return *msg->request_;
}
const ::tensorflow::serving::PredictResponse& PredictLog::_Internal::response(
    const PredictLog* msg) {
  return *msg->response_;
}
...
void PredictLog::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* PredictLog::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
void PredictLog::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const PredictLog* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PredictLog>(&from);
  if (source == nullptr) {
...
void PredictLog::MergeFrom(const PredictLog& from) {
  ...
  if (from.has_request()) {
    _internal_mutable_request()
        ->::tensorflow::serving::PredictRequest::MergeFrom(
            from._internal_request());
  }
  if (from.has_response()) {
    _internal_mutable_response()
        ->::tensorflow::serving::PredictResponse::MergeFrom(
            from._internal_response());
  }
}
...
bool PredictLog::IsInitialized() const { return true; }
...
void MultiInferenceLog::InitAsDefaultInstance() {
  ::tensorflow::serving::_MultiInferenceLog_default_instance_._instance
      .get_mutable()
      ->request_ = const_cast<::tensorflow::serving::MultiInferenceRequest*>(
      ::tensorflow::serving::MultiInferenceRequest::
          internal_default_instance());
  ::tensorflow::serving::_MultiInferenceLog_default_instance_._instance
      .get_mutable()
      ->response_ = const_cast<::tensorflow::serving::MultiInferenceResponse*>(
      ::tensorflow::serving::MultiInferenceResponse::
          internal_default_instance());
}
class MultiInferenceLog::_Internal {
 public:
  static const ::tensorflow::serving::MultiInferenceRequest& request(
      const MultiInferenceLog* msg);
  static const ::tensorflow::serving::MultiInferenceResponse& response(
      const MultiInferenceLog* msg);
};
...
MultiInferenceLog::MultiInferenceLog(const MultiInferenceLog& from)
  ...
  if (from._internal_has_response()) {
    response_ =
        new ::tensorflow::serving::MultiInferenceResponse(*from.response_);
  } else {
    response_ = nullptr;
  }
...
const char* MultiInferenceLog::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
void MultiInferenceLog::MergeFrom(
  ...
  const MultiInferenceLog* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<MultiInferenceLog>(&from);
  if (source == nullptr) {
...
void MultiInferenceLog::MergeFrom(const MultiInferenceLog& from) {
  ...
  if (from.has_request()) {
    _internal_mutable_request()
        ->::tensorflow::serving::MultiInferenceRequest::MergeFrom(
            from._internal_request());
  }
  if (from.has_response()) {
    _internal_mutable_response()
        ->::tensorflow::serving::MultiInferenceResponse::MergeFrom(
            from._internal_response());
  }
}
...
bool MultiInferenceLog::IsInitialized() const { return true; }
...
void SessionRunLog::InitAsDefaultInstance() {
  ::tensorflow::serving::_SessionRunLog_default_instance_._instance
      .get_mutable()
      ->request_ = const_cast<::tensorflow::serving::SessionRunRequest*>(
      ::tensorflow::serving::SessionRunRequest::internal_default_instance());
  ::tensorflow::serving::_SessionRunLog_default_instance_._instance
      .get_mutable()
      ->response_ = const_cast<::tensorflow::serving::SessionRunResponse*>(
      ::tensorflow::serving::SessionRunResponse::internal_default_instance());
}
class SessionRunLog::_Internal {
 public:
  static const ::tensorflow::serving::SessionRunRequest& request(
      const SessionRunLog* msg);
  static const ::tensorflow::serving::SessionRunResponse& response(
      const SessionRunLog* msg);
};
...
void SessionRunLog::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* SessionRunLog::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
void SessionRunLog::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const SessionRunLog* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<SessionRunLog>(&from);
  if (source == nullptr) {
...
void SessionRunLog::MergeFrom(const SessionRunLog& from) {
  ...
  if (from.has_request()) {
    _internal_mutable_request()
        ->::tensorflow::serving::SessionRunRequest::MergeFrom(
            from._internal_request());
  }
  if (from.has_response()) {
    _internal_mutable_response()
        ->::tensorflow::serving::SessionRunResponse::MergeFrom(
            from._internal_response());
  }
}
...
bool SessionRunLog::IsInitialized() const { return true; }
...
void PredictionLog::InitAsDefaultInstance() {
  ::tensorflow::serving::_PredictionLog_default_instance_._instance
      .get_mutable()
      ->log_metadata_ = const_cast<::tensorflow::serving::LogMetadata*>(
      ::tensorflow::serving::LogMetadata::internal_default_instance());
  ::tensorflow::serving::_PredictionLog_default_instance_.classify_log_ =
      const_cast<::tensorflow::serving::ClassifyLog*>(
          ::tensorflow::serving::ClassifyLog::internal_default_instance());
  ::tensorflow::serving::_PredictionLog_default_instance_.regress_log_ =
      const_cast<::tensorflow::serving::RegressLog*>(
          ::tensorflow::serving::RegressLog::internal_default_instance());
  ::tensorflow::serving::_PredictionLog_default_instance_.predict_log_ =
      const_cast<::tensorflow::serving::PredictLog*>(
          ::tensorflow::serving::PredictLog::internal_default_instance());
  ::tensorflow::serving::_PredictionLog_default_instance_
      .multi_inference_log_ = const_cast<
      ::tensorflow::serving::MultiInferenceLog*>(
      ::tensorflow::serving::MultiInferenceLog::internal_default_instance());
  ::tensorflow::serving::_PredictionLog_default_instance_.session_run_log_ =
      const_cast<::tensorflow::serving::SessionRunLog*>(
          ::tensorflow::serving::SessionRunLog::internal_default_instance());
}
class PredictionLog::_Internal {
 public:
  static const ::tensorflow::serving::LogMetadata& log_metadata(
      const PredictionLog* msg);
  static const ::tensorflow::serving::ClassifyLog& classify_log(
      const PredictionLog* msg);
  static const ::tensorflow::serving::RegressLog& regress_log(
      const PredictionLog* msg);
  static const ::tensorflow::serving::PredictLog& predict_log(
      const PredictionLog* msg);
  static const ::tensorflow::serving::MultiInferenceLog& multi_inference_log(
      const PredictionLog* msg);
  static const ::tensorflow::serving::SessionRunLog& session_run_log(
      const PredictionLog* msg);
};
...
const ::tensorflow::serving::RegressLog& PredictionLog::_Internal::regress_log(
    const PredictionLog* msg) {
  return *msg->log_type_.regress_log_;
}
const ::tensorflow::serving::PredictLog& PredictionLog::_Internal::predict_log(
    const PredictionLog* msg) {
...
void PredictionLog::set_allocated_classify_log(
...
void PredictionLog::set_allocated_regress_log(
...
void PredictionLog::set_allocated_predict_log(
...
void PredictionLog::set_allocated_multi_inference_log(
...
void PredictionLog::set_allocated_session_run_log(
...
PredictionLog::PredictionLog(const PredictionLog& from)
  ...
  switch (from.log_type_case()) {
    case kClassifyLog: {
      _internal_mutable_classify_log()
          ->::tensorflow::serving::ClassifyLog::MergeFrom(
              from._internal_classify_log());
      break;
    }
    case kRegressLog: {
      _internal_mutable_regress_log()
          ->::tensorflow::serving::RegressLog::MergeFrom(
              from._internal_regress_log());
      break;
    }
    case kPredictLog: {
      _internal_mutable_predict_log()
          ->::tensorflow::serving::PredictLog::MergeFrom(
              from._internal_predict_log());
      break;
    }
    case kMultiInferenceLog: {
      _internal_mutable_multi_inference_log()
          ->::tensorflow::serving::MultiInferenceLog::MergeFrom(
              from._internal_multi_inference_log());
      break;
    }
    case kSessionRunLog: {
      _internal_mutable_session_run_log()
          ->::tensorflow::serving::SessionRunLog::MergeFrom(
...
void PredictionLog::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* PredictionLog::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
void PredictionLog::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const PredictionLog* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PredictionLog>(&from);
  if (source == nullptr) {
...
void PredictionLog::MergeFrom(const PredictionLog& from) {
  ...
  if (from.has_log_metadata()) {
    _internal_mutable_log_metadata()
        ->::tensorflow::serving::LogMetadata::MergeFrom(
...
bool PredictionLog::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::ClassifyLog*
Arena::CreateMaybeMessage<::tensorflow::serving::ClassifyLog>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::ClassifyLog>(
      arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::RegressLog*
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::PredictLog*
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::MultiInferenceLog*
Arena::CreateMaybeMessage<::tensorflow::serving::MultiInferenceLog>(
    Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::MultiInferenceLog>(
      arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::SessionRunLog*
Arena::CreateMaybeMessage<::tensorflow::serving::SessionRunLog>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::SessionRunLog>(
      arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::PredictionLog*
Arena::CreateMaybeMessage<::tensorflow::serving::PredictionLog>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::PredictionLog>(
      arena);
}
