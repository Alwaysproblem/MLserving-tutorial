...
extern GetModelStatusRequestDefaultTypeInternal
    _GetModelStatusRequest_default_instance_;
class GetModelStatusResponse;
class GetModelStatusResponseDefaultTypeInternal;
extern GetModelStatusResponseDefaultTypeInternal
    _GetModelStatusResponse_default_instance_;
class ModelVersionStatus;
class ModelVersionStatusDefaultTypeInternal;
extern ModelVersionStatusDefaultTypeInternal
    _ModelVersionStatus_default_instance_;
}  // namespace serving
}  // namespace tensorflow
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::serving::GetModelStatusRequest*
Arena::CreateMaybeMessage<::tensorflow::serving::GetModelStatusRequest>(Arena*);
template <>
::tensorflow::serving::GetModelStatusResponse*
Arena::CreateMaybeMessage<::tensorflow::serving::GetModelStatusResponse>(
    Arena*);
template <>
::tensorflow::serving::ModelVersionStatus*
Arena::CreateMaybeMessage<::tensorflow::serving::ModelVersionStatus>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace serving {
...
constexpr ModelVersionStatus_State ModelVersionStatus_State_State_MIN =
    ModelVersionStatus_State_UNKNOWN;
constexpr ModelVersionStatus_State ModelVersionStatus_State_State_MAX =
    ModelVersionStatus_State_END;
constexpr int ModelVersionStatus_State_State_ARRAYSIZE =
    ModelVersionStatus_State_State_MAX + 1;
...
inline const std::string& ModelVersionStatus_State_Name(T enum_t_value) {
  static_assert(
      ::std::is_same<T, ModelVersionStatus_State>::value ||
...
inline bool ModelVersionStatus_State_Parse(const std::string& name,
                                           ModelVersionStatus_State* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<
      ModelVersionStatus_State>(ModelVersionStatus_State_descriptor(), name,
                                value);
}
// ===================================================================
...
class GetModelStatusRequest PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.GetModelStatusRequest)
                   */
{
 public:
  ...
  inline GetModelStatusRequest& operator=(
      GetModelStatusRequest&& from) noexcept {
 ...
 private:
  ...
  friend struct ::
      TableStruct_tensorflow_5fserving_2fapis_2fget_5fmodel_5fstatus_2eproto;
};
// -------------------------------------------------------------------

class ModelVersionStatus PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ModelVersionStatus)
                   */
{
 public:
 ...
 public:
  ...
  static inline const std::string& State_Name(T enum_t_value) {
    static_assert(
        ::std::is_same<T, State>::value || ::std::is_integral<T>::value,
 ...
 private:
  ...
  void _internal_set_state(
      ::tensorflow::serving::ModelVersionStatus_State value);
...
class GetModelStatusResponse PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.GetModelStatusResponse)
                   */
{
 public:
  ...
  inline GetModelStatusResponse& operator=(
      GetModelStatusResponse&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
 ...
 public:
  ...
  // repeated .tensorflow.serving.ModelVersionStatus model_version_status =
  // 1[json_name = "model_version_status"];
 ...
 public:
  ...
  ::tensorflow::serving::ModelVersionStatus* mutable_model_version_status(
      int index);
 ...
 private:
  const ::tensorflow::serving::ModelVersionStatus&
  _internal_model_version_status(int index) const;
  ::tensorflow::serving::ModelVersionStatus*
  _internal_add_model_version_status();

 public:
  const ::tensorflow::serving::ModelVersionStatus& model_version_status(
      int index) const;
...
GetModelStatusRequest::_internal_model_spec() const {
...
inline const ::tensorflow::serving::ModelSpec&
GetModelStatusRequest::model_spec() const {
...
GetModelStatusRequest::release_model_spec() {
...
inline ::tensorflow::serving::ModelSpec*
GetModelStatusRequest::unsafe_arena_release_model_spec() {
...
inline ::tensorflow::serving::ModelSpec*
GetModelStatusRequest::_internal_mutable_model_spec() {
...
inline ::tensorflow::serving::ModelSpec*
GetModelStatusRequest::mutable_model_spec() {
...
inline void GetModelStatusRequest::set_allocated_model_spec(
    ::tensorflow::serving::ModelSpec* model_spec) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ModelVersionStatus::_internal_version()
    const {
  return version_;
}
...
inline void ModelVersionStatus::_internal_set_version(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  version_ = value;
}
inline void ModelVersionStatus::set_version(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
// .tensorflow.serving.ModelVersionStatus.State state = 2;
inline void ModelVersionStatus::clear_state() { state_ = 0; }
inline ::tensorflow::serving::ModelVersionStatus_State
ModelVersionStatus::_internal_state() const {
  return static_cast<::tensorflow::serving::ModelVersionStatus_State>(state_);
}
inline ::tensorflow::serving::ModelVersionStatus_State
ModelVersionStatus::state() const {
  // @@protoc_insertion_point(field_get:tensorflow.serving.ModelVersionStatus.state)
  return _internal_state();
}
inline void ModelVersionStatus::_internal_set_state(
    ::tensorflow::serving::ModelVersionStatus_State value) {
  state_ = value;
}
inline void ModelVersionStatus::set_state(
    ::tensorflow::serving::ModelVersionStatus_State value) {
...
inline const ::tensorflow::serving::StatusProto&
ModelVersionStatus::_internal_status() const {
  const ::tensorflow::serving::StatusProto* p = status_;
  return p != nullptr
             ? *p
             : *reinterpret_cast<const ::tensorflow::serving::StatusProto*>(
                   &::tensorflow::serving::_StatusProto_default_instance_);
}
inline const ::tensorflow::serving::StatusProto& ModelVersionStatus::status()
    const {
...
inline ::tensorflow::serving::StatusProto*
ModelVersionStatus::release_status() {
...
inline ::tensorflow::serving::StatusProto*
ModelVersionStatus::unsafe_arena_release_status() {
...
inline ::tensorflow::serving::StatusProto*
ModelVersionStatus::_internal_mutable_status() {
  if (status_ == nullptr) {
    auto* p =
        CreateMaybeMessage<::tensorflow::serving::StatusProto>(GetArena());
    status_ = p;
  }
  return status_;
}
inline ::tensorflow::serving::StatusProto*
ModelVersionStatus::mutable_status() {
  // @@protoc_insertion_point(field_mutable:tensorflow.serving.ModelVersionStatus.status)
  return _internal_mutable_status();
}
inline void ModelVersionStatus::set_allocated_status(
    ::tensorflow::serving::StatusProto* status) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(status_);
...
inline ::tensorflow::serving::ModelVersionStatus*
GetModelStatusResponse::mutable_model_version_status(int index) {
...
inline const ::tensorflow::serving::ModelVersionStatus&
GetModelStatusResponse::_internal_model_version_status(int index) const {
  return model_version_status_.Get(index);
}
inline const ::tensorflow::serving::ModelVersionStatus&
GetModelStatusResponse::model_version_status(int index) const {
...
inline ::tensorflow::serving::ModelVersionStatus*
GetModelStatusResponse::_internal_add_model_version_status() {
  return model_version_status_.Add();
}
inline ::tensorflow::serving::ModelVersionStatus*
GetModelStatusResponse::add_model_version_status() {
...
template <>
struct is_proto_enum<::tensorflow::serving::ModelVersionStatus_State>
    : ::std::true_type {};
template <>
inline const EnumDescriptor*
GetEnumDescriptor<::tensorflow::serving::ModelVersionStatus_State>() {
