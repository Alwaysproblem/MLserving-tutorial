...
Arena::CreateMaybeMessage<::tensorflow::eager::RemoteTensorHandle>(Arena*);
template <>
::tensorflow::eager::ResourceDtypeAndShape*
Arena::CreateMaybeMessage<::tensorflow::eager::ResourceDtypeAndShape>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace eager {
...
class ResourceDtypeAndShape PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.eager.ResourceDtypeAndShape)
                   */
{
 public:
  ...
  inline ResourceDtypeAndShape& operator=(
      ResourceDtypeAndShape&& from) noexcept {
...
class RemoteTensorHandle PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.eager.RemoteTensorHandle)
                   */
{
 public:
 ...
 public:
  ...
  ::tensorflow::eager::ResourceDtypeAndShape*
  mutable_resource_dtypes_and_shapes(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<
      ::tensorflow::eager::ResourceDtypeAndShape>*
  mutable_resource_dtypes_and_shapes();

 private:
  const ::tensorflow::eager::ResourceDtypeAndShape&
  _internal_resource_dtypes_and_shapes(int index) const;
  ::tensorflow::eager::ResourceDtypeAndShape*
  _internal_add_resource_dtypes_and_shapes();

 public:
  const ::tensorflow::eager::ResourceDtypeAndShape& resource_dtypes_and_shapes(
      int index) const;
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_op_device(std::string* op_device);
...
// .tensorflow.DataType dtype = 1;
inline void ResourceDtypeAndShape::clear_dtype() { dtype_ = 0; }
...
inline void ResourceDtypeAndShape::_internal_set_dtype(
...
ResourceDtypeAndShape::_internal_shape() const {
...
inline const ::tensorflow::TensorShapeProto& ResourceDtypeAndShape::shape()
    const {
...
ResourceDtypeAndShape::unsafe_arena_release_shape() {
...
inline ::tensorflow::TensorShapeProto*
ResourceDtypeAndShape::_internal_mutable_shape() {
  if (shape_ == nullptr) {
...
inline void ResourceDtypeAndShape::set_allocated_shape(
    ::tensorflow::TensorShapeProto* shape) {
...
// int64 op_id = 1;
inline void RemoteTensorHandle::clear_op_id() { op_id_ = PROTOBUF_LONGLONG(0); }
inline ::PROTOBUF_NAMESPACE_ID::int64 RemoteTensorHandle::_internal_op_id()
    const {
  return op_id_;
}
...
inline void RemoteTensorHandle::_internal_set_op_id(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  op_id_ = value;
}
inline void RemoteTensorHandle::set_op_id(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
// int32 output_num = 2;
inline void RemoteTensorHandle::clear_output_num() { output_num_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 RemoteTensorHandle::_internal_output_num()
    const {
  return output_num_;
}
...
inline void RemoteTensorHandle::_internal_set_output_num(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  output_num_ = value;
}
inline void RemoteTensorHandle::set_output_num(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void RemoteTensorHandle::_internal_set_op_device(
...
inline std::string* RemoteTensorHandle::release_op_device() {
  ...
  return op_device_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RemoteTensorHandle::set_allocated_op_device(
    std::string* op_device) {
  if (op_device != nullptr) {
  } else {
  }
  op_device_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      op_device, GetArena());
...
inline std::string* RemoteTensorHandle::unsafe_arena_release_op_device() {
  ...
  return op_device_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RemoteTensorHandle::unsafe_arena_set_allocated_op_device(
  ...
  op_device_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      op_device, GetArena());
...
// .tensorflow.DataType dtype = 5;
inline void RemoteTensorHandle::clear_dtype() { dtype_ = 0; }
...
inline void RemoteTensorHandle::_internal_set_dtype(
    ::tensorflow::DataType value) {
  dtype_ = value;
}
...
// repeated .tensorflow.eager.ResourceDtypeAndShape resource_dtypes_and_shapes =
// 6;
inline int RemoteTensorHandle::_internal_resource_dtypes_and_shapes_size()
    const {
...
inline ::tensorflow::eager::ResourceDtypeAndShape*
RemoteTensorHandle::mutable_resource_dtypes_and_shapes(int index) {
...
inline const ::tensorflow::eager::ResourceDtypeAndShape&
RemoteTensorHandle::_internal_resource_dtypes_and_shapes(int index) const {
  return resource_dtypes_and_shapes_.Get(index);
}
inline const ::tensorflow::eager::ResourceDtypeAndShape&
RemoteTensorHandle::resource_dtypes_and_shapes(int index) const {
...
inline ::tensorflow::eager::ResourceDtypeAndShape*
RemoteTensorHandle::_internal_add_resource_dtypes_and_shapes() {
  return resource_dtypes_and_shapes_.Add();
}
inline ::tensorflow::eager::ResourceDtypeAndShape*
RemoteTensorHandle::add_resource_dtypes_and_shapes() {
