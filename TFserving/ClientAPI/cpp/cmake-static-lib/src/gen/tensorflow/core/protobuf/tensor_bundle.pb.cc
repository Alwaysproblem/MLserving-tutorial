...
class BundleHeaderProtoDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<BundleHeaderProto>
      _instance;
...
static void
InitDefaultsscc_info_BundleEntryProto_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
    scc_info_BundleEntryProto_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto =
        {{ATOMIC_VAR_INIT(
...
static void
InitDefaultsscc_info_BundleHeaderProto_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
    scc_info_BundleHeaderProto_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto =
        {{ATOMIC_VAR_INIT(
              ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized),
          1, 0,
          InitDefaultsscc_info_BundleHeaderProto_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto},
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto::offsets
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::BundleHeaderProto,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ...
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::BundleEntryProto,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
...
static ::PROTOBUF_NAMESPACE_ID::Message const* const file_default_instances[] =
    {
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::_BundleHeaderProto_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto_sccs
        [2] = {
            &scc_info_BundleEntryProto_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto
                 .base,
            &scc_info_BundleHeaderProto_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto
...
static bool dynamic_init_dummy_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto =
...
void BundleHeaderProto::InitAsDefaultInstance() {
  ::tensorflow::_BundleHeaderProto_default_instance_._instance.get_mutable()
...
const ::tensorflow::VersionDef& BundleHeaderProto::_Internal::version(
    const BundleHeaderProto* msg) {
  return *msg->version_;
}
...
BundleHeaderProto::BundleHeaderProto(const BundleHeaderProto& from)
  ...
  ::memcpy(&num_shards_, &from.num_shards_,
           static_cast<size_t>(reinterpret_cast<char*>(&endianness_) -
                               reinterpret_cast<char*>(&num_shards_)) +
               sizeof(endianness_));
...
const char* BundleHeaderProto::_InternalParse(
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(ptr);
          _internal_set_endianness(
              static_cast<::tensorflow::BundleHeaderProto_Endianness>(val));
        } else
          goto handle_unusual;
        continue;
  ...
  if (this->num_shards() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(
            1, this->_internal_num_shards(), target);
  }
...
void BundleHeaderProto::MergeFrom(
  ...
  const BundleHeaderProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<BundleHeaderProto>(&from);
  if (source == nullptr) {
...
bool BundleHeaderProto::IsInitialized() const { return true; }
...
void BundleEntryProto::InitAsDefaultInstance() {
  ::tensorflow::_BundleEntryProto_default_instance_._instance.get_mutable()
...
class BundleEntryProto::_Internal {
 public:
  static const ::tensorflow::TensorShapeProto& shape(
      const BundleEntryProto* msg);
};

const ::tensorflow::TensorShapeProto& BundleEntryProto::_Internal::shape(
    const BundleEntryProto* msg) {
  return *msg->shape_;
}
...
void BundleEntryProto::clear_slices() { slices_.Clear(); }
BundleEntryProto::BundleEntryProto(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), slices_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
...
BundleEntryProto::BundleEntryProto(const BundleEntryProto& from)
    : ::PROTOBUF_NAMESPACE_ID::Message(), slices_(from.slices_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      from._internal_metadata_);
...
const char* BundleEntryProto::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          crc32c_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<
  ...
  if (this->crc32c() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFixed32ToArray(
            6, this->_internal_crc32c(), target);
  }

  // repeated .tensorflow.TensorSliceProto slices = 7;
  for (unsigned int i = 0, n = static_cast<unsigned int>(
                               this->_internal_slices_size());
       i < n; i++) {
    target = stream->EnsureSpace(target);
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            7, this->_internal_slices(i), target, stream);
  }
...
void BundleEntryProto::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const BundleEntryProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<BundleEntryProto>(&from);
  if (source == nullptr) {
...
bool BundleEntryProto::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::BundleHeaderProto*
...
template <>
PROTOBUF_NOINLINE ::tensorflow::BundleEntryProto*
