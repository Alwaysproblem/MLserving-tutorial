...
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::SaverDef* Arena::CreateMaybeMessage<::tensorflow::SaverDef>(
    Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
constexpr int
    SaverDef_CheckpointFormatVersion_CheckpointFormatVersion_ARRAYSIZE =
        SaverDef_CheckpointFormatVersion_CheckpointFormatVersion_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
SaverDef_CheckpointFormatVersion_descriptor();
template <typename T>
inline const std::string& SaverDef_CheckpointFormatVersion_Name(
    T enum_t_value) {
  static_assert(::std::is_same<T, SaverDef_CheckpointFormatVersion>::value ||
                    ::std::is_integral<T>::value,
                "Incorrect type passed to function "
                "SaverDef_CheckpointFormatVersion_Name.");
...
class SaverDef PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.SaverDef)
                   */
{
 public:
  ...
  SaverDef(SaverDef&& from) noexcept : SaverDef() { *this = ::std::move(from); }
  ...
  static inline const SaverDef* internal_default_instance() {
    return reinterpret_cast<const SaverDef*>(&_SaverDef_default_instance_);
  }
 ...
 public:
  ...
  template <typename T>
  static inline const std::string& CheckpointFormatVersion_Name(
      T enum_t_value) {
    static_assert(
        ::std::is_same<T, CheckpointFormatVersion>::value ||
            ::std::is_integral<T>::value,
  ...
  static inline bool CheckpointFormatVersion_Parse(
      const std::string& name, CheckpointFormatVersion* value) {
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_restore_op_name(std::string* restore_op_name);
...
inline void SaverDef::_internal_set_filename_tensor_name(
...
inline std::string* SaverDef::_internal_mutable_filename_tensor_name() {
  return filename_tensor_name_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline std::string* SaverDef::release_filename_tensor_name() {
  ...
  return filename_tensor_name_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SaverDef::set_allocated_filename_tensor_name(
    std::string* filename_tensor_name) {
  if (filename_tensor_name != nullptr) {
  } else {
  }
  filename_tensor_name_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* SaverDef::unsafe_arena_release_filename_tensor_name() {
  ...
  return filename_tensor_name_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SaverDef::unsafe_arena_set_allocated_filename_tensor_name(
  ...
  filename_tensor_name_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      filename_tensor_name, GetArena());
...
inline std::string* SaverDef::_internal_mutable_save_tensor_name() {
  return save_tensor_name_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline std::string* SaverDef::release_save_tensor_name() {
  ...
  return save_tensor_name_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SaverDef::set_allocated_save_tensor_name(
    std::string* save_tensor_name) {
  if (save_tensor_name != nullptr) {
  } else {
  }
  save_tensor_name_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* SaverDef::unsafe_arena_release_save_tensor_name() {
  ...
  return save_tensor_name_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SaverDef::unsafe_arena_set_allocated_save_tensor_name(
  ...
  save_tensor_name_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      save_tensor_name, GetArena());
...
inline std::string* SaverDef::_internal_mutable_restore_op_name() {
  return restore_op_name_.Mutable(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline std::string* SaverDef::release_restore_op_name() {
  ...
  return restore_op_name_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SaverDef::set_allocated_restore_op_name(
    std::string* restore_op_name) {
  if (restore_op_name != nullptr) {
  } else {
  }
  restore_op_name_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* SaverDef::unsafe_arena_release_restore_op_name() {
  ...
  return restore_op_name_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SaverDef::unsafe_arena_set_allocated_restore_op_name(
  ...
  restore_op_name_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      restore_op_name, GetArena());
...
// int32 max_to_keep = 4;
inline void SaverDef::clear_max_to_keep() { max_to_keep_ = 0; }
...
inline void SaverDef::_internal_set_max_to_keep(
...
// bool sharded = 5;
inline void SaverDef::clear_sharded() { sharded_ = false; }
inline bool SaverDef::_internal_sharded() const { return sharded_; }
inline bool SaverDef::sharded() const {
  // @@protoc_insertion_point(field_get:tensorflow.SaverDef.sharded)
  return _internal_sharded();
}
inline void SaverDef::_internal_set_sharded(bool value) { sharded_ = value; }
...
// .tensorflow.SaverDef.CheckpointFormatVersion version = 7;
inline void SaverDef::clear_version() { version_ = 0; }
inline ::tensorflow::SaverDef_CheckpointFormatVersion
SaverDef::_internal_version() const {
  return static_cast<::tensorflow::SaverDef_CheckpointFormatVersion>(version_);
}
inline ::tensorflow::SaverDef_CheckpointFormatVersion SaverDef::version()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.SaverDef.version)
  return _internal_version();
}
inline void SaverDef::_internal_set_version(
    ::tensorflow::SaverDef_CheckpointFormatVersion value) {
  version_ = value;
}
inline void SaverDef::set_version(
    ::tensorflow::SaverDef_CheckpointFormatVersion value) {
...
template <>
struct is_proto_enum<::tensorflow::SaverDef_CheckpointFormatVersion>
    : ::std::true_type {};
template <>
inline const EnumDescriptor*
GetEnumDescriptor<::tensorflow::SaverDef_CheckpointFormatVersion>() {
