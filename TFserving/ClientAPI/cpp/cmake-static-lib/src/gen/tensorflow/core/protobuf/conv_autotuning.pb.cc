...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_2fstream_5fexecutor_2fdnn_2eproto ::
...
class ConvolutionProtoDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ConvolutionProto>
      _instance;
} _ConvolutionProto_default_instance_;
}  // namespace tensorflow
static void
InitDefaultsscc_info_ConvolutionProto_tensorflow_2fcore_2fprotobuf_2fconv_5fautotuning_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
    scc_info_ConvolutionProto_tensorflow_2fcore_2fprotobuf_2fconv_5fautotuning_2eproto =
        {{ATOMIC_VAR_INIT(
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_2fcore_2fprotobuf_2fconv_5fautotuning_2eproto
        [1];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_2fcore_2fprotobuf_2fconv_5fautotuning_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::ConvolutionProto,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
...
static ::PROTOBUF_NAMESPACE_ID::Message const* const file_default_instances[] =
    {
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::_ConvolutionProto_default_instance_),
};
...
const char
    descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fconv_5fautotuning_2eproto
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
            ...
            "\n\020side_value_scale\030\007 "
            "\001(\001\0227\n\nactivation\030\010"
            " \001(\0162#.stream_executor.dnn.ActivationMod"
            "e\022\025\n\rinput_address\030\t "
            "\001(\003\022\026\n\016filter_addre"
            "ss\030\n \001(\003\022\026\n\016output_address\030\013 "
            "\001(\003\022\024\n\014bias"
            "_address\030\014 \001(\003\022\032\n\022side_input_address\030\r "
            "\001"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_2fcore_2fprotobuf_2fconv_5fautotuning_2eproto_sccs
        [1] = {
            &scc_info_ConvolutionProto_tensorflow_2fcore_2fprotobuf_2fconv_5fautotuning_2eproto
                 .base,
};
...
static bool dynamic_init_dummy_tensorflow_2fcore_2fprotobuf_2fconv_5fautotuning_2eproto =
...
void ConvolutionProto::InitAsDefaultInstance() {
  ::tensorflow::_ConvolutionProto_default_instance_._instance.get_mutable()
      ->input_ = const_cast<::stream_executor::dnn::TensorDescriptorProto*>(
      ::stream_executor::dnn::TensorDescriptorProto::
          internal_default_instance());
  ::tensorflow::_ConvolutionProto_default_instance_._instance.get_mutable()
      ->filter_ = const_cast<::stream_executor::dnn::TensorDescriptorProto*>(
      ::stream_executor::dnn::TensorDescriptorProto::
          internal_default_instance());
  ::tensorflow::_ConvolutionProto_default_instance_._instance.get_mutable()
      ->output_ = const_cast<::stream_executor::dnn::TensorDescriptorProto*>(
      ::stream_executor::dnn::TensorDescriptorProto::
          internal_default_instance());
  ::tensorflow::_ConvolutionProto_default_instance_._instance.get_mutable()
      ->conv_desc_ =
      const_cast<::stream_executor::dnn::ConvolutionDescriptorProto*>(
          ::stream_executor::dnn::ConvolutionDescriptorProto::
              internal_default_instance());
}
class ConvolutionProto::_Internal {
 public:
  static const ::stream_executor::dnn::TensorDescriptorProto& input(
      const ConvolutionProto* msg);
  static const ::stream_executor::dnn::TensorDescriptorProto& filter(
      const ConvolutionProto* msg);
  static const ::stream_executor::dnn::TensorDescriptorProto& output(
      const ConvolutionProto* msg);
  static const ::stream_executor::dnn::ConvolutionDescriptorProto& conv_desc(
      const ConvolutionProto* msg);
};
...
const char* ConvolutionProto::_InternalParse(
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(ptr);
          _internal_set_kind(
              static_cast<::stream_executor::dnn::ConvolutionKind>(val));
        } else
          goto handle_unusual;
        continue;
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ::PROTOBUF_NAMESPACE_ID::uint64 val =
              ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_activation(
              static_cast<::stream_executor::dnn::ActivationMode>(val));
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* ConvolutionProto::_InternalSerialize(
  ...
  if (!(this->conv_scale() <= 0 && this->conv_scale() >= 0)) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(
            6, this->_internal_conv_scale(), target);
  }
  ...
  if (!(this->side_value_scale() <= 0 && this->side_value_scale() >= 0)) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(
            7, this->_internal_side_value_scale(), target);
  }
  ...
  if (this->input_address() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(
            9, this->_internal_input_address(), target);
  }
  ...
  if (this->filter_address() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(
            10, this->_internal_filter_address(), target);
  }
  ...
  if (this->output_address() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(
            11, this->_internal_output_address(), target);
  }
  ...
  if (this->bias_address() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(
            12, this->_internal_bias_address(), target);
  }
  ...
  if (this->side_input_address() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(
            13, this->_internal_side_input_address(), target);
  }
...
void ConvolutionProto::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const ConvolutionProto* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ConvolutionProto>(&from);
  if (source == nullptr) {
...
void ConvolutionProto::MergeFrom(const ConvolutionProto& from) {
  ...
  if (from.has_input()) {
    _internal_mutable_input()
        ->::stream_executor::dnn::TensorDescriptorProto::MergeFrom(
  ...
  if (from.has_conv_desc()) {
    _internal_mutable_conv_desc()
        ->::stream_executor::dnn::ConvolutionDescriptorProto::MergeFrom(
...
bool ConvolutionProto::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::ConvolutionProto*
