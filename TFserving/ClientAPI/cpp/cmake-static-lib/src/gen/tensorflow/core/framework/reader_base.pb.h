...
Arena::CreateMaybeMessage<::tensorflow::ReaderBaseState>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class ReaderBaseState PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.ReaderBaseState)
                   */
{
 public:
  ...
  ReaderBaseState(ReaderBaseState&& from) noexcept : ReaderBaseState() {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_current_work(std::string* current_work);
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ReaderBaseState::_internal_work_started()
    const {
...
inline void ReaderBaseState::_internal_set_work_started(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  work_started_ = value;
}
inline void ReaderBaseState::set_work_started(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ReaderBaseState::_internal_work_finished()
    const {
...
inline void ReaderBaseState::_internal_set_work_finished(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  work_finished_ = value;
}
inline void ReaderBaseState::set_work_finished(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
ReaderBaseState::_internal_num_records_produced() const {
  return num_records_produced_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 ReaderBaseState::num_records_produced()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.ReaderBaseState.num_records_produced)
  return _internal_num_records_produced();
}
inline void ReaderBaseState::_internal_set_num_records_produced(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  num_records_produced_ = value;
}
inline void ReaderBaseState::set_num_records_produced(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void ReaderBaseState::_internal_set_current_work(
...
inline std::string* ReaderBaseState::release_current_work() {
  ...
  return current_work_.Release(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ReaderBaseState::set_allocated_current_work(
    std::string* current_work) {
  if (current_work != nullptr) {
  } else {
  }
  current_work_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* ReaderBaseState::unsafe_arena_release_current_work() {
  ...
  return current_work_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ReaderBaseState::unsafe_arena_set_allocated_current_work(
  ...
  current_work_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      current_work, GetArena());
