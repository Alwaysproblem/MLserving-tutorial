...
extern TensorShapeProto_DimDefaultTypeInternal
    _TensorShapeProto_Dim_default_instance_;
}  // namespace tensorflow
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::TensorShapeProto*
Arena::CreateMaybeMessage<::tensorflow::TensorShapeProto>(Arena*);
template <>
::tensorflow::TensorShapeProto_Dim*
Arena::CreateMaybeMessage<::tensorflow::TensorShapeProto_Dim>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class TensorShapeProto_Dim PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.TensorShapeProto.Dim)
                   */
{
 public:
...
class TensorShapeProto PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.TensorShapeProto)
                   */
{
 public:
  ...
  TensorShapeProto(TensorShapeProto&& from) noexcept : TensorShapeProto() {
    *this = ::std::move(from);
  }
...
// int64 size = 1;
inline void TensorShapeProto_Dim::clear_size() { size_ = PROTOBUF_LONGLONG(0); }
inline ::PROTOBUF_NAMESPACE_ID::int64 TensorShapeProto_Dim::_internal_size()
    const {
  return size_;
}
...
inline void TensorShapeProto_Dim::_internal_set_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  size_ = value;
}
inline void TensorShapeProto_Dim::set_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
// repeated .tensorflow.TensorShapeProto.Dim dim = 2;
inline int TensorShapeProto::_internal_dim_size() const { return dim_.size(); }
inline int TensorShapeProto::dim_size() const { return _internal_dim_size(); }
...
inline const ::tensorflow::TensorShapeProto_Dim&
TensorShapeProto::_internal_dim(int index) const {
...
inline ::tensorflow::TensorShapeProto_Dim*
TensorShapeProto::_internal_add_dim() {
  return dim_.Add();
}
