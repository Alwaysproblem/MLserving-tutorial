...
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::VersionDef* Arena::CreateMaybeMessage<::tensorflow::VersionDef>(
    Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class VersionDef PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.VersionDef)
                   */
{
 public:
  ...
  VersionDef(VersionDef&& from) noexcept : VersionDef() {
    *this = ::std::move(from);
  }
  ...
  static inline const VersionDef* internal_default_instance() {
    return reinterpret_cast<const VersionDef*>(&_VersionDef_default_instance_);
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int32 VersionDef::_internal_min_consumer()
    const {
...
inline void VersionDef::_internal_set_min_consumer(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  min_consumer_ = value;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 VersionDef::_internal_bad_consumers(
    int index) const {
  return bad_consumers_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int32 VersionDef::bad_consumers(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.VersionDef.bad_consumers)
  return _internal_bad_consumers(index);
}
inline void VersionDef::set_bad_consumers(
...
inline void VersionDef::_internal_add_bad_consumers(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  bad_consumers_.Add(value);
}
inline void VersionDef::add_bad_consumers(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
