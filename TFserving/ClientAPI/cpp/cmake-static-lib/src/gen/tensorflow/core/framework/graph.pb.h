...
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::GraphDef* Arena::CreateMaybeMessage<::tensorflow::GraphDef>(
    Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class GraphDef PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.GraphDef)
                   */
{
 public:
  ...
  GraphDef(GraphDef&& from) noexcept : GraphDef() { *this = ::std::move(from); }
  ...
  static inline const GraphDef* internal_default_instance() {
    return reinterpret_cast<const GraphDef*>(&_GraphDef_default_instance_);
  }
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::tensorflow::NodeDef>& node()
      const;
...
// repeated .tensorflow.NodeDef node = 1;
inline int GraphDef::_internal_node_size() const { return node_.size(); }
inline int GraphDef::node_size() const { return _internal_node_size(); }
...
inline bool GraphDef::has_versions() const { return _internal_has_versions(); }
...
inline bool GraphDef::has_library() const { return _internal_has_library(); }
inline const ::tensorflow::FunctionDefLibrary& GraphDef::_internal_library()
    const {
...
GraphDef::unsafe_arena_release_library() {
