...
class VersionDefDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<VersionDef>
      _instance;
} _VersionDef_default_instance_;
}  // namespace tensorflow
static void
InitDefaultsscc_info_VersionDef_tensorflow_2fcore_2fframework_2fversions_2eproto() {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_2fcore_2fframework_2fversions_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const**
    file_level_enum_descriptors_tensorflow_2fcore_2fframework_2fversions_2eproto =
        nullptr;
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_2fcore_2fframework_2fversions_2eproto::offsets
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::VersionDef,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
...
const char
    descriptor_table_protodef_tensorflow_2fcore_2fframework_2fversions_2eproto
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
            "\n(tensorflow/core/framework/versions.pro"
            "to\022\ntensorflow\"K\n\nVersionDef\022\020\n\010producer"
            "\030\001 \001(\005\022\024\n\014min_consumer\030\002 "
            "\001(\005\022\025\n\rbad_cons"
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* const
    descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_deps[1] =
        {};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_sccs[1] = {
        &scc_info_VersionDef_tensorflow_2fcore_2fframework_2fversions_2eproto
             .base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag
    descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto = {
        ...
        270,
        &descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_once,
        descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_sccs,
        descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_deps,
        1,
        0,
        schemas,
        file_default_instances,
        TableStruct_tensorflow_2fcore_2fframework_2fversions_2eproto::offsets,
        file_level_metadata_tensorflow_2fcore_2fframework_2fversions_2eproto,
        1,
        file_level_enum_descriptors_tensorflow_2fcore_2fframework_2fversions_2eproto,
        file_level_service_descriptors_tensorflow_2fcore_2fframework_2fversions_2eproto,
};
...
static bool dynamic_init_dummy_tensorflow_2fcore_2fframework_2fversions_2eproto =
...
VersionDef::VersionDef(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), bad_consumers_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:tensorflow.VersionDef)
}
VersionDef::VersionDef(const VersionDef& from)
    : ::PROTOBUF_NAMESPACE_ID::Message(), bad_consumers_(from.bad_consumers_) {
...
void VersionDef::SharedDtor() { GOOGLE_DCHECK(GetArena() == nullptr); }
...
void VersionDef::SetCachedSize(int size) const { _cached_size_.Set(size); }
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedInt32Parser(
              _internal_mutable_bad_consumers(), ptr, ctx);
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* VersionDef::_InternalSerialize(
  ...
  // repeated int32 bad_consumers = 3;
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteInt32Packed(3, _internal_bad_consumers(), byte_size,
                                        target);
    }
  }
...
void VersionDef::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const VersionDef* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<VersionDef>(&from);
  if (source == nullptr) {
...
template <>
PROTOBUF_NOINLINE ::tensorflow::VersionDef*
