...
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::serving::LoggingConfig*
Arena::CreateMaybeMessage<::tensorflow::serving::LoggingConfig>(Arena*);
template <>
::tensorflow::serving::SamplingConfig*
Arena::CreateMaybeMessage<::tensorflow::serving::SamplingConfig>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace serving {
...
class SamplingConfig PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.SamplingConfig)
                   */
{
 public:
  ...
  SamplingConfig(SamplingConfig&& from) noexcept : SamplingConfig() {
    *this = ::std::move(from);
  }
...
class LoggingConfig PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.LoggingConfig)
                   */
{
 public:
 ...
 public:
  void unsafe_arena_set_allocated_log_collector_config(
      ::tensorflow::serving::LogCollectorConfig* log_collector_config);
  ::tensorflow::serving::LogCollectorConfig*
  unsafe_arena_release_log_collector_config();
 ...
 private:
  const ::tensorflow::serving::SamplingConfig& _internal_sampling_config()
      const;
...
// double sampling_rate = 1;
inline void SamplingConfig::clear_sampling_rate() { sampling_rate_ = 0; }
...
inline const ::tensorflow::serving::LogCollectorConfig&
LoggingConfig::_internal_log_collector_config() const {
...
inline const ::tensorflow::serving::LogCollectorConfig&
LoggingConfig::log_collector_config() const {
...
inline ::tensorflow::serving::LogCollectorConfig*
LoggingConfig::release_log_collector_config() {
...
inline ::tensorflow::serving::LogCollectorConfig*
LoggingConfig::unsafe_arena_release_log_collector_config() {
...
inline ::tensorflow::serving::LogCollectorConfig*
LoggingConfig::_internal_mutable_log_collector_config() {
  if (log_collector_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::serving::LogCollectorConfig>(
        GetArena());
...
inline ::tensorflow::serving::LogCollectorConfig*
LoggingConfig::mutable_log_collector_config() {
...
inline void LoggingConfig::set_allocated_log_collector_config(
    ::tensorflow::serving::LogCollectorConfig* log_collector_config) {
...
inline const ::tensorflow::serving::SamplingConfig&
LoggingConfig::_internal_sampling_config() const {
  const ::tensorflow::serving::SamplingConfig* p = sampling_config_;
  return p != nullptr
             ? *p
             : *reinterpret_cast<const ::tensorflow::serving::SamplingConfig*>(
                   &::tensorflow::serving::_SamplingConfig_default_instance_);
}
inline const ::tensorflow::serving::SamplingConfig&
LoggingConfig::sampling_config() const {
...
inline ::tensorflow::serving::SamplingConfig*
LoggingConfig::release_sampling_config() {
...
inline ::tensorflow::serving::SamplingConfig*
LoggingConfig::unsafe_arena_release_sampling_config() {
...
inline ::tensorflow::serving::SamplingConfig*
LoggingConfig::_internal_mutable_sampling_config() {
  if (sampling_config_ == nullptr) {
    auto* p =
        CreateMaybeMessage<::tensorflow::serving::SamplingConfig>(GetArena());
    sampling_config_ = p;
  }
  return sampling_config_;
}
inline ::tensorflow::serving::SamplingConfig*
LoggingConfig::mutable_sampling_config() {
...
inline void LoggingConfig::set_allocated_sampling_config(
    ::tensorflow::serving::SamplingConfig* sampling_config) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete sampling_config_;
