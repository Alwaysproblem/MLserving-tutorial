...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_LoggingConfig_tensorflow_5fserving_2fconfig_2flogging_5fconfig_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3>
        scc_info_ModelConfig_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
        scc_info_ModelConfig_VersionLabelsEntry_DoNotUse_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_ModelConfigList_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto;
...
class ModelConfigDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ModelConfig>
      _instance;
} _ModelConfig_default_instance_;
class ModelConfigListDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ModelConfigList>
      _instance;
} _ModelConfigList_default_instance_;
class ModelServerConfigDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ModelServerConfig>
      _instance;
...
static void
InitDefaultsscc_info_ModelConfig_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto() {
...
static void
InitDefaultsscc_info_ModelConfig_VersionLabelsEntry_DoNotUse_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::tensorflow::serving::ModelConfig_VersionLabelsEntry_DoNotUse::
...
static void
InitDefaultsscc_info_ModelConfigList_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_ModelServerConfig_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
    scc_info_ModelServerConfig_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto =
        {{ATOMIC_VAR_INIT(
              ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized),
          2, 0,
          InitDefaultsscc_info_ModelServerConfig_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto},
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto
        [4];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ...
            1,
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelConfig,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelConfig,
                                  logging_config_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelConfigList,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelConfigList,
                                  config_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelServerConfig,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelServerConfig,
                                  _oneof_case_[0]),
            ~0u,  // no _weak_field_map_
            offsetof(
                ::tensorflow::serving::ModelServerConfigDefaultTypeInternal,
                model_config_list_),
            offsetof(
                ::tensorflow::serving::ModelServerConfigDefaultTypeInternal,
                custom_model_config_),
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::ModelServerConfig,
                                  config_),
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const* const file_default_instances[] =
    {
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::
                _ModelConfig_VersionLabelsEntry_DoNotUse_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_ModelConfig_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_ModelConfigList_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
...
const char
    descriptor_table_protodef_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
            ...
            "e\030\002 "
            "\001(\003:"
            "\0028\001J\004\010\005\020\006\"B\n\017ModelConfigList\022/\n\006"
            ...
            "R\020\002\032\002\010\001B\003\370\001"
            "\001b\006proto3";
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto_sccs
        [4] = {
            &scc_info_ModelConfig_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto
                 .base,
            &scc_info_ModelConfig_VersionLabelsEntry_DoNotUse_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto
...
static bool dynamic_init_dummy_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto =
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* ModelType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto);
  return file_level_enum_descriptors_tensorflow_5fserving_2fconfig_2fmodel_5fserver_5fconfig_2eproto
      [0];
}
...
void ModelConfig_VersionLabelsEntry_DoNotUse::MergeFrom(
    const ModelConfig_VersionLabelsEntry_DoNotUse& other) {
  MergeFromInternal(other);
}
::PROTOBUF_NAMESPACE_ID::Metadata
ModelConfig_VersionLabelsEntry_DoNotUse::GetMetadata() const {
...
void ModelConfig::InitAsDefaultInstance() {
  ::tensorflow::serving::_ModelConfig_default_instance_._instance.get_mutable()
      ->model_version_policy_ =
  ...
  ::tensorflow::serving::_ModelConfig_default_instance_._instance.get_mutable()
      ->logging_config_ = const_cast<::tensorflow::serving::LoggingConfig*>(
...
class ModelConfig::_Internal {
 public:
  static const ::tensorflow::serving::
      FileSystemStoragePathSourceConfig_ServableVersionPolicy&
      model_version_policy(const ModelConfig* msg);
  static const ::tensorflow::serving::LoggingConfig& logging_config(
      const ModelConfig* msg);
};
...
ModelConfig::ModelConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), version_labels_(arena) {
  SharedCtor();
...
ModelConfig::ModelConfig(const ModelConfig& from)
  ...
  model_platform_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_model_platform().empty()) {
    model_platform_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_model_platform(), GetArena());
  }
  if (from._internal_has_logging_config()) {
    logging_config_ =
        new ::tensorflow::serving::LoggingConfig(*from.logging_config_);
  } else {
    logging_config_ = nullptr;
  }
  if (from._internal_has_model_version_policy()) {
    model_version_policy_ = new ::tensorflow::serving::
        FileSystemStoragePathSourceConfig_ServableVersionPolicy(
            *from.model_version_policy_);
  } else {
    model_version_policy_ = nullptr;
  }
...
void ModelConfig::SharedDtor() {
  ...
  base_path_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  model_platform_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void ModelConfig::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* ModelConfig::_InternalParse(
...
#define CHK_(x) \
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.ModelConfig.name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(
              str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.ModelConfig.base_path"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          _internal_set_model_type(
              static_cast<::tensorflow::serving::ModelType>(val));
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(
              str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.ModelConfig.model_platform"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      // model_version_policy = 7;
      case 7:
        if (PROTOBUF_PREDICT_TRUE(
                static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 58)) {
          ptr =
              ctx->ParseMessage(_internal_mutable_model_version_policy(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* ModelConfig::_InternalSerialize(
  ...
  if (this->model_platform().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_model_platform().data(),
        static_cast<int>(this->_internal_model_platform().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
  ...
  if (!this->_internal_version_labels().empty()) {
    typedef ::PROTOBUF_NAMESPACE_ID::Map<
        std::string, ::PROTOBUF_NAMESPACE_ID::int64>::const_pointer ConstPtr;
    ...
    if (stream->IsSerializationDeterministic() &&
      ...
      typedef ::PROTOBUF_NAMESPACE_ID::Map<
          std::string, ::PROTOBUF_NAMESPACE_ID::int64>::size_type size_type;
      size_type n = 0;
      for (::PROTOBUF_NAMESPACE_ID::Map<
               std::string, ::PROTOBUF_NAMESPACE_ID::int64>::const_iterator it =
               this->_internal_version_labels().begin();
      ...
      for (size_type i = 0; i < n; i++) {
        target =
            ModelConfig_VersionLabelsEntry_DoNotUse::Funcs::InternalSerialize(
                8, items[static_cast<ptrdiff_t>(i)]->first,
      ...
      for (::PROTOBUF_NAMESPACE_ID::Map<
        ...
        target =
            ModelConfig_VersionLabelsEntry_DoNotUse::Funcs::InternalSerialize(
                8, it->first, it->second, target, stream);
        Utf8Check::Check(&(*it));
      }
    }
  }
...
size_t ModelConfig::ByteSizeLong() const {
  ...
  total_size += 1 * ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(
                        this->_internal_version_labels_size());
  for (::PROTOBUF_NAMESPACE_ID::Map<
           std::string, ::PROTOBUF_NAMESPACE_ID::int64>::const_iterator it =
           this->_internal_version_labels().begin();
       it != this->_internal_version_labels().end(); ++it) {
    total_size += ModelConfig_VersionLabelsEntry_DoNotUse::Funcs::ByteSizeLong(
        it->first, it->second);
  }
...
void ModelConfig::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const ModelConfig* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ModelConfig>(&from);
  if (source == nullptr) {
...
void ModelConfig::MergeFrom(const ModelConfig& from) {
  ...
  if (from.has_logging_config()) {
    _internal_mutable_logging_config()
        ->::tensorflow::serving::LoggingConfig::MergeFrom(
            from._internal_logging_config());
  }
  if (from.has_model_version_policy()) {
    _internal_mutable_model_version_policy()->::tensorflow::serving::
...
bool ModelConfig::IsInitialized() const { return true; }
...
void ModelConfig::InternalSwap(ModelConfig* other) {
  ...
  base_path_.Swap(
      ...
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
  model_platform_.Swap(
      &other->model_platform_,
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
...
ModelConfigList::ModelConfigList(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), config_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
...
ModelConfigList::ModelConfigList(const ModelConfigList& from)
    : ::PROTOBUF_NAMESPACE_ID::Message(), config_(from.config_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      from._internal_metadata_);
...
void ModelConfigList::SharedDtor() { GOOGLE_DCHECK(GetArena() == nullptr); }
...
void ModelConfigList::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* ModelConfigList::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
::PROTOBUF_NAMESPACE_ID::uint8* ModelConfigList::_InternalSerialize(
  ...
  for (unsigned int i = 0, n = static_cast<unsigned int>(
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            1, this->_internal_config(i), target, stream);
  }
...
void ModelConfigList::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const ModelConfigList* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ModelConfigList>(&from);
  if (source == nullptr) {
...
bool ModelConfigList::IsInitialized() const { return true; }
...
void ModelServerConfig::InitAsDefaultInstance() {
  ::tensorflow::serving::_ModelServerConfig_default_instance_
      .model_config_list_ = const_cast<::tensorflow::serving::ModelConfigList*>(
      ::tensorflow::serving::ModelConfigList::internal_default_instance());
  ::tensorflow::serving::_ModelServerConfig_default_instance_
      .custom_model_config_ = const_cast<PROTOBUF_NAMESPACE_ID::Any*>(
      PROTOBUF_NAMESPACE_ID::Any::internal_default_instance());
}
class ModelServerConfig::_Internal {
 public:
  static const ::tensorflow::serving::ModelConfigList& model_config_list(
      const ModelServerConfig* msg);
  static const PROTOBUF_NAMESPACE_ID::Any& custom_model_config(
      const ModelServerConfig* msg);
};
...
ModelServerConfig::_Internal::custom_model_config(
    const ModelServerConfig* msg) {
  return *msg->config_.custom_model_config_;
}
void ModelServerConfig::set_allocated_model_config_list(
...
void ModelServerConfig::set_allocated_custom_model_config(
...
ModelServerConfig::ModelServerConfig(const ModelServerConfig& from)
  ...
  switch (from.config_case()) {
    case kModelConfigList: {
      _internal_mutable_model_config_list()
          ->::tensorflow::serving::ModelConfigList::MergeFrom(
              from._internal_model_config_list());
      break;
    }
    case kCustomModelConfig: {
      _internal_mutable_custom_model_config()
...
const char* ModelServerConfig::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
void ModelServerConfig::MergeFrom(
  ...
  const ModelServerConfig* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ModelServerConfig>(&from);
  if (source == nullptr) {
...
bool ModelServerConfig::IsInitialized() const { return true; }
...
PROTOBUF_NOINLINE ::tensorflow::serving::
  ...
  return Arena::CreateMessageInternal<
      ::tensorflow::serving::ModelConfig_VersionLabelsEntry_DoNotUse>(arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::ModelConfig*
Arena::CreateMaybeMessage<::tensorflow::serving::ModelConfig>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::ModelConfig>(
      arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::ModelConfigList*
Arena::CreateMaybeMessage<::tensorflow::serving::ModelConfigList>(
    Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::ModelConfigList>(
      arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::ModelServerConfig*
Arena::CreateMaybeMessage<::tensorflow::serving::ModelServerConfig>(
    Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::ModelServerConfig>(
      arena);
}
