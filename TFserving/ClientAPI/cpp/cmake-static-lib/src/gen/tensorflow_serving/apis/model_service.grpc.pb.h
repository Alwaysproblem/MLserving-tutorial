 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status GetModelStatus(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::GetModelStatusRequest& request,
        ::tensorflow::serving::GetModelStatusResponse* response) = 0;
    ...
    AsyncGetModelStatus(
      ...
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::tensorflow::serving::GetModelStatusResponse>>(
          AsyncGetModelStatusRaw(context, request, cq));
    }
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::GetModelStatusResponse>>
    PrepareAsyncGetModelStatus(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::GetModelStatusRequest& request,
        ::grpc::CompletionQueue* cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::tensorflow::serving::GetModelStatusResponse>>(
          PrepareAsyncGetModelStatusRaw(context, request, cq));
    }
    ...
    // longer served.
    virtual ::grpc::Status HandleReloadConfigRequest(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::ReloadConfigRequest& request,
        ::tensorflow::serving::ReloadConfigResponse* response) = 0;
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::ReloadConfigResponse>>
    AsyncHandleReloadConfigRequest(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::ReloadConfigRequest& request,
        ::grpc::CompletionQueue* cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::tensorflow::serving::ReloadConfigResponse>>(
          AsyncHandleReloadConfigRequestRaw(context, request, cq));
    }
    std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::ReloadConfigResponse>>
    PrepareAsyncHandleReloadConfigRequest(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::ReloadConfigRequest& request,
        ::grpc::CompletionQueue* cq) {
      return std::unique_ptr<::grpc::ClientAsyncResponseReaderInterface<
          ::tensorflow::serving::ReloadConfigResponse>>(
          PrepareAsyncHandleReloadConfigRequestRaw(context, request, cq));
    }
    class experimental_async_interface {
     public:
      virtual ~experimental_async_interface() {}
      // Gets status of model. If the ModelSpec in the request does not specify
      // version, information about all versions of the model will be returned.
      // If the ModelSpec in the request does specify a version, the status of
      // only that version will be returned.
      ...
      virtual void GetModelStatus(
          ...
          ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
#endif
      // Reloads the set of served models. The new config supersedes the old
      // one, so if a model is omitted from the new config it will be unloaded
   ...
   private:
    virtual ::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::GetModelStatusResponse>*
    AsyncGetModelStatusRaw(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::GetModelStatusRequest& request,
        ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::GetModelStatusResponse>*
    PrepareAsyncGetModelStatusRaw(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::GetModelStatusRequest& request,
        ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::ReloadConfigResponse>*
    AsyncHandleReloadConfigRequestRaw(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::ReloadConfigRequest& request,
        ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface<
        ::tensorflow::serving::ReloadConfigResponse>*
    PrepareAsyncHandleReloadConfigRequestRaw(
        ::grpc::ClientContext* context,
        const ::tensorflow::serving::ReloadConfigRequest& request,
        ::grpc::CompletionQueue* cq) = 0;
  };
    ...
    class experimental_async final
     ...
     public:
      ...
      void GetModelStatus(
          ...
          ::grpc::experimental::ClientUnaryReactor* reactor) override;
#endif
      void HandleReloadConfigRequest(
          ::grpc::ClientContext* context,
          const ::tensorflow::serving::ReloadConfigRequest* request,
          ::tensorflow::serving::ReloadConfigResponse* response,
          std::function<void(::grpc::Status)>) override;
  ...
  class WithAsyncMethod_GetModelStatus : public BaseClass {
   ...
   public:
    WithAsyncMethod_GetModelStatus() { ::grpc::Service::MarkMethodAsync(0); }
  ...
  class WithAsyncMethod_HandleReloadConfigRequest : public BaseClass {
   ...
   public:
    ...
    void RequestHandleReloadConfigRequest(
        ::grpc::ServerContext* context,
        ::tensorflow::serving::ReloadConfigRequest* request,
        ::grpc::ServerAsyncResponseWriter<
            ::tensorflow::serving::ReloadConfigResponse>* response,
        ::grpc::CompletionQueue* new_call_cq,
        ::grpc::ServerCompletionQueue* notification_cq, void* tag) {
  ...
  typedef WithAsyncMethod_GetModelStatus<
      WithAsyncMethod_HandleReloadConfigRequest<Service>>
      AsyncService;
  template <class BaseClass>
...
#endif
                          context,
                      const ::tensorflow::serving::GetModelStatusRequest*
                          request,
                      ::tensorflow::serving::GetModelStatusResponse* response) {
                    return this->GetModelStatus(context, request, response);
                  }));
    }
    void SetMessageAllocatorFor_GetModelStatus(
        ::grpc::experimental::MessageAllocator<
            ::tensorflow::serving::GetModelStatusRequest,
            ::tensorflow::serving::GetModelStatusResponse>* allocator) {
#ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler<
          ::tensorflow::serving::GetModelStatusRequest,
          ::tensorflow::serving::GetModelStatusResponse>*>(handler)
  ...
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_HandleReloadConfigRequest
      : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   ...
   public:
          ...
          MarkMethodCallback(
              ...
              new ::grpc_impl::internal::CallbackUnaryHandler<
                  ...
                  [this](
                      ...
                      const ::tensorflow::serving::ReloadConfigRequest* request,
                      ::tensorflow::serving::ReloadConfigResponse* response) {
                    return this->HandleReloadConfigRequest(context, request,
                                                           response);
                  }));
    }
    void SetMessageAllocatorFor_HandleReloadConfigRequest(
        ::grpc::experimental::MessageAllocator<
            ::tensorflow::serving::ReloadConfigRequest,
            ::tensorflow::serving::ReloadConfigResponse>* allocator) {
#ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler =
      ...
      static_cast<::grpc_impl::internal::CallbackUnaryHandler<
          ::tensorflow::serving::ReloadConfigRequest,
          ::tensorflow::serving::ReloadConfigResponse>*>(handler)
          ->SetMessageAllocator(allocator);
    }
...
#ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_GetModelStatus<
      ExperimentalWithCallbackMethod_HandleReloadConfigRequest<Service>>
      CallbackService;
#endif
  ...
  class WithRawMethod_GetModelStatus : public BaseClass {
   ...
   public:
    WithRawMethod_GetModelStatus() { ::grpc::Service::MarkMethodRaw(0); }
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_HandleReloadConfigRequest
      : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
          ...
          MarkMethodRawCallback(1,
                                new ::grpc_impl::internal::CallbackUnaryHandler<
                                    ...
                                    [this](
                                        ...
                                        const ::grpc::ByteBuffer* request,
                                        ::grpc::ByteBuffer* response) {
                                      return this->HandleReloadConfigRequest(
  ...
  class WithStreamedUnaryMethod_GetModelStatus : public BaseClass {
   ...
   public:
          ...
          0, new ::grpc::internal::StreamedUnaryHandler<
                 ...
                 [this](::grpc_impl::ServerContext* context,
                        ::grpc_impl::ServerUnaryStreamer<
                            ...
                            ::tensorflow::serving::GetModelStatusResponse>*
                            streamer) {
                   return this->StreamedGetModelStatus(context, streamer);
                 }));
    }
    ...
    virtual ::grpc::Status StreamedGetModelStatus(
        ::grpc::ServerContext* context,
  ...
  class WithStreamedUnaryMethod_HandleReloadConfigRequest : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::MarkMethodStreamed(
          ...
          new ::grpc::internal::StreamedUnaryHandler<
              ...
              [this](
                  ...
                  ::grpc_impl::ServerUnaryStreamer<
                      ::tensorflow::serving::ReloadConfigRequest,
                      ::tensorflow::serving::ReloadConfigResponse>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedHandleReloadConfigRequest(
        ::grpc::ServerContext* context,
        ::grpc::ServerUnaryStreamer<
            ::tensorflow::serving::ReloadConfigRequest,
            ::tensorflow::serving::ReloadConfigResponse>*
  ...
  typedef WithStreamedUnaryMethod_GetModelStatus<
      WithStreamedUnaryMethod_HandleReloadConfigRequest<Service>>
