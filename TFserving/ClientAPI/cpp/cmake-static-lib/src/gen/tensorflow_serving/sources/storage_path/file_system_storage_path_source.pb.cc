...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_FileSystemStoragePathSourceConfig_ServableToMonitor_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3>
        scc_info_FileSystemStoragePathSourceConfig_ServableVersionPolicy_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
        scc_info_FileSystemStoragePathSourceConfig_ServableVersionPolicy_All_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
        scc_info_FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
        scc_info_FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto;
...
static void
InitDefaultsscc_info_FileSystemStoragePathSourceConfig_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
    scc_info_FileSystemStoragePathSourceConfig_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto =
        {{ATOMIC_VAR_INIT(
...
static void
InitDefaultsscc_info_FileSystemStoragePathSourceConfig_ServableToMonitor_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_FileSystemStoragePathSourceConfig_ServableVersionPolicy_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_FileSystemStoragePathSourceConfig_ServableVersionPolicy_All_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const**
    file_level_enum_descriptors_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto =
        nullptr;
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ...
            PROTOBUF_FIELD_OFFSET(
                ::tensorflow::serving::FileSystemStoragePathSourceConfig,
                file_system_poll_wait_seconds_),
            PROTOBUF_FIELD_OFFSET(
                ::tensorflow::serving::FileSystemStoragePathSourceConfig,
                fail_if_zero_versions_at_startup_),
            PROTOBUF_FIELD_OFFSET(
                ::tensorflow::serving::FileSystemStoragePathSourceConfig,
                servable_versions_always_present_),
};
        ...
        {11, -1,
         sizeof(
             ::tensorflow::serving::
                 FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific)},
        {17, -1,
         sizeof(::tensorflow::serving::
                    FileSystemStoragePathSourceConfig_ServableVersionPolicy)},
        {26, -1,
         sizeof(::tensorflow::serving::
                    FileSystemStoragePathSourceConfig_ServableToMonitor)},
        {34, -1,
         sizeof(::tensorflow::serving::FileSystemStoragePathSourceConfig)},
};
...
const char
    descriptor_table_protodef_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
            ...
            "\030\002 \001(\t\022l\n\027servable_version_policy\030\004 "
            "\001(\0132"
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::
    InitAsDefaultInstance() {}
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::ArenaDtor(
    void* object) {
  FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest* _this =
      reinterpret_cast<
          FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest*>(
          object);
  (void)_this;
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::
    RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {}
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::
    SetCachedSize(int size) const {
...
const char*
FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::_InternalParse(
  ...
  if (this->num_versions() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(
            1, this->_internal_num_versions(), target);
  }
...
size_t
FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::ByteSizeLong()
    const {
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::MergeFrom(
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::
    IsInitialized() const {
  return true;
}
...
FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::GetMetadata()
    const {
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::
    InitAsDefaultInstance() {}
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::ArenaDtor(
    void* object) {
  FileSystemStoragePathSourceConfig_ServableVersionPolicy_All* _this =
      reinterpret_cast<
          FileSystemStoragePathSourceConfig_ServableVersionPolicy_All*>(object);
  (void)_this;
}
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::
    RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {}
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::SetCachedSize(
    int size) const {
  _cached_size_.Set(size);
}
...
const char*
FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
size_t
FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::ByteSizeLong()
    const {
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const FileSystemStoragePathSourceConfig_ServableVersionPolicy_All* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          FileSystemStoragePathSourceConfig_ServableVersionPolicy_All>(&from);
  if (source == nullptr) {
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::
    IsInitialized() const {
  return true;
}

void FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::InternalSwap(
...
::PROTOBUF_NAMESPACE_ID::Metadata
FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::GetMetadata()
    const {
  return GetMetadataStatic();
}
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::
    InitAsDefaultInstance() {}
...
FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::
    FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific(
        ::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), versions_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
...
FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::
    FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific(
        const FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific&
            from)
    : ::PROTOBUF_NAMESPACE_ID::Message(), versions_(from.versions_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      from._internal_metadata_);
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::
    ArenaDtor(void* object) {
  FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific* _this =
      reinterpret_cast<
          FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific*>(
          object);
  (void)_this;
...
const char* FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedInt64Parser(
              _internal_mutable_versions(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8) {
          _internal_add_versions(
...
FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::
  ...
  // repeated int64 versions = 1;
  {
    ...
    if (byte_size > 0) {
      target =
          stream->WriteInt64Packed(1, _internal_versions(), byte_size, target);
    }
  }
...
size_t
FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::ByteSizeLong()
    const {
  ...
  // repeated int64 versions = 1;
  {
    ...
    _versions_cached_byte_size_.store(cached_size, std::memory_order_relaxed);
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::
    MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  GOOGLE_DCHECK_NE(&from, this);
  const FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific*
      source = ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific>(
          &from);
  if (source == nullptr) {
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::
    IsInitialized() const {
  return true;
}
...
::PROTOBUF_NAMESPACE_ID::Metadata
FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::GetMetadata()
    const {
  return GetMetadataStatic();
}
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy::
    InitAsDefaultInstance() {
  ::tensorflow::serving::
      _FileSystemStoragePathSourceConfig_ServableVersionPolicy_default_instance_
          .latest_ = const_cast<
...
class FileSystemStoragePathSourceConfig_ServableVersionPolicy::_Internal {
 public:
  static const ::tensorflow::serving::
      FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest&
      latest(
          const FileSystemStoragePathSourceConfig_ServableVersionPolicy* msg);
  static const ::tensorflow::serving::
      FileSystemStoragePathSourceConfig_ServableVersionPolicy_All&
      all(const FileSystemStoragePathSourceConfig_ServableVersionPolicy* msg);
  static const ::tensorflow::serving::
      FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific&
      specific(
          const FileSystemStoragePathSourceConfig_ServableVersionPolicy* msg);
...
const ::tensorflow::serving::
    FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest&
    FileSystemStoragePathSourceConfig_ServableVersionPolicy::_Internal::latest(
        const FileSystemStoragePathSourceConfig_ServableVersionPolicy* msg) {
  return *msg->policy_choice_.latest_;
}
const ::tensorflow::serving::
    FileSystemStoragePathSourceConfig_ServableVersionPolicy_All&
    FileSystemStoragePathSourceConfig_ServableVersionPolicy::_Internal::all(
        const FileSystemStoragePathSourceConfig_ServableVersionPolicy* msg) {
  return *msg->policy_choice_.all_;
}
const ::tensorflow::serving::
    FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific&
    FileSystemStoragePathSourceConfig_ServableVersionPolicy::_Internal::
        specific(const FileSystemStoragePathSourceConfig_ServableVersionPolicy*
                     msg) {
  return *msg->policy_choice_.specific_;
}
void FileSystemStoragePathSourceConfig_ServableVersionPolicy::
    set_allocated_latest(
        ::tensorflow::serving::
            FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest*
                latest) {
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy::set_allocated_all(
    ::tensorflow::serving::
...
FileSystemStoragePathSourceConfig_ServableVersionPolicy::
  ...
  switch (from.policy_choice_case()) {
    case kLatest: {
      _internal_mutable_latest()->::tensorflow::serving::
          FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest::
              MergeFrom(from._internal_latest());
      break;
    }
    case kAll: {
      _internal_mutable_all()->::tensorflow::serving::
          FileSystemStoragePathSourceConfig_ServableVersionPolicy_All::
              MergeFrom(from._internal_all());
      break;
    }
    case kSpecific: {
      _internal_mutable_specific()->::tensorflow::serving::
          FileSystemStoragePathSourceConfig_ServableVersionPolicy_Specific::
              MergeFrom(from._internal_specific());
      break;
    }
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy::ArenaDtor(
    void* object) {
  FileSystemStoragePathSourceConfig_ServableVersionPolicy* _this =
      reinterpret_cast<
          FileSystemStoragePathSourceConfig_ServableVersionPolicy*>(object);
  (void)_this;
}
void FileSystemStoragePathSourceConfig_ServableVersionPolicy::RegisterArenaDtor(
    ::PROTOBUF_NAMESPACE_ID::Arena*) {}
void FileSystemStoragePathSourceConfig_ServableVersionPolicy::SetCachedSize(
    int size) const {
  _cached_size_.Set(size);
}
const FileSystemStoragePathSourceConfig_ServableVersionPolicy&
FileSystemStoragePathSourceConfig_ServableVersionPolicy::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &::scc_info_FileSystemStoragePathSourceConfig_ServableVersionPolicy_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto
           .base);
  return *internal_default_instance();
...
const char*
FileSystemStoragePathSourceConfig_ServableVersionPolicy::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
size_t FileSystemStoragePathSourceConfig_ServableVersionPolicy::ByteSizeLong()
    const {
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const FileSystemStoragePathSourceConfig_ServableVersionPolicy* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          FileSystemStoragePathSourceConfig_ServableVersionPolicy>(&from);
  if (source == nullptr) {
...
void FileSystemStoragePathSourceConfig_ServableVersionPolicy::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool FileSystemStoragePathSourceConfig_ServableVersionPolicy::IsInitialized()
    const {
  return true;
}

void FileSystemStoragePathSourceConfig_ServableVersionPolicy::InternalSwap(
...
::PROTOBUF_NAMESPACE_ID::Metadata
FileSystemStoragePathSourceConfig_ServableVersionPolicy::GetMetadata() const {
  return GetMetadataStatic();
}

// ===================================================================

void FileSystemStoragePathSourceConfig_ServableToMonitor::
    InitAsDefaultInstance() {
  ::tensorflow::serving::
      _FileSystemStoragePathSourceConfig_ServableToMonitor_default_instance_
          ._instance.get_mutable()
          ->servable_version_policy_ =
      const_cast<::tensorflow::serving::
                     FileSystemStoragePathSourceConfig_ServableVersionPolicy*>(
          ::tensorflow::serving::
              FileSystemStoragePathSourceConfig_ServableVersionPolicy::
                  internal_default_instance());
 ...
 public:
  static const ::tensorflow::serving::
      ...
      servable_version_policy(
          const FileSystemStoragePathSourceConfig_ServableToMonitor* msg);
};

const ::tensorflow::serving::
    FileSystemStoragePathSourceConfig_ServableVersionPolicy&
    FileSystemStoragePathSourceConfig_ServableToMonitor::_Internal::
        servable_version_policy(
            const FileSystemStoragePathSourceConfig_ServableToMonitor* msg) {
...
FileSystemStoragePathSourceConfig_ServableToMonitor::
  ...
  base_path_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (!from._internal_base_path().empty()) {
    base_path_.Set(
        &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
        from._internal_base_path(), GetArena());
  }
  if (from._internal_has_servable_version_policy()) {
    servable_version_policy_ = new ::tensorflow::serving::
        FileSystemStoragePathSourceConfig_ServableVersionPolicy(
            *from.servable_version_policy_);
  } else {
...
void FileSystemStoragePathSourceConfig_ServableToMonitor::SharedDtor() {
  ...
  servable_name_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  base_path_.DestroyNoArena(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  if (this != internal_default_instance()) delete servable_version_policy_;
}

void FileSystemStoragePathSourceConfig_ServableToMonitor::ArenaDtor(
    void* object) {
  FileSystemStoragePathSourceConfig_ServableToMonitor* _this =
      reinterpret_cast<FileSystemStoragePathSourceConfig_ServableToMonitor*>(
          object);
  (void)_this;
}
void FileSystemStoragePathSourceConfig_ServableToMonitor::RegisterArenaDtor(
    ::PROTOBUF_NAMESPACE_ID::Arena*) {}
void FileSystemStoragePathSourceConfig_ServableToMonitor::SetCachedSize(
    int size) const {
  _cached_size_.Set(size);
}
const FileSystemStoragePathSourceConfig_ServableToMonitor&
FileSystemStoragePathSourceConfig_ServableToMonitor::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &::scc_info_FileSystemStoragePathSourceConfig_ServableToMonitor_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto
           .base);
  return *internal_default_instance();
...
const char* FileSystemStoragePathSourceConfig_ServableToMonitor::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str,
              "tensorflow.serving.FileSystemStoragePathSourceConfig."
              "ServableToMonitor.servable_name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(
                static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ptr = ctx->ParseMessage(_internal_mutable_servable_version_policy(),
                                  ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
...
FileSystemStoragePathSourceConfig_ServableToMonitor::_InternalSerialize(
  ...
  if (this->base_path().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        this->_internal_base_path().data(),
        static_cast<int>(this->_internal_base_path().length()),
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
        "tensorflow.serving.FileSystemStoragePathSourceConfig."
        "ServableToMonitor.base_path");
    target =
        stream->WriteStringMaybeAliased(2, this->_internal_base_path(), target);
  }
...
size_t FileSystemStoragePathSourceConfig_ServableToMonitor::ByteSizeLong()
    const {
...
void FileSystemStoragePathSourceConfig_ServableToMonitor::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const FileSystemStoragePathSourceConfig_ServableToMonitor* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          FileSystemStoragePathSourceConfig_ServableToMonitor>(&from);
  if (source == nullptr) {
...
void FileSystemStoragePathSourceConfig_ServableToMonitor::MergeFrom(
  ...
  if (from.has_servable_version_policy()) {
    _internal_mutable_servable_version_policy()->::tensorflow::serving::
        FileSystemStoragePathSourceConfig_ServableVersionPolicy::MergeFrom(
            from._internal_servable_version_policy());
  }
}

void FileSystemStoragePathSourceConfig_ServableToMonitor::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool FileSystemStoragePathSourceConfig_ServableToMonitor::IsInitialized()
    const {
  return true;
}

void FileSystemStoragePathSourceConfig_ServableToMonitor::InternalSwap(
...
::PROTOBUF_NAMESPACE_ID::Metadata
FileSystemStoragePathSourceConfig_ServableToMonitor::GetMetadata() const {
  return GetMetadataStatic();
}
...
FileSystemStoragePathSourceConfig::FileSystemStoragePathSourceConfig(
    ::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), servables_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
...
FileSystemStoragePathSourceConfig::FileSystemStoragePathSourceConfig(
    ...
    : ::PROTOBUF_NAMESPACE_ID::Message(), servables_(from.servables_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      from._internal_metadata_);
  servable_name_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ...
  ::memcpy(&file_system_poll_wait_seconds_,
           &from.file_system_poll_wait_seconds_,
           static_cast<size_t>(
               reinterpret_cast<char*>(&servable_versions_always_present_) -
               reinterpret_cast<char*>(&file_system_poll_wait_seconds_)) +
               sizeof(servable_versions_always_present_));
...
void FileSystemStoragePathSourceConfig::SharedCtor() {
  ...
  base_path_.UnsafeSetDefault(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(&file_system_poll_wait_seconds_, 0,
           static_cast<size_t>(
               reinterpret_cast<char*>(&servable_versions_always_present_) -
               reinterpret_cast<char*>(&file_system_poll_wait_seconds_)) +
               sizeof(servable_versions_always_present_));
...
void FileSystemStoragePathSourceConfig::ArenaDtor(void* object) {
  FileSystemStoragePathSourceConfig* _this =
      reinterpret_cast<FileSystemStoragePathSourceConfig*>(object);
  (void)_this;
}
void FileSystemStoragePathSourceConfig::RegisterArenaDtor(
    ::PROTOBUF_NAMESPACE_ID::Arena*) {}
void FileSystemStoragePathSourceConfig::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const FileSystemStoragePathSourceConfig&
FileSystemStoragePathSourceConfig::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &::scc_info_FileSystemStoragePathSourceConfig_tensorflow_5fserving_2fsources_2fstorage_5fpath_2ffile_5fsystem_5fstorage_5fpath_5fsource_2eproto
           .base);
  return *internal_default_instance();
...
const char* FileSystemStoragePathSourceConfig::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str,
              "tensorflow.serving.FileSystemStoragePathSourceConfig.servable_"
              "name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str,
              "tensorflow.serving.FileSystemStoragePathSourceConfig.base_"
              "path"));
          CHK_(ptr);
        } else
          goto handle_unusual;
...
FileSystemStoragePathSourceConfig::_InternalSerialize(
  ...
  if (this->file_system_poll_wait_seconds() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt64ToArray(
            3, this->_internal_file_system_poll_wait_seconds(), target);
  }
  ...
  if (this->fail_if_zero_versions_at_startup() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(
            4, this->_internal_fail_if_zero_versions_at_startup(), target);
  }
  ...
  for (unsigned int i = 0, n = static_cast<unsigned int>(
                               this->_internal_servables_size());
       i < n; i++) {
    target = stream->EnsureSpace(target);
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            5, this->_internal_servables(i), target, stream);
  }
  ...
  if (this->servable_versions_always_present() != 0) {
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(
            6, this->_internal_servable_versions_always_present(), target);
  }
...
void FileSystemStoragePathSourceConfig::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const FileSystemStoragePathSourceConfig* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<
          FileSystemStoragePathSourceConfig>(&from);
  if (source == nullptr) {
...
void FileSystemStoragePathSourceConfig::MergeFrom(
  ...
  if (from.file_system_poll_wait_seconds() != 0) {
    _internal_set_file_system_poll_wait_seconds(
        from._internal_file_system_poll_wait_seconds());
  }
  if (from.fail_if_zero_versions_at_startup() != 0) {
    _internal_set_fail_if_zero_versions_at_startup(
        from._internal_fail_if_zero_versions_at_startup());
  }
  if (from.servable_versions_always_present() != 0) {
    _internal_set_servable_versions_always_present(
        from._internal_servable_versions_always_present());
  }
}

void FileSystemStoragePathSourceConfig::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool FileSystemStoragePathSourceConfig::IsInitialized() const { return true; }

void FileSystemStoragePathSourceConfig::InternalSwap(
    FileSystemStoragePathSourceConfig* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      &other->_internal_metadata_);
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FileSystemStoragePathSourceConfig,
                            servable_versions_always_present_) +
...
::PROTOBUF_NAMESPACE_ID::Metadata
FileSystemStoragePathSourceConfig::GetMetadata() const {
  return GetMetadataStatic();
}
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::
    FileSystemStoragePathSourceConfig_ServableVersionPolicy_Latest*
...
PROTOBUF_NOINLINE ::tensorflow::serving::
    ...
    Arena::CreateMaybeMessage<
        ::tensorflow::serving::
            FileSystemStoragePathSourceConfig_ServableToMonitor>(Arena* arena) {
  return Arena::CreateMessageInternal<
      ::tensorflow::serving::
          FileSystemStoragePathSourceConfig_ServableToMonitor>(arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::FileSystemStoragePathSourceConfig*
Arena::CreateMaybeMessage<
    ::tensorflow::serving::FileSystemStoragePathSourceConfig>(Arena* arena) {
  return Arena::CreateMessageInternal<
