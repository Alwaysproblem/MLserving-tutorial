...
class LogMetadataDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<LogMetadata>
      _instance;
} _LogMetadata_default_instance_;
}  // namespace serving
}  // namespace tensorflow
static void
InitDefaultsscc_info_LogMetadata_tensorflow_5fserving_2fcore_2flogging_2eproto() {
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_5fserving_2fcore_2flogging_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const**
    file_level_enum_descriptors_tensorflow_5fserving_2fcore_2flogging_2eproto =
        nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const**
    file_level_service_descriptors_tensorflow_5fserving_2fcore_2flogging_2eproto =
        nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fcore_2flogging_2eproto::offsets
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::LogMetadata,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
...
const char
    descriptor_table_protodef_tensorflow_5fserving_2fcore_2flogging_2eproto
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* const
    descriptor_table_tensorflow_5fserving_2fcore_2flogging_2eproto_deps[2] = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2fcore_2flogging_2eproto_sccs[1] = {
        &scc_info_LogMetadata_tensorflow_5fserving_2fcore_2flogging_2eproto
             .base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag
    descriptor_table_tensorflow_5fserving_2fcore_2flogging_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_tensorflow_5fserving_2fcore_2flogging_2eproto = {
        ...
        311,
        &descriptor_table_tensorflow_5fserving_2fcore_2flogging_2eproto_once,
        descriptor_table_tensorflow_5fserving_2fcore_2flogging_2eproto_sccs,
        descriptor_table_tensorflow_5fserving_2fcore_2flogging_2eproto_deps,
        1,
        2,
        schemas,
        file_default_instances,
        TableStruct_tensorflow_5fserving_2fcore_2flogging_2eproto::offsets,
        file_level_metadata_tensorflow_5fserving_2fcore_2flogging_2eproto,
        1,
        file_level_enum_descriptors_tensorflow_5fserving_2fcore_2flogging_2eproto,
        file_level_service_descriptors_tensorflow_5fserving_2fcore_2flogging_2eproto,
};
...
static bool dynamic_init_dummy_tensorflow_5fserving_2fcore_2flogging_2eproto =
...
void LogMetadata::InitAsDefaultInstance() {
  ::tensorflow::serving::_LogMetadata_default_instance_._instance.get_mutable()
...
class LogMetadata::_Internal {
 public:
  static const ::tensorflow::serving::ModelSpec& model_spec(
      const LogMetadata* msg);
  static const ::tensorflow::serving::SamplingConfig& sampling_config(
      const LogMetadata* msg);
};

const ::tensorflow::serving::ModelSpec& LogMetadata::_Internal::model_spec(
    const LogMetadata* msg) {
...
LogMetadata::LogMetadata(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), saved_model_tags_(arena) {
  SharedCtor();
...
void LogMetadata::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* LogMetadata::_InternalParse(
        ...
        if (PROTOBUF_PREDICT_TRUE(
          ...
          do {
            ...
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
                str, "tensorflow.serving.LogMetadata.saved_model_tags"));
            CHK_(ptr);
...
void LogMetadata::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const LogMetadata* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<LogMetadata>(&from);
  if (source == nullptr) {
...
bool LogMetadata::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::LogMetadata*
Arena::CreateMaybeMessage<::tensorflow::serving::LogMetadata>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::LogMetadata>(
      arena);
}
