...
Arena::CreateMaybeMessage<::tensorflow::serving::LogMetadata>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace serving {
...
class LogMetadata PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.LogMetadata)
                   */
{
 public:
  ...
  LogMetadata(LogMetadata&& from) noexcept : LogMetadata() {
    *this = ::std::move(from);
  }
 ...
 private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
        &::descriptor_table_tensorflow_5fserving_2fcore_2flogging_2eproto);
    return ::descriptor_table_tensorflow_5fserving_2fcore_2flogging_2eproto
...
LogMetadata::_internal_model_spec() const {
...
LogMetadata::unsafe_arena_release_model_spec() {
...
inline ::tensorflow::serving::ModelSpec*
LogMetadata::_internal_mutable_model_spec() {
...
inline void LogMetadata::set_allocated_model_spec(
    ::tensorflow::serving::ModelSpec* model_spec) {
...
LogMetadata::_internal_sampling_config() const {
...
inline const ::tensorflow::serving::SamplingConfig&
LogMetadata::sampling_config() const {
...
LogMetadata::release_sampling_config() {
...
inline ::tensorflow::serving::SamplingConfig*
LogMetadata::unsafe_arena_release_sampling_config() {
...
inline ::tensorflow::serving::SamplingConfig*
LogMetadata::_internal_mutable_sampling_config() {
...
inline ::tensorflow::serving::SamplingConfig*
LogMetadata::mutable_sampling_config() {
...
inline void LogMetadata::set_allocated_sampling_config(
    ::tensorflow::serving::SamplingConfig* sampling_config) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(
...
inline void LogMetadata::clear_saved_model_tags() { saved_model_tags_.Clear(); }
...
inline const std::string& LogMetadata::_internal_saved_model_tags(
    int index) const {
...
inline void LogMetadata::set_saved_model_tags(int index,
...
inline void LogMetadata::set_saved_model_tags(int index, const char* value,
                                              size_t size) {
  saved_model_tags_.Mutable(index)->assign(reinterpret_cast<const char*>(value),
                                           size);
