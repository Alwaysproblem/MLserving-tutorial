...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
        scc_info_PrometheusConfig_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto;
namespace tensorflow {
namespace serving {
class PrometheusConfigDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PrometheusConfig>
      _instance;
} _PrometheusConfig_default_instance_;
class MonitoringConfigDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<MonitoringConfig>
      _instance;
} _MonitoringConfig_default_instance_;
}  // namespace serving
}  // namespace tensorflow
static void
InitDefaultsscc_info_MonitoringConfig_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
    scc_info_MonitoringConfig_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto =
        {{ATOMIC_VAR_INIT(
...
static void
InitDefaultsscc_info_PrometheusConfig_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto
        [2];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto::
        offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::PrometheusConfig,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::PrometheusConfig,
                                  path_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::MonitoringConfig,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
...
static ::PROTOBUF_NAMESPACE_ID::Message const* const file_default_instances[] =
    {
        ...
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_MonitoringConfig_default_instance_),
};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* const
    descriptor_table_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto_deps
        [1] = {};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto_sccs
        [2] = {
            &scc_info_MonitoringConfig_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto
                 .base,
            &scc_info_PrometheusConfig_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto
...
static bool dynamic_init_dummy_tensorflow_5fserving_2fconfig_2fmonitoring_5fconfig_2eproto =
...
PrometheusConfig::PrometheusConfig(const PrometheusConfig& from)
  ...
  if (!from._internal_path().empty()) {
    path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
              from._internal_path(), GetArena());
  }
...
const char* PrometheusConfig::_InternalParse(
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.PrometheusConfig.path"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void PrometheusConfig::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const PrometheusConfig* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PrometheusConfig>(&from);
  if (source == nullptr) {
...
bool PrometheusConfig::IsInitialized() const { return true; }
...
void MonitoringConfig::InitAsDefaultInstance() {
  ::tensorflow::serving::_MonitoringConfig_default_instance_._instance
      .get_mutable()
      ->prometheus_config_ =
      const_cast<::tensorflow::serving::PrometheusConfig*>(
          ::tensorflow::serving::PrometheusConfig::internal_default_instance());
}
class MonitoringConfig::_Internal {
 public:
  static const ::tensorflow::serving::PrometheusConfig& prometheus_config(
      const MonitoringConfig* msg);
};
...
MonitoringConfig::MonitoringConfig(const MonitoringConfig& from)
  ...
  if (from._internal_has_prometheus_config()) {
    prometheus_config_ =
        new ::tensorflow::serving::PrometheusConfig(*from.prometheus_config_);
  } else {
...
const char* MonitoringConfig::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
void MonitoringConfig::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const MonitoringConfig* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<MonitoringConfig>(&from);
  if (source == nullptr) {
...
void MonitoringConfig::MergeFrom(const MonitoringConfig& from) {
  ...
  if (from.has_prometheus_config()) {
    _internal_mutable_prometheus_config()
        ->::tensorflow::serving::PrometheusConfig::MergeFrom(
...
bool MonitoringConfig::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::PrometheusConfig*
Arena::CreateMaybeMessage<::tensorflow::serving::PrometheusConfig>(
    Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::PrometheusConfig>(
      arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::MonitoringConfig*
Arena::CreateMaybeMessage<::tensorflow::serving::MonitoringConfig>(
    Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::MonitoringConfig>(
      arena);
}
