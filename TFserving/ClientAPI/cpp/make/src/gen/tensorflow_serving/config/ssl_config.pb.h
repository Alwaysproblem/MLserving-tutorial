...
Arena::CreateMaybeMessage<::tensorflow::serving::SSLConfig>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace serving {
...
class SSLConfig PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.SSLConfig)
                   */
{
 public:
  ...
  SSLConfig(SSLConfig&& from) noexcept : SSLConfig() {
    *this = ::std::move(from);
  }
  ...
  static inline const SSLConfig* internal_default_instance() {
    return reinterpret_cast<const SSLConfig*>(&_SSLConfig_default_instance_);
  }
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_server_key(std::string* server_key);
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_server_cert(std::string* server_cert);
 ...
 public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_custom_ca(std::string* custom_ca);
...
inline void SSLConfig::set_server_key(const char* value, size_t size) {
  server_key_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* SSLConfig::unsafe_arena_release_server_key() {
  ...
  return server_key_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SSLConfig::unsafe_arena_set_allocated_server_key(
  ...
  server_key_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      server_key, GetArena());
...
inline void SSLConfig::set_server_cert(const char* value, size_t size) {
  server_cert_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* SSLConfig::unsafe_arena_release_server_cert() {
  ...
  return server_cert_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SSLConfig::unsafe_arena_set_allocated_server_cert(
  ...
  server_cert_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      server_cert, GetArena());
...
inline void SSLConfig::set_custom_ca(const char* value, size_t size) {
  custom_ca_.Set(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* SSLConfig::unsafe_arena_release_custom_ca() {
  ...
  return custom_ca_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SSLConfig::unsafe_arena_set_allocated_custom_ca(
  ...
  custom_ca_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      custom_ca, GetArena());
...
// bool client_verify = 4;
inline void SSLConfig::clear_client_verify() { client_verify_ = false; }
