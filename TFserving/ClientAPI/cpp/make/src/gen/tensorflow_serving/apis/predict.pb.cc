...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fpredict_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_PredictRequest_InputsEntry_DoNotUse_tensorflow_5fserving_2fapis_2fpredict_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fpredict_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_PredictResponse_OutputsEntry_DoNotUse_tensorflow_5fserving_2fapis_2fpredict_2eproto;
...
class PredictRequestDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PredictRequest>
      _instance;
...
class PredictResponseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<PredictResponse>
      _instance;
} _PredictResponse_default_instance_;
}  // namespace serving
}  // namespace tensorflow
static void
InitDefaultsscc_info_PredictRequest_tensorflow_5fserving_2fapis_2fpredict_2eproto() {
...
static void
InitDefaultsscc_info_PredictRequest_InputsEntry_DoNotUse_tensorflow_5fserving_2fapis_2fpredict_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::tensorflow::serving::PredictRequest_InputsEntry_DoNotUse::
...
static void
InitDefaultsscc_info_PredictResponse_tensorflow_5fserving_2fapis_2fpredict_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_PredictResponse_OutputsEntry_DoNotUse_tensorflow_5fserving_2fapis_2fpredict_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::tensorflow::serving::PredictResponse_OutputsEntry_DoNotUse::
      InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fapis_2fpredict_2eproto::offsets
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ...
            1,
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::PredictRequest,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
            ...
            1,
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::PredictResponse,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, 7,
         sizeof(::tensorflow::serving::PredictRequest_InputsEntry_DoNotUse)},
        {9, -1, sizeof(::tensorflow::serving::PredictRequest)},
        {17, 24,
         sizeof(::tensorflow::serving::PredictResponse_OutputsEntry_DoNotUse)},
...
const char
    descriptor_table_protodef_tensorflow_5fserving_2fapis_2fpredict_2eproto
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
            ...
            "\001(\0132\027.tensorflow"
            ".TensorProto:\0028\001B\003\370\001\001b\006proto3";
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* const
    descriptor_table_tensorflow_5fserving_2fapis_2fpredict_2eproto_deps[2] = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2fapis_2fpredict_2eproto_sccs[4] = {
        &scc_info_PredictRequest_tensorflow_5fserving_2fapis_2fpredict_2eproto
             .base,
        &scc_info_PredictRequest_InputsEntry_DoNotUse_tensorflow_5fserving_2fapis_2fpredict_2eproto
             .base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_tensorflow_5fserving_2fapis_2fpredict_2eproto = {
        ...
        589,
        &descriptor_table_tensorflow_5fserving_2fapis_2fpredict_2eproto_once,
        descriptor_table_tensorflow_5fserving_2fapis_2fpredict_2eproto_sccs,
        ...
        TableStruct_tensorflow_5fserving_2fapis_2fpredict_2eproto::offsets,
        file_level_metadata_tensorflow_5fserving_2fapis_2fpredict_2eproto,
        4,
        file_level_enum_descriptors_tensorflow_5fserving_2fapis_2fpredict_2eproto,
        file_level_service_descriptors_tensorflow_5fserving_2fapis_2fpredict_2eproto,
};
...
static bool dynamic_init_dummy_tensorflow_5fserving_2fapis_2fpredict_2eproto =
...
void PredictRequest_InputsEntry_DoNotUse::MergeFrom(
    const PredictRequest_InputsEntry_DoNotUse& other) {
  MergeFromInternal(other);
}
::PROTOBUF_NAMESPACE_ID::Metadata
PredictRequest_InputsEntry_DoNotUse::GetMetadata() const {
...
class PredictRequest::_Internal {
 public:
  static const ::tensorflow::serving::ModelSpec& model_spec(
      const PredictRequest* msg);
};

const ::tensorflow::serving::ModelSpec& PredictRequest::_Internal::model_spec(
    const PredictRequest* msg) {
...
void PredictRequest::clear_inputs() { inputs_.Clear(); }
...
PredictRequest::PredictRequest(const PredictRequest& from)
    : ::PROTOBUF_NAMESPACE_ID::Message(), output_filter_(from.output_filter_) {
...
void PredictRequest::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* PredictRequest::_InternalParse(
        ...
        if (PROTOBUF_PREDICT_TRUE(
          ...
          do {
            ...
            CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
                str, "tensorflow.serving.PredictRequest.output_filter"));
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
::PROTOBUF_NAMESPACE_ID::uint8* PredictRequest::_InternalSerialize(
  ...
  if (!this->_internal_inputs().empty()) {
    typedef ::PROTOBUF_NAMESPACE_ID::Map<
        std::string, ::tensorflow::TensorProto>::const_pointer ConstPtr;
    ...
    if (stream->IsSerializationDeterministic() &&
      ...
      typedef ::PROTOBUF_NAMESPACE_ID::Map<
          std::string, ::tensorflow::TensorProto>::size_type size_type;
      size_type n = 0;
      for (::PROTOBUF_NAMESPACE_ID::Map<
               std::string, ::tensorflow::TensorProto>::const_iterator it =
      ...
      for (size_type i = 0; i < n; i++) {
        target = PredictRequest_InputsEntry_DoNotUse::Funcs::InternalSerialize(
...
size_t PredictRequest::ByteSizeLong() const {
  ...
  for (::PROTOBUF_NAMESPACE_ID::Map<
           ...
           this->_internal_inputs().begin();
       it != this->_internal_inputs().end(); ++it) {
    total_size += PredictRequest_InputsEntry_DoNotUse::Funcs::ByteSizeLong(
        it->first, it->second);
  }

  // repeated string output_filter = 3;
  total_size +=
      1 * ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(output_filter_.size());
...
void PredictRequest::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const PredictRequest* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PredictRequest>(&from);
  if (source == nullptr) {
...
bool PredictRequest::IsInitialized() const { return true; }
...
void PredictResponse_OutputsEntry_DoNotUse::MergeFrom(
    const PredictResponse_OutputsEntry_DoNotUse& other) {
  MergeFromInternal(other);
}
::PROTOBUF_NAMESPACE_ID::Metadata
PredictResponse_OutputsEntry_DoNotUse::GetMetadata() const {
  return GetMetadataStatic();
}
void PredictResponse_OutputsEntry_DoNotUse::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& other) {
...
class PredictResponse::_Internal {
 public:
  static const ::tensorflow::serving::ModelSpec& model_spec(
      const PredictResponse* msg);
};

const ::tensorflow::serving::ModelSpec& PredictResponse::_Internal::model_spec(
    const PredictResponse* msg) {
  return *msg->model_spec_;
}
...
void PredictResponse::clear_outputs() { outputs_.Clear(); }
PredictResponse::PredictResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), outputs_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
...
void PredictResponse::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* PredictResponse::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
::PROTOBUF_NAMESPACE_ID::uint8* PredictResponse::_InternalSerialize(
  ...
  if (!this->_internal_outputs().empty()) {
    ...
    if (stream->IsSerializationDeterministic() &&
      ...
      for (size_type i = 0; i < n; i++) {
        target =
            PredictResponse_OutputsEntry_DoNotUse::Funcs::InternalSerialize(
...
size_t PredictResponse::ByteSizeLong() const {
  ...
  for (::PROTOBUF_NAMESPACE_ID::Map<
           ...
           this->_internal_outputs().begin();
       it != this->_internal_outputs().end(); ++it) {
    total_size += PredictResponse_OutputsEntry_DoNotUse::Funcs::ByteSizeLong(
        it->first, it->second);
  }
...
void PredictResponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const PredictResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PredictResponse>(&from);
  if (source == nullptr) {
...
bool PredictResponse::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::PredictRequest_InputsEntry_DoNotUse*
Arena::CreateMaybeMessage<
    ::tensorflow::serving::PredictRequest_InputsEntry_DoNotUse>(Arena* arena) {
  return Arena::CreateMessageInternal<
      ::tensorflow::serving::PredictRequest_InputsEntry_DoNotUse>(arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::PredictRequest*
Arena::CreateMaybeMessage<::tensorflow::serving::PredictRequest>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::PredictRequest>(
      arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::PredictResponse_OutputsEntry_DoNotUse*
Arena::CreateMaybeMessage<
    ::tensorflow::serving::PredictResponse_OutputsEntry_DoNotUse>(
    Arena* arena) {
  return Arena::CreateMessageInternal<
      ::tensorflow::serving::PredictResponse_OutputsEntry_DoNotUse>(arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::PredictResponse*
Arena::CreateMaybeMessage<::tensorflow::serving::PredictResponse>(
    Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::PredictResponse>(
      arena);
}
