...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fclassification_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_ClassificationResult_tensorflow_5fserving_2fapis_2fclassification_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2finference_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3>
        scc_info_InferenceResult_tensorflow_5fserving_2fapis_2finference_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2finference_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_InferenceTask_tensorflow_5fserving_2fapis_2finference_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2finput_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2>
        scc_info_Input_tensorflow_5fserving_2fapis_2finput_2eproto;
...
extern PROTOBUF_INTERNAL_EXPORT_tensorflow_5fserving_2fapis_2fregression_2eproto ::
    PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1>
        scc_info_RegressionResult_tensorflow_5fserving_2fapis_2fregression_2eproto;
namespace tensorflow {
namespace serving {
class InferenceTaskDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<InferenceTask>
      _instance;
} _InferenceTask_default_instance_;
class InferenceResultDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<InferenceResult>
      _instance;
...
static void
InitDefaultsscc_info_InferenceResult_tensorflow_5fserving_2fapis_2finference_2eproto() {
...
static void
InitDefaultsscc_info_InferenceTask_tensorflow_5fserving_2fapis_2finference_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_MultiInferenceRequest_tensorflow_5fserving_2fapis_2finference_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static void
InitDefaultsscc_info_MultiInferenceResponse_tensorflow_5fserving_2fapis_2finference_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_tensorflow_5fserving_2fapis_2finference_2eproto[4];
...
const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_tensorflow_5fserving_2fapis_2finference_2eproto::offsets
        [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::InferenceTask,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::InferenceTask,
                                  method_name_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::InferenceResult,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::InferenceResult,
                                  _oneof_case_[0]),
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::InferenceResult,
                                  model_spec_),
            offsetof(::tensorflow::serving::InferenceResultDefaultTypeInternal,
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::InferenceResult,
                                  result_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::MultiInferenceRequest,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
            ...
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::MultiInferenceRequest,
                                  input_),
            ~0u,  // no _has_bits_
            PROTOBUF_FIELD_OFFSET(::tensorflow::serving::MultiInferenceResponse,
                                  _internal_metadata_),
            ~0u,  // no _extensions_
            ~0u,  // no _oneof_case_
            ~0u,  // no _weak_field_map_
...
static ::PROTOBUF_NAMESPACE_ID::Message const* const file_default_instances[] =
    {
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_InferenceTask_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_InferenceResult_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_MultiInferenceRequest_default_instance_),
        reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(
            &::tensorflow::serving::_MultiInferenceResponse_default_instance_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* const
    descriptor_table_tensorflow_5fserving_2fapis_2finference_2eproto_deps[4] = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_tensorflow_5fserving_2fapis_2finference_2eproto_sccs[4] = {
        &scc_info_InferenceResult_tensorflow_5fserving_2fapis_2finference_2eproto
             .base,
        &scc_info_InferenceTask_tensorflow_5fserving_2fapis_2finference_2eproto
             .base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_tensorflow_5fserving_2fapis_2finference_2eproto = {
        ...
        745,
        &descriptor_table_tensorflow_5fserving_2fapis_2finference_2eproto_once,
        descriptor_table_tensorflow_5fserving_2fapis_2finference_2eproto_sccs,
        ...
        TableStruct_tensorflow_5fserving_2fapis_2finference_2eproto::offsets,
        file_level_metadata_tensorflow_5fserving_2fapis_2finference_2eproto,
        4,
        file_level_enum_descriptors_tensorflow_5fserving_2fapis_2finference_2eproto,
        file_level_service_descriptors_tensorflow_5fserving_2fapis_2finference_2eproto,
};
...
static bool dynamic_init_dummy_tensorflow_5fserving_2fapis_2finference_2eproto =
...
class InferenceTask::_Internal {
 public:
  static const ::tensorflow::serving::ModelSpec& model_spec(
      const InferenceTask* msg);
};

const ::tensorflow::serving::ModelSpec& InferenceTask::_Internal::model_spec(
    const InferenceTask* msg) {
...
void InferenceTask::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* InferenceTask::_InternalParse(
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(
              str, "tensorflow.serving.InferenceTask.method_name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* InferenceTask::_InternalSerialize(
  ...
  if (this->method_name().size() > 0) {
    ...
    target = stream->WriteStringMaybeAliased(2, this->_internal_method_name(),
                                             target);
  }
...
void InferenceTask::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const InferenceTask* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<InferenceTask>(&from);
  if (source == nullptr) {
...
bool InferenceTask::IsInitialized() const { return true; }
...
void InferenceResult::InitAsDefaultInstance() {
  ::tensorflow::serving::_InferenceResult_default_instance_._instance
      ...
      ::tensorflow::serving::ModelSpec::internal_default_instance());
  ::tensorflow::serving::_InferenceResult_default_instance_
      .classification_result_ = const_cast<
      ::tensorflow::serving::ClassificationResult*>(
      ::tensorflow::serving::ClassificationResult::internal_default_instance());
  ::tensorflow::serving::_InferenceResult_default_instance_.regression_result_ =
      const_cast<::tensorflow::serving::RegressionResult*>(
...
class InferenceResult::_Internal {
 public:
  ...
  static const ::tensorflow::serving::ClassificationResult&
  classification_result(const InferenceResult* msg);
  static const ::tensorflow::serving::RegressionResult& regression_result(
      const InferenceResult* msg);
};

const ::tensorflow::serving::ModelSpec& InferenceResult::_Internal::model_spec(
    const InferenceResult* msg) {
  return *msg->model_spec_;
}
...
void InferenceResult::set_allocated_classification_result(
...
void InferenceResult::set_allocated_regression_result(
...
InferenceResult::InferenceResult(const InferenceResult& from)
  ...
  switch (from.result_case()) {
    case kClassificationResult: {
      _internal_mutable_classification_result()
          ->::tensorflow::serving::ClassificationResult::MergeFrom(
              from._internal_classification_result());
      break;
    }
    case kRegressionResult: {
      _internal_mutable_regression_result()
          ->::tensorflow::serving::RegressionResult::MergeFrom(
...
void InferenceResult::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* InferenceResult::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(
                static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr =
              ctx->ParseMessage(_internal_mutable_classification_result(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void InferenceResult::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const InferenceResult* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<InferenceResult>(&from);
  if (source == nullptr) {
...
bool InferenceResult::IsInitialized() const { return true; }
...
class MultiInferenceRequest::_Internal {
 public:
  static const ::tensorflow::serving::Input& input(
      const MultiInferenceRequest* msg);
};

const ::tensorflow::serving::Input& MultiInferenceRequest::_Internal::input(
    const MultiInferenceRequest* msg) {
  return *msg->input_;
}
...
void MultiInferenceRequest::ArenaDtor(void* object) {
  MultiInferenceRequest* _this =
      reinterpret_cast<MultiInferenceRequest*>(object);
  (void)_this;
}
...
const char* MultiInferenceRequest::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
size_t MultiInferenceRequest::ByteSizeLong() const {
  ...
  if (this->has_input()) {
    total_size +=
        1 +
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(*input_);
  }
...
void MultiInferenceRequest::MergeFrom(
...
void MultiInferenceRequest::MergeFrom(const MultiInferenceRequest& from) {
  ...
  if (from.has_input()) {
    _internal_mutable_input()->::tensorflow::serving::Input::MergeFrom(
        from._internal_input());
  }
}

void MultiInferenceRequest::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool MultiInferenceRequest::IsInitialized() const { return true; }
...
void MultiInferenceResponse::ArenaDtor(void* object) {
  MultiInferenceResponse* _this =
      reinterpret_cast<MultiInferenceResponse*>(object);
  (void)_this;
}
void MultiInferenceResponse::RegisterArenaDtor(
...
const char* MultiInferenceResponse::_InternalParse(
    const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
  if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
::PROTOBUF_NAMESPACE_ID::uint8* MultiInferenceResponse::_InternalSerialize(
  ...
  for (unsigned int i = 0, n = static_cast<unsigned int>(
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            1, this->_internal_results(i), target, stream);
  }
...
void MultiInferenceResponse::MergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
void MultiInferenceResponse::CopyFrom(
    const ::PROTOBUF_NAMESPACE_ID::Message& from) {
...
bool MultiInferenceResponse::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::InferenceTask*
Arena::CreateMaybeMessage<::tensorflow::serving::InferenceTask>(Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::InferenceTask>(
      arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::InferenceResult*
Arena::CreateMaybeMessage<::tensorflow::serving::InferenceResult>(
    Arena* arena) {
  return Arena::CreateMessageInternal<::tensorflow::serving::InferenceResult>(
      arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::MultiInferenceRequest*
Arena::CreateMaybeMessage<::tensorflow::serving::MultiInferenceRequest>(
    Arena* arena) {
  return Arena::CreateMessageInternal<
      ::tensorflow::serving::MultiInferenceRequest>(arena);
}
template <>
PROTOBUF_NOINLINE ::tensorflow::serving::MultiInferenceResponse*
Arena::CreateMaybeMessage<::tensorflow::serving::MultiInferenceResponse>(
    Arena* arena) {
  return Arena::CreateMessageInternal<
      ::tensorflow::serving::MultiInferenceResponse>(arena);
}
