...
extern BundleHeaderProtoDefaultTypeInternal
    _BundleHeaderProto_default_instance_;
}  // namespace tensorflow
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::BundleEntryProto*
Arena::CreateMaybeMessage<::tensorflow::BundleEntryProto>(Arena*);
template <>
::tensorflow::BundleHeaderProto*
Arena::CreateMaybeMessage<::tensorflow::BundleHeaderProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
constexpr BundleHeaderProto_Endianness
...
constexpr int BundleHeaderProto_Endianness_Endianness_ARRAYSIZE =
    BundleHeaderProto_Endianness_Endianness_MAX + 1;
...
inline const std::string& BundleHeaderProto_Endianness_Name(T enum_t_value) {
  static_assert(
      ::std::is_same<T, BundleHeaderProto_Endianness>::value ||
...
inline bool BundleHeaderProto_Endianness_Parse(
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<
      BundleHeaderProto_Endianness>(BundleHeaderProto_Endianness_descriptor(),
                                    name, value);
}
// ===================================================================
...
class BundleHeaderProto PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.BundleHeaderProto)
                   */
{
 public:
  ...
  BundleHeaderProto(BundleHeaderProto&& from) noexcept : BundleHeaderProto() {
    *this = ::std::move(from);
  }
 ...
 public:
  ...
  static inline const std::string& Endianness_Name(T enum_t_value) {
    static_assert(
        ::std::is_same<T, Endianness>::value || ::std::is_integral<T>::value,
 ...
 private:
  ...
  friend struct ::
      TableStruct_tensorflow_2fcore_2fprotobuf_2ftensor_5fbundle_2eproto;
};
// -------------------------------------------------------------------

class BundleEntryProto PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.BundleEntryProto)
                   */
{
 public:
  ...
  BundleEntryProto(BundleEntryProto&& from) noexcept : BundleEntryProto() {
    *this = ::std::move(from);
  }
...
// int32 num_shards = 1;
inline void BundleHeaderProto::clear_num_shards() { num_shards_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 BundleHeaderProto::_internal_num_shards()
    const {
  return num_shards_;
}
...
inline void BundleHeaderProto::_internal_set_num_shards(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  num_shards_ = value;
}
inline void BundleHeaderProto::set_num_shards(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
...
// .tensorflow.BundleHeaderProto.Endianness endianness = 2;
inline void BundleHeaderProto::clear_endianness() { endianness_ = 0; }
inline ::tensorflow::BundleHeaderProto_Endianness
BundleHeaderProto::_internal_endianness() const {
  return static_cast<::tensorflow::BundleHeaderProto_Endianness>(endianness_);
}
inline ::tensorflow::BundleHeaderProto_Endianness
BundleHeaderProto::endianness() const {
  // @@protoc_insertion_point(field_get:tensorflow.BundleHeaderProto.endianness)
  return _internal_endianness();
}
inline void BundleHeaderProto::_internal_set_endianness(
    ::tensorflow::BundleHeaderProto_Endianness value) {
  endianness_ = value;
}
inline void BundleHeaderProto::set_endianness(
    ::tensorflow::BundleHeaderProto_Endianness value) {
...
inline const ::tensorflow::VersionDef& BundleHeaderProto::_internal_version()
    const {
...
BundleHeaderProto::unsafe_arena_release_version() {
...
inline ::tensorflow::VersionDef*
BundleHeaderProto::_internal_mutable_version() {
  if (version_ == nullptr) {
...
inline void BundleHeaderProto::set_allocated_version(
    ::tensorflow::VersionDef* version) {
...
// .tensorflow.DataType dtype = 1;
inline void BundleEntryProto::clear_dtype() { dtype_ = 0; }
...
inline void BundleEntryProto::_internal_set_dtype(
...
inline const ::tensorflow::TensorShapeProto& BundleEntryProto::_internal_shape()
    const {
...
BundleEntryProto::unsafe_arena_release_shape() {
...
inline ::tensorflow::TensorShapeProto*
BundleEntryProto::_internal_mutable_shape() {
  if (shape_ == nullptr) {
...
inline void BundleEntryProto::set_allocated_shape(
    ::tensorflow::TensorShapeProto* shape) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(shape_);
...
// int32 shard_id = 3;
inline void BundleEntryProto::clear_shard_id() { shard_id_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32 BundleEntryProto::_internal_shard_id()
    const {
  return shard_id_;
}
...
inline void BundleEntryProto::_internal_set_shard_id(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  shard_id_ = value;
}
inline void BundleEntryProto::set_shard_id(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
...
// int64 offset = 4;
inline void BundleEntryProto::clear_offset() { offset_ = PROTOBUF_LONGLONG(0); }
inline ::PROTOBUF_NAMESPACE_ID::int64 BundleEntryProto::_internal_offset()
    const {
  return offset_;
}
...
inline void BundleEntryProto::_internal_set_offset(
...
// int64 size = 5;
inline void BundleEntryProto::clear_size() { size_ = PROTOBUF_LONGLONG(0); }
...
inline void BundleEntryProto::_internal_set_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  size_ = value;
}
...
// fixed32 crc32c = 6;
inline void BundleEntryProto::clear_crc32c() { crc32c_ = 0u; }
inline ::PROTOBUF_NAMESPACE_ID::uint32 BundleEntryProto::_internal_crc32c()
    const {
  return crc32c_;
}
...
inline void BundleEntryProto::_internal_set_crc32c(
    ::PROTOBUF_NAMESPACE_ID::uint32 value) {
  crc32c_ = value;
}
inline void BundleEntryProto::set_crc32c(
    ::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline ::tensorflow::TensorSliceProto* BundleEntryProto::mutable_slices(
    int index) {
...
inline const ::tensorflow::TensorSliceProto& BundleEntryProto::_internal_slices(
    int index) const {
  return slices_.Get(index);
}
inline const ::tensorflow::TensorSliceProto& BundleEntryProto::slices(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.BundleEntryProto.slices)
  return _internal_slices(index);
}
inline ::tensorflow::TensorSliceProto*
BundleEntryProto::_internal_add_slices() {
  return slices_.Add();
}
...
template <>
struct is_proto_enum<::tensorflow::BundleHeaderProto_Endianness>
    : ::std::true_type {};
template <>
inline const EnumDescriptor*
GetEnumDescriptor<::tensorflow::BundleHeaderProto_Endianness>() {
