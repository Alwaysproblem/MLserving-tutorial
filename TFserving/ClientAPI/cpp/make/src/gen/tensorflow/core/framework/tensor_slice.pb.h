...
extern TensorSliceProto_ExtentDefaultTypeInternal
    _TensorSliceProto_Extent_default_instance_;
}  // namespace tensorflow
PROTOBUF_NAMESPACE_OPEN
template <>
::tensorflow::TensorSliceProto*
Arena::CreateMaybeMessage<::tensorflow::TensorSliceProto>(Arena*);
template <>
::tensorflow::TensorSliceProto_Extent*
Arena::CreateMaybeMessage<::tensorflow::TensorSliceProto_Extent>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class TensorSliceProto_Extent PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.TensorSliceProto.Extent)
                   */
{
 public:
  ...
  inline TensorSliceProto_Extent& operator=(
      const TensorSliceProto_Extent& from) {
    CopyFrom(from);
    return *this;
  }
  inline TensorSliceProto_Extent& operator=(
      TensorSliceProto_Extent&& from) noexcept {
...
class TensorSliceProto PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.TensorSliceProto)
                   */
{
 public:
  ...
  TensorSliceProto(TensorSliceProto&& from) noexcept : TensorSliceProto() {
    *this = ::std::move(from);
  }
 ...
 private:
  const ::tensorflow::TensorSliceProto_Extent& _internal_extent(
      int index) const;
...
inline ::PROTOBUF_NAMESPACE_ID::int64 TensorSliceProto_Extent::_internal_start()
    const {
  return start_;
}
...
inline void TensorSliceProto_Extent::_internal_set_start(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  start_ = value;
}
inline void TensorSliceProto_Extent::set_start(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
TensorSliceProto_Extent::_internal_length() const {
  if (_internal_has_length()) {
    return has_length_.length_;
  }
  return PROTOBUF_LONGLONG(0);
}
inline void TensorSliceProto_Extent::_internal_set_length(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  if (!_internal_has_length()) {
    clear_has_length();
    set_has_length();
...
inline void TensorSliceProto_Extent::set_length(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline TensorSliceProto_Extent::HasLengthCase
TensorSliceProto_Extent::has_length_case() const {
...
inline void TensorSliceProto::clear_extent() { extent_.Clear(); }
inline ::tensorflow::TensorSliceProto_Extent* TensorSliceProto::mutable_extent(
    int index) {
...
inline const ::tensorflow::TensorSliceProto_Extent&
TensorSliceProto::_internal_extent(int index) const {
  return extent_.Get(index);
}
inline const ::tensorflow::TensorSliceProto_Extent& TensorSliceProto::extent(
    int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.TensorSliceProto.extent)
  return _internal_extent(index);
}
inline ::tensorflow::TensorSliceProto_Extent*
TensorSliceProto::_internal_add_extent() {
  return extent_.Add();
}
