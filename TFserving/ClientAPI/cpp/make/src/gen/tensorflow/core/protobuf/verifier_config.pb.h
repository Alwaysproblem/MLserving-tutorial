...
Arena::CreateMaybeMessage<::tensorflow::VerifierConfig>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
constexpr VerifierConfig_Toggle VerifierConfig_Toggle_Toggle_MIN =
    VerifierConfig_Toggle_DEFAULT;
constexpr VerifierConfig_Toggle VerifierConfig_Toggle_Toggle_MAX =
    VerifierConfig_Toggle_OFF;
constexpr int VerifierConfig_Toggle_Toggle_ARRAYSIZE =
    VerifierConfig_Toggle_Toggle_MAX + 1;
...
inline const std::string& VerifierConfig_Toggle_Name(T enum_t_value) {
  static_assert(
      ::std::is_same<T, VerifierConfig_Toggle>::value ||
          ::std::is_integral<T>::value,
      "Incorrect type passed to function VerifierConfig_Toggle_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
      VerifierConfig_Toggle_descriptor(), enum_t_value);
}
inline bool VerifierConfig_Toggle_Parse(const std::string& name,
                                        VerifierConfig_Toggle* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<
      VerifierConfig_Toggle>(VerifierConfig_Toggle_descriptor(), name, value);
}
// ===================================================================

class VerifierConfig PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:tensorflow.VerifierConfig)
                   */
{
 public:
  ...
  VerifierConfig(VerifierConfig&& from) noexcept : VerifierConfig() {
    *this = ::std::move(from);
  }
 ...
 private:
  ...
  void _internal_set_verification_timeout_in_ms(
 ...
 private:
  ...
  void _internal_set_structure_verifier(
...
VerifierConfig::_internal_verification_timeout_in_ms() const {
  return verification_timeout_in_ms_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64
VerifierConfig::verification_timeout_in_ms() const {
...
inline void VerifierConfig::_internal_set_verification_timeout_in_ms(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
  verification_timeout_in_ms_ = value;
}
inline void VerifierConfig::set_verification_timeout_in_ms(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::tensorflow::VerifierConfig_Toggle
VerifierConfig::_internal_structure_verifier() const {
  return static_cast<::tensorflow::VerifierConfig_Toggle>(structure_verifier_);
}
inline ::tensorflow::VerifierConfig_Toggle VerifierConfig::structure_verifier()
    const {
  // @@protoc_insertion_point(field_get:tensorflow.VerifierConfig.structure_verifier)
  return _internal_structure_verifier();
}
inline void VerifierConfig::_internal_set_structure_verifier(
    ::tensorflow::VerifierConfig_Toggle value) {
  structure_verifier_ = value;
}
inline void VerifierConfig::set_structure_verifier(
    ::tensorflow::VerifierConfig_Toggle value) {
...
GetEnumDescriptor<::tensorflow::VerifierConfig_Toggle>() {
