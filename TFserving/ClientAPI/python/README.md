...
- request different model name
  ...
  ```bash
  $ python3 grpc_request.py -m Toy # python3 grpcRequest.py -m <model name>
  # outputs {
  #   key: "output_1"
  #   value {
  #     dtype: DT_FLOAT
  ...
  # }
  $ python3 grpc_request.py -m Toy_double
  # outputs {
  #   key: "output_1"
  #   value {
  #     dtype: DT_FLOAT
...
- request different version through the version number
  ...
  ```bash
    $ python3 grpc_request.py -v 1 # python3 grpcRequest.py -v <version number>
    # outputs {
    #   key: "output_1"
    #   value {
    #     dtype: DT_FLOAT
...
- request different version through the version annotation
  ...
  ```bash
  $ python3 grpc_request.py -l stable # python3 grpcRequest.py -l <model label or annotation>
  # outputs {
  #   key: "output_1"
  #   value {
  #     dtype: DT_FLOAT
  ...
  #   signature_name: "serving_default"
  # }
  $ python3 grpc_request.py -l canary
  # outputs {
  #   key: "output_1"
  #   value {
  #     dtype: DT_FLOAT
...
- request model status
  ...
  ```bash
  $ python grpc_model_status.py -m Toy_double -v 1
...
- reload model through gRPC API
  ...
  ```bash
  $ python grpc_reload_model.py -m Toy
...
- request model log
  ...
  ```bash
  $ python grpc_request_log.py -m Toy
  # ********************************************request logs********************************************
  # predict_log {
  #   request {
  #     model_spec {
