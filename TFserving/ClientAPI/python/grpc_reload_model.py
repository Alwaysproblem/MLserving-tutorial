"""Send grpc request for reload model"""
import numpy as np
...
if __name__ == "__main__":
  ...
  model_reload = modelstub.HandleReloadConfigRequest(
      model_man_request, timeout_req
  )

  if model_reload.status.error_code == 0:
    print(f"model {one_config.name} reloaded successfully")
  else:
